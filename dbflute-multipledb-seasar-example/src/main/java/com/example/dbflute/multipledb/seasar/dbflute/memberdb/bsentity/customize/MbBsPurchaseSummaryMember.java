 ...
 * 
 * [column]
 *     MEMBER_ID, MEMBER_NAME, PURCHASE_SUMMARY
 * 
 * [sequence]
 *     
 * 
 ...
 */
public abstract class MbBsPurchaseSummaryMember implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.customize.dbmeta.MbPurchaseSummaryMemberDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsPurchaseSummaryMember)) { return false; }
        MbBsPurchaseSummaryMember otherEntity = (MbBsPurchaseSummaryMember)other;
     ...
     */
    public MbPurchaseSummaryMember clone() {
        try {
            return (MbPurchaseSummaryMember)super.clone();

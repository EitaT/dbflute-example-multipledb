...
public class MbBsMemberStatusCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;MbMemberStatusCB&gt;() {
    ...
    public void union(UnionQuery<MbMemberStatusCB> unionQuery) {
        final MbMemberStatusCB cb = new MbMemberStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;MbMemberStatusCB&gt;() {
     *     public void query(MbMemberStatusCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<MbMemberStatusCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #DD4747">derivedMemberList()</span>.<span style="color: #DD4747">max</span>(new SubQuery&lt;MbMemberCB&gt;() {
         *     public void query(MbMemberCB subCB) {
         *         subCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, MbMember.<span style="color: #DD4747">ALIAS_foo...</span>);
         * </pre>
        ...
        public HpSDRFunction<MbMemberCB, MbMemberStatusCQ> derivedMemberList() {
            ...
            return new HpSDRFunction<MbMemberCB, MbMemberStatusCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<MbMemberCB, MbMemberStatusCQ>() {
                public void setup(String fn, SubQuery<MbMemberCB> sq, MbMemberStatusCQ cq, String al, DerivedReferrerOption op) {
        ...
        public HpSDRFunction<MbMemberLoginCB, MbMemberStatusCQ> derivedMemberLoginList() {
            ...
            return new HpSDRFunction<MbMemberLoginCB, MbMemberStatusCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<MbMemberLoginCB, MbMemberStatusCQ>() {
                public void setup(String fn, SubQuery<MbMemberLoginCB> sq, MbMemberStatusCQ cq, String al, DerivedReferrerOption op) {
        ...
        public HpSDRFunction<MbMemberStatusCB, MbMemberStatusCQ> myselfDerived() {
            ...
            return new HpSDRFunction<MbMemberStatusCB, MbMemberStatusCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<MbMemberStatusCB, MbMemberStatusCQ>() {
                public void setup(String fn, SubQuery<MbMemberStatusCB> sq, MbMemberStatusCQ cq, String al, DerivedReferrerOption op) {
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;MbMemberStatusCB&gt;() {
    ...
    public HpColQyOperand<MbMemberStatusCB> columnQuery(final SpecifyQuery<MbMemberStatusCB> leftSpecifyQuery) {
        return xcreateColQyOperand(new HpColQyHandler<MbMemberStatusCB>() {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;MbMemberStatusCB&gt;() {
     ...
     *     public void query(MbMemberStatusCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MbMemberStatusCB&gt;() {

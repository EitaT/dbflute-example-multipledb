 ...
 */
public class MbServiceRankCIQ extends MbAbstractBsServiceRankCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MbBsServiceRankCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public MbServiceRankCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, MbBsServiceRankCQ myCQ) {
    ...
    public String keepServiceRankCode_ExistsReferrer_MemberServiceList(MbMemberServiceCQ sq)
    { throwIICBOE("ExistsReferrer"); return null; }
    public String keepServiceRankCode_NotExistsReferrer_MemberServiceList(MbMemberServiceCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepServiceRankCode_InScopeRelation_MemberServiceList(MbMemberServiceCQ sq)
    { return _myCQ.keepServiceRankCode_InScopeRelation_MemberServiceList(sq); }
    public String keepServiceRankCode_NotInScopeRelation_MemberServiceList(MbMemberServiceCQ sq)
    { return _myCQ.keepServiceRankCode_NotInScopeRelation_MemberServiceList(sq); }
    public String keepServiceRankCode_SpecifyDerivedReferrer_MemberServiceList(MbMemberServiceCQ sq)
    ...
    protected String xinCB() { return MbServiceRankCB.class.getName(); }
    protected String xinCQ() { return MbServiceRankCQ.class.getName(); }
}

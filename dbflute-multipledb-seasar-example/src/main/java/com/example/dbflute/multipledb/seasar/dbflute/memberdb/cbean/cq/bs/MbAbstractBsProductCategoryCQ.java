 ...
 */
public abstract class MbAbstractBsProductCategoryCQ extends AbstractConditionQuery {
    ...
    public abstract String keepProductCategoryCode_ExistsReferrer_ProductList(MbProductCQ subQuery);
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">existsProductCategorySelfList</span>(new SubQuery&lt;MbProductCategoryCB&gt;() {
     ...
     */
    public void existsProductCategorySelfList(SubQuery<MbProductCategoryCB> subQuery) {
        assertObjectNotNull("subQuery<MbProductCategoryCB>", subQuery);
        MbProductCategoryCB cb = new MbProductCategoryCB(); cb.xsetupForExistsReferrer(this); subQuery.query(cb);
    ...
    public abstract String keepProductCategoryCode_ExistsReferrer_ProductCategorySelfList(MbProductCategoryCQ subQuery);
    ...
    public abstract String keepProductCategoryCode_NotExistsReferrer_ProductList(MbProductCQ subQuery);
     ...
     * PRODUCT_CATEGORY by PARENT_CATEGORY_CODE, named 'productCategorySelfAsOne'.
     * <pre>
     * cb.query().<span style="color: #FD4747">notExistsProductCategorySelfList</span>(new SubQuery&lt;MbProductCategoryCB&gt;() {
     *     public void query(MbProductCategoryCB subCB) {
     *         subCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void notExistsProductCategorySelfList(SubQuery<MbProductCategoryCB> subQuery) {
        assertObjectNotNull("subQuery<MbProductCategoryCB>", subQuery);
        MbProductCategoryCB cb = new MbProductCategoryCB(); cb.xsetupForExistsReferrer(this); subQuery.query(cb);
    ...
    public abstract String keepProductCategoryCode_NotExistsReferrer_ProductCategorySelfList(MbProductCategoryCQ subQuery);
    ...
    public abstract String keepProductCategoryCode_InScopeRelation_ProductList(MbProductCQ subQuery);
     ...
     */
    public void inScopeProductCategorySelfList(SubQuery<MbProductCategoryCB> subQuery) {
        assertObjectNotNull("subQuery<MbProductCategoryCB>", subQuery);
        MbProductCategoryCB cb = new MbProductCategoryCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
    ...
    public abstract String keepProductCategoryCode_InScopeRelation_ProductCategorySelfList(MbProductCategoryCQ subQuery);
    ...
    public abstract String keepProductCategoryCode_NotInScopeRelation_ProductList(MbProductCQ subQuery);
     ...
     */
    public void notInScopeProductCategorySelfList(SubQuery<MbProductCategoryCB> subQuery) {
        assertObjectNotNull("subQuery<MbProductCategoryCB>", subQuery);
        MbProductCategoryCB cb = new MbProductCategoryCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
    ...
    public abstract String keepProductCategoryCode_NotInScopeRelation_ProductCategorySelfList(MbProductCategoryCQ subQuery);
    ...
    public abstract String keepProductCategoryCode_SpecifyDerivedReferrer_ProductList(MbProductCQ subQuery);

    public void xsderiveProductCategorySelfList(String function, SubQuery<MbProductCategoryCB> subQuery, String aliasName, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<MbProductCategoryCB>", subQuery);
        MbProductCategoryCB cb = new MbProductCategoryCB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
    ...
    public abstract String keepProductCategoryCode_SpecifyDerivedReferrer_ProductCategorySelfList(MbProductCategoryCQ subQuery);
    ...
    public abstract String keepProductCategoryCode_QueryDerivedReferrer_ProductList(MbProductCQ subQuery);
     ...
     * PRODUCT_CATEGORY by PARENT_CATEGORY_CODE, named 'productCategorySelfAsOne'.
     * <pre>
     * cb.query().<span style="color: #FD4747">derivedProductCategorySelfList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;MbProductCategoryCB&gt;() {
     *     public void query(MbProductCategoryCB subCB) {
     *         subCB.specify().<span style="color: #FD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
     *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
     *     }
     ...
     * @return The object to set up a function for referrer table. (NotNull)
     */
    public HpQDRFunction<MbProductCategoryCB> derivedProductCategorySelfList() {
        return xcreateQDRFunctionProductCategorySelfList();
    }
    protected HpQDRFunction<MbProductCategoryCB> xcreateQDRFunctionProductCategorySelfList() {
        return new HpQDRFunction<MbProductCategoryCB>(new HpQDRSetupper<MbProductCategoryCB>() {
            public void setup(String function, SubQuery<MbProductCategoryCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
                xqderiveProductCategorySelfList(function, subQuery, operand, value, option);
            }
        });
    }
    public void xqderiveProductCategorySelfList(String function, SubQuery<MbProductCategoryCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<MbProductCategoryCB>", subQuery);
        MbProductCategoryCB cb = new MbProductCategoryCB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
    ...
    public abstract String keepProductCategoryCode_QueryDerivedReferrer_ProductCategorySelfList(MbProductCategoryCQ subQuery);
     ...
     */
    public void inScopeProductCategorySelf(SubQuery<MbProductCategoryCB> subQuery) {
        assertObjectNotNull("subQuery<MbProductCategoryCB>", subQuery);
        MbProductCategoryCB cb = new MbProductCategoryCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
    ...
    public abstract String keepParentCategoryCode_InScopeRelation_ProductCategorySelf(MbProductCategoryCQ subQuery);
     ...
     */
    public void notInScopeProductCategorySelf(SubQuery<MbProductCategoryCB> subQuery) {
        assertObjectNotNull("subQuery<MbProductCategoryCB>", subQuery);
        MbProductCategoryCB cb = new MbProductCategoryCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
    ...
    public abstract String keepParentCategoryCode_NotInScopeRelation_ProductCategorySelf(MbProductCategoryCQ subQuery);
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_Equal()</span>.max(new SubQuery&lt;MbProductCategoryCB&gt;() {
     *     public void query(MbProductCategoryCB subCB) {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;MbProductCategoryCB&gt;() {
     *     public void query(MbProductCategoryCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;MbProductCategoryCB&gt;() {
     *     public void query(MbProductCategoryCB subCB) {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessThan()</span>.max(new SubQuery&lt;MbProductCategoryCB&gt;() {
     *     public void query(MbProductCategoryCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;MbProductCategoryCB&gt;() {
     *     public void query(MbProductCategoryCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;MbProductCategoryCB&gt;() {
     *     public void query(MbProductCategoryCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    protected HpSSQFunction<MbProductCategoryCB> xcreateSSQFunction(final String operand) {
        return new HpSSQFunction<MbProductCategoryCB>(new HpSSQSetupper<MbProductCategoryCB>() {
            public void setup(String function, SubQuery<MbProductCategoryCB> subQuery, HpSSQOption<MbProductCategoryCB> option) {
                xscalarCondition(function, subQuery, operand, option);
            }
        });
    }

    protected void xscalarCondition(String function, SubQuery<MbProductCategoryCB> subQuery, String operand, HpSSQOption<MbProductCategoryCB> option) {
        assertObjectNotNull("subQuery<MbProductCategoryCB>", subQuery);
        MbProductCategoryCB cb = xcreateScalarConditionCB(); subQuery.query(cb);
        String subQueryPropertyName = keepScalarCondition(cb.query()); // for saving query-value
        option.setPartitionByCBean(xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(function, cb.query(), subQueryPropertyName, operand, option);
    }
    public abstract String keepScalarCondition(MbProductCategoryCQ subQuery);
    ...
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String function, SubQuery<MbProductCategoryCB> subQuery, String aliasName, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<MbProductCategoryCB>", subQuery);
        MbProductCategoryCB cb = new MbProductCategoryCB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
    ...
    public abstract String keepSpecifyMyselfDerived(MbProductCategoryCQ subQuery);
    ...
    public void xqderiveMyselfDerived(String function, SubQuery<MbProductCategoryCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<MbProductCategoryCB>", subQuery);
        MbProductCategoryCB cb = new MbProductCategoryCB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
    ...
    public abstract String keepQueryMyselfDerived(MbProductCategoryCQ subQuery);
    ...
    public void myselfExists(SubQuery<MbProductCategoryCB> subQuery) {
        assertObjectNotNull("subQuery<MbProductCategoryCB>", subQuery);
        MbProductCategoryCB cb = new MbProductCategoryCB(); cb.xsetupForMyselfExists(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfExists(cb.query()); // for saving query-value.
        registerMyselfExists(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfExists(MbProductCategoryCQ subQuery);
    ...
    public void myselfInScope(SubQuery<MbProductCategoryCB> subQuery) {
        assertObjectNotNull("subQuery<MbProductCategoryCB>", subQuery);
        MbProductCategoryCB cb = new MbProductCategoryCB(); cb.xsetupForMyselfInScope(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfInScope(cb.query()); // for saving query-value.
        registerMyselfInScope(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfInScope(MbProductCategoryCQ subQuery);

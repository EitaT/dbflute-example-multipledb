 ...
 */
public abstract class LdBsPublisher implements LdEntityDefinedCommonColumn, Serializable, Cloneable {
    ...
    protected String buildColumnString() {
        ...
        sb.append(dm).append(getPublisherName());

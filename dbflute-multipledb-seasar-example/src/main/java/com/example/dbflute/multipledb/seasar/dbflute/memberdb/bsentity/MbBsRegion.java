 ...
 */
public abstract class MbBsRegion implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsRegion)) { return false; }
        MbBsRegion otherEntity = (MbBsRegion)other;
     ...
     */
    public MbRegion clone() {
        try {
            return (MbRegion)super.clone();

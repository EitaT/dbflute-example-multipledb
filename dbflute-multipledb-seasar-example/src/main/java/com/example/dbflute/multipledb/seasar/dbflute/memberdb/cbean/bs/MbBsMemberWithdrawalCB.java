...
public class MbBsMemberWithdrawalCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public MbMemberWithdrawalCB acceptPK(Integer memberId) {
        assertObjectNotNull("memberId", memberId);
        MbBsMemberWithdrawalCB cb = this;
        cb.query().setMemberId_Equal(memberId);
        return (MbMemberWithdrawalCB)this;
    }
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;MbMemberWithdrawalCB&gt;() {
    ...
    public void union(UnionQuery<MbMemberWithdrawalCB> unionQuery) {
        final MbMemberWithdrawalCB cb = new MbMemberWithdrawalCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;MbMemberWithdrawalCB&gt;() {
     *     public void query(MbMemberWithdrawalCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;MbMemberWithdrawalCB&gt;() {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;MbMemberWithdrawalCB&gt;() {
     ...
     *     public void query(MbMemberWithdrawalCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MbMemberWithdrawalCB&gt;() {

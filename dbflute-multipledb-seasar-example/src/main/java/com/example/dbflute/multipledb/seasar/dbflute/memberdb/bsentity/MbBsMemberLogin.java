 ...
 */
public abstract class MbBsMemberLogin implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsMemberLogin)) { return false; }
        MbBsMemberLogin otherEntity = (MbBsMemberLogin)other;

...
public class LdBsAuthorCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;LdAuthorCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;LdAuthorCB&gt;() {
     *     public void query(LdAuthorCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<LdAuthorCQ> {
        ...
        public HpSDRFunction<LdBookCB, LdAuthorCQ> derivedBookList() {
            ...
            return new HpSDRFunction<LdBookCB, LdAuthorCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<LdBookCB, LdAuthorCQ>() {
                public void setup(String function, SubQuery<LdBookCB> subQuery, LdAuthorCQ cq, String aliasName, DerivedReferrerOption option) {
        ...
        public HpSDRFunction<LdAuthorCB, LdAuthorCQ> myselfDerived() {
            ...
            return new HpSDRFunction<LdAuthorCB, LdAuthorCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<LdAuthorCB, LdAuthorCQ>() {
                public void setup(String function, SubQuery<LdAuthorCB> subQuery, LdAuthorCQ cq, String aliasName, DerivedReferrerOption option) {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;LdAuthorCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;LdAuthorCB&gt;() {
     ...
     *     public void query(LdAuthorCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;LdAuthorCB&gt;() {

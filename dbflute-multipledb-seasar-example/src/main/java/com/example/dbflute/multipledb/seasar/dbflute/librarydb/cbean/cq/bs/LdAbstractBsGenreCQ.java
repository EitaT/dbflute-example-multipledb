...
public abstract class LdAbstractBsGenreCQ extends AbstractConditionQuery {
    ...
    public void existsBookList(SubQuery<LdBookCB> subQuery) {
        ...
        String pp = keepGenreCode_ExistsReferrer_BookList(cb.query());
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">existsGenreSelfList</span>(new SubQuery&lt;LdGenreCB&gt;() {
    ...
    public void existsGenreSelfList(SubQuery<LdGenreCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        LdGenreCB cb = new LdGenreCB(); cb.xsetupForExistsReferrer(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepGenreCode_ExistsReferrer_GenreSelfList(cb.query());
    ...
    public void notExistsBookList(SubQuery<LdBookCB> subQuery) {
        ...
        LdBookCB cb = new LdBookCB(); cb.xsetupForExistsReferrer(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepGenreCode_NotExistsReferrer_BookList(cb.query());
     ...
     * GENRE by PARENT_GENRE_CODE, named 'genreSelfAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">notExistsGenreSelfList</span>(new SubQuery&lt;LdGenreCB&gt;() {
     *     public void query(LdGenreCB subCB) {
     *         subCB.query().setXxx...
     *     }
     * });
    ...
    public void notExistsGenreSelfList(SubQuery<LdGenreCB> subQuery) {
        ...
        LdGenreCB cb = new LdGenreCB(); cb.xsetupForExistsReferrer(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepGenreCode_NotExistsReferrer_GenreSelfList(cb.query());
    ...
    public void inScopeBookList(SubQuery<LdBookCB> subQuery) {
        ...
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepGenreCode_InScopeRelation_BookList(cb.query());
    ...
    public void inScopeGenreSelfList(SubQuery<LdGenreCB> subQuery) {
        ...
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepGenreCode_InScopeRelation_GenreSelfList(cb.query());
    ...
    public void notInScopeBookList(SubQuery<LdBookCB> subQuery) {
        ...
        LdBookCB cb = new LdBookCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepGenreCode_NotInScopeRelation_BookList(cb.query());
    ...
    public void notInScopeGenreSelfList(SubQuery<LdGenreCB> subQuery) {
        ...
        LdGenreCB cb = new LdGenreCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepGenreCode_NotInScopeRelation_GenreSelfList(cb.query());
    ...
    public void xsderiveBookList(String fn, SubQuery<LdBookCB> sq, String al, DerivedReferrerOption op) {
        ...
        String pp = keepGenreCode_SpecifyDerivedReferrer_BookList(cb.query());
    ...
    public void xsderiveGenreSelfList(String fn, SubQuery<LdGenreCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        LdGenreCB cb = new LdGenreCB(); cb.xsetupForDerivedReferrer(this);
        try { lock(); sq.query(cb); } finally { unlock(); }
        String pp = keepGenreCode_SpecifyDerivedReferrer_GenreSelfList(cb.query());
    ...
    public void xqderiveBookList(String fn, SubQuery<LdBookCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        ...
        LdBookCB cb = new LdBookCB(); cb.xsetupForDerivedReferrer(this);
        try { lock(); sq.query(cb); } finally { unlock(); }
        String sqpp = keepGenreCode_QueryDerivedReferrer_BookList(cb.query()); String prpp = keepGenreCode_QueryDerivedReferrer_BookListParameter(vl);
     ...
     * GENRE by PARENT_GENRE_CODE, named 'genreSelfAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedGenreSelfList()</span>.<span style="color: #DD4747">max</span>(new SubQuery&lt;LdGenreCB&gt;() {
     *     public void query(LdGenreCB subCB) {
     *         subCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
     *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
     *     }
    ...
    public void xqderiveGenreSelfList(String fn, SubQuery<LdGenreCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        ...
        LdGenreCB cb = new LdGenreCB(); cb.xsetupForDerivedReferrer(this);
        try { lock(); sq.query(cb); } finally { unlock(); }
        String sqpp = keepGenreCode_QueryDerivedReferrer_GenreSelfList(cb.query()); String prpp = keepGenreCode_QueryDerivedReferrer_GenreSelfListParameter(vl);
     ...
     * <pre>e.g. setGenreName_LikeSearch("xxx", new <span style="color: #DD4747">LikeSearchOption</span>().likeContain());</pre>
     ...
     * <pre>e.g. setParentGenreCode_LikeSearch("xxx", new <span style="color: #DD4747">LikeSearchOption</span>().likeContain());</pre>
    ...
    public void inScopeGenreSelf(SubQuery<LdGenreCB> subQuery) {
        ...
        LdGenreCB cb = new LdGenreCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepParentGenreCode_InScopeRelation_GenreSelf(cb.query());
    ...
    public void notInScopeGenreSelf(SubQuery<LdGenreCB> subQuery) {
        ...
        LdGenreCB cb = new LdGenreCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepParentGenreCode_NotInScopeRelation_GenreSelf(cb.query());
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_Equal()</span>.max(new SubQuery&lt;LdGenreCB&gt;() {
     *     public void query(LdGenreCB subCB) {
    ...
    public HpSSQFunction<LdGenreCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, LdGenreCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;LdGenreCB&gt;() {
     *     public void query(LdGenreCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
    ...
    public HpSSQFunction<LdGenreCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, LdGenreCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;LdGenreCB&gt;() {
     *     public void query(LdGenreCB subCB) {
    ...
    public HpSSQFunction<LdGenreCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, LdGenreCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessThan()</span>.max(new SubQuery&lt;LdGenreCB&gt;() {
     *     public void query(LdGenreCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<LdGenreCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, LdGenreCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;LdGenreCB&gt;() {
     *     public void query(LdGenreCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<LdGenreCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, LdGenreCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;LdGenreCB&gt;() {
     *     public void query(LdGenreCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<LdGenreCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, LdGenreCB.class);
    }
    ...
    public void myselfExists(SubQuery<LdGenreCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        LdGenreCB cb = new LdGenreCB(); cb.xsetupForMyselfExists(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
    ...
    public void myselfInScope(SubQuery<LdGenreCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        LdGenreCB cb = new LdGenreCB(); cb.xsetupForMyselfInScope(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }

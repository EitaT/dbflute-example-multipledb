 ...
 */
public class MbProductCIQ extends MbAbstractBsProductCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public MbProductCIQ(ConditionQuery childQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, MbBsProductCQ myCQ) {
    ...
    protected String xinCB() { return MbProductCB.class.getName(); }
    protected String xinCQ() { return MbProductCQ.class.getName(); }
}

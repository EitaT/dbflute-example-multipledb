...
public class MbMemberWithdrawalDbm extends AbstractDBMeta {
    ...
    public class EfpgMember implements PropertyGateway {
        public Object read(Entity et) { return ((MbMemberWithdrawal)et).getMember(); }
        public void write(Entity et, Object vl) { ((MbMemberWithdrawal)et).setMember((MbMember)vl); }
    }
    public class EfpgWithdrawalReason implements PropertyGateway {
        public Object read(Entity et) { return ((MbMemberWithdrawal)et).getWithdrawalReason(); }
        public void write(Entity et, Object vl) { ((MbMemberWithdrawal)et).setWithdrawalReason((MbWithdrawalReason)vl); }
    }
    ...
    protected final ColumnInfo _columnWithdrawalDatetime = cci("WITHDRAWAL_DATETIME", "WITHDRAWAL_DATETIME", null, null, java.sql.Timestamp.class, "withdrawalDatetime", null, false, false, true, "TIMESTAMP", 23, 10, null, false, null, null, null, null, null);
    ...
    public ForeignInfo foreignMember() {
        ...
        return cfi("FK_MEMBER_WITHDRAWAL_MEMBER", "member", this, MbMemberDbm.getInstance(), mp, 0, null, true, false, false, false, null, null, false, "memberWithdrawalAsOne");
    }
    /**
    ...
    public ForeignInfo foreignWithdrawalReason() {
        ...
        return cfi("FK_MEMBER_WITHDRAWAL_WITHDRAWAL_REASON", "withdrawalReason", this, MbWithdrawalReasonDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "memberWithdrawalList");
    }

...
public abstract class LdBsGenreBhv extends AbstractBehaviorWritable<LdGenre, LdGenreCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public LdGenreDbm getDBMeta() { return LdGenreDbm.getInstance(); }
    ...
    public OutsideSqlBasicExecutor<LdGenreBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<LdGenreBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends LdGenre> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends LdGenre> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {

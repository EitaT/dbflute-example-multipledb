...
/**
 * The condition-query for in-line of LENDING_COLLECTION.
...
public class LdLendingCollectionCIQ extends LdAbstractBsLendingCollectionCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LdLendingCollectionCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, LdBsLendingCollectionCQ myCQ) {
    ...
    protected ConditionValue getCValueLendingDate() { return _myCQ.getLendingDate(); }
    ...
    protected ConditionValue getCValueReturnLimitDate() { return _myCQ.getReturnLimitDate(); }
    ...
    protected String xinCB() { return LdLendingCollectionCB.class.getName(); }
    protected String xinCQ() { return LdLendingCollectionCQ.class.getName(); }
}

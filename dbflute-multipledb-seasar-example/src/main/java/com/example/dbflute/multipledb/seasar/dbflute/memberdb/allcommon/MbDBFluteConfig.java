 ...
 */
public class MbDBFluteConfig {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** Log instance. */
    private static final Log _log = LogFactory.getLog(MbDBFluteConfig.class);

    /** Singleton instance. */
    private static final MbDBFluteConfig _instance = new MbDBFluteConfig();
    ...
    protected String _outsideSqlPackage = "com.example.dbflute.multipledb.seasar.dbflute.memberdb";
     ...
     * Constructor.
     */
    private MbDBFluteConfig() { // adjusts default settings
     ...
     */
    public static MbDBFluteConfig getInstance() {
        return _instance;
    }
    ...
    protected DBDef currentDBDef() {
        return MbDBCurrent.getInstance().currentDBDef();
    }

    protected boolean isCurrentDBDef(DBDef currentDBDef) {
        return MbDBCurrent.getInstance().isCurrentDBDef(currentDBDef);
    }
    ...
    public static class ImplementedOracleAgent implements OracleAgent {
        ...
        public PhysicalConnectionDigger getPhysicalConnectionDigger() {
            return MbDBFluteConfig.getInstance().getPhysicalConnectionDigger();
        }
    }
    ...
    public static class SelectCursorCBCommandHyperPatch<ENTITY extends org.seasar.dbflute.Entity> extends org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<ENTITY> {
        ...
        protected TnRelationRowCreatorHyperPatch createRelationRowCreator(org.seasar.dbflute.s2dao.metadata.TnBeanMetaData bmd) {
            return new TnRelationRowCreatorHyperPatch(createRelationOptionalFactory());
        }
    }
    ...
    public static class TnRelationRowCreatorHyperPatch extends org.seasar.dbflute.s2dao.extension.TnRelationRowCreatorExtension {

        public TnRelationRowCreatorHyperPatch(org.seasar.dbflute.s2dao.extension.TnRelationRowOptionalHandler optionalFactory) {
            super(optionalFactory);
        }

        @Override
        protected void registerRelationValue(org.seasar.dbflute.s2dao.rowcreator.TnRelationRowCreationResource res, String columnName) throws SQLException {
            final org.seasar.dbflute.s2dao.metadata.TnPropertyMapping mapping = res.getCurrentPropertyMapping();
            Object value = null;
            if (res.containsRelationKeyColumn(columnName)) { // #RELKEY
                ...
                final org.seasar.dbflute.jdbc.ValueType valueType = mapping.getValueType();
                final java.util.Map<String, java.util.Map<String, Integer>> selectIndexMap = res.getSelectIndexMap();
                final java.sql.ResultSet rs = res.getResultSet();
                if (selectIndexMap != null) {
                    final String relationNoSuffix = res.getRelationNoSuffix();
                    value = org.seasar.dbflute.resource.ResourceContext.getRelationValue(rs, relationNoSuffix, columnName, valueType, selectIndexMap);
                } else {

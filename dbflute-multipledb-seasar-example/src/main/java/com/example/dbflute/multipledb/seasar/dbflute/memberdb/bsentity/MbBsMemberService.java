 ...
 */
public abstract class MbBsMemberService implements MbEntityDefinedCommonColumn, Serializable, Cloneable {
     ...
     */
    public void setServiceRank(MbServiceRank serviceRank) {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsMemberService)) { return false; }
        MbBsMemberService otherEntity = (MbBsMemberService)other;
     ...
     */
    public MbMemberService clone() {
        try {
            return (MbMemberService)super.clone();

 ...
 */
public abstract class MbBsProductStatus extends AbstractEntity implements DomainEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof MbBsProductStatus) {
            MbBsProductStatus other = (MbBsProductStatus)obj;
    ...
    @Override
    public MbProductStatus clone() {
        return (MbProductStatus)super.clone();
    }

...
public class MbBsProductCategoryCQ extends MbAbstractBsProductCategoryCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public MbBsProductCategoryCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    protected Map<String, MbProductCQ> _productCategoryCode_ExistsReferrer_ProductListMap;
    public Map<String, MbProductCQ> getProductCategoryCode_ExistsReferrer_ProductList() { return _productCategoryCode_ExistsReferrer_ProductListMap; }
    public String keepProductCategoryCode_ExistsReferrer_ProductList(MbProductCQ subQuery) {
    ...
    protected Map<String, MbProductCategoryCQ> _productCategoryCode_ExistsReferrer_ProductCategorySelfListMap;
    public Map<String, MbProductCategoryCQ> getProductCategoryCode_ExistsReferrer_ProductCategorySelfList() { return _productCategoryCode_ExistsReferrer_ProductCategorySelfListMap; }
    public String keepProductCategoryCode_ExistsReferrer_ProductCategorySelfList(MbProductCategoryCQ subQuery) {
    ...
    protected Map<String, MbProductCQ> _productCategoryCode_NotExistsReferrer_ProductListMap;
    public Map<String, MbProductCQ> getProductCategoryCode_NotExistsReferrer_ProductList() { return _productCategoryCode_NotExistsReferrer_ProductListMap; }
    public String keepProductCategoryCode_NotExistsReferrer_ProductList(MbProductCQ subQuery) {
    ...
    protected Map<String, MbProductCategoryCQ> _productCategoryCode_NotExistsReferrer_ProductCategorySelfListMap;
    public Map<String, MbProductCategoryCQ> getProductCategoryCode_NotExistsReferrer_ProductCategorySelfList() { return _productCategoryCode_NotExistsReferrer_ProductCategorySelfListMap; }
    public String keepProductCategoryCode_NotExistsReferrer_ProductCategorySelfList(MbProductCategoryCQ subQuery) {
    ...
    protected Map<String, MbProductCQ> _productCategoryCode_InScopeRelation_ProductListMap;
    public Map<String, MbProductCQ> getProductCategoryCode_InScopeRelation_ProductList() { return _productCategoryCode_InScopeRelation_ProductListMap; }
    public String keepProductCategoryCode_InScopeRelation_ProductList(MbProductCQ subQuery) {
    ...
    protected Map<String, MbProductCategoryCQ> _productCategoryCode_InScopeRelation_ProductCategorySelfListMap;
    public Map<String, MbProductCategoryCQ> getProductCategoryCode_InScopeRelation_ProductCategorySelfList() { return _productCategoryCode_InScopeRelation_ProductCategorySelfListMap; }
    public String keepProductCategoryCode_InScopeRelation_ProductCategorySelfList(MbProductCategoryCQ subQuery) {
    ...
    protected Map<String, MbProductCQ> _productCategoryCode_NotInScopeRelation_ProductListMap;
    public Map<String, MbProductCQ> getProductCategoryCode_NotInScopeRelation_ProductList() { return _productCategoryCode_NotInScopeRelation_ProductListMap; }
    public String keepProductCategoryCode_NotInScopeRelation_ProductList(MbProductCQ subQuery) {
    ...
    protected Map<String, MbProductCategoryCQ> _productCategoryCode_NotInScopeRelation_ProductCategorySelfListMap;
    public Map<String, MbProductCategoryCQ> getProductCategoryCode_NotInScopeRelation_ProductCategorySelfList() { return _productCategoryCode_NotInScopeRelation_ProductCategorySelfListMap; }
    public String keepProductCategoryCode_NotInScopeRelation_ProductCategorySelfList(MbProductCategoryCQ subQuery) {
    ...
    protected Map<String, MbProductCQ> _productCategoryCode_SpecifyDerivedReferrer_ProductListMap;
    public Map<String, MbProductCQ> getProductCategoryCode_SpecifyDerivedReferrer_ProductList() { return _productCategoryCode_SpecifyDerivedReferrer_ProductListMap; }
    public String keepProductCategoryCode_SpecifyDerivedReferrer_ProductList(MbProductCQ subQuery) {
    ...
    protected Map<String, MbProductCategoryCQ> _productCategoryCode_SpecifyDerivedReferrer_ProductCategorySelfListMap;
    public Map<String, MbProductCategoryCQ> getProductCategoryCode_SpecifyDerivedReferrer_ProductCategorySelfList() { return _productCategoryCode_SpecifyDerivedReferrer_ProductCategorySelfListMap; }
    public String keepProductCategoryCode_SpecifyDerivedReferrer_ProductCategorySelfList(MbProductCategoryCQ subQuery) {
    ...
    protected Map<String, MbProductCQ> _productCategoryCode_QueryDerivedReferrer_ProductListMap;
    public Map<String, MbProductCQ> getProductCategoryCode_QueryDerivedReferrer_ProductList() { return _productCategoryCode_QueryDerivedReferrer_ProductListMap; }
    public String keepProductCategoryCode_QueryDerivedReferrer_ProductList(MbProductCQ subQuery) {
    ...
    protected Map<String, MbProductCategoryCQ> _productCategoryCode_QueryDerivedReferrer_ProductCategorySelfListMap;
    public Map<String, MbProductCategoryCQ> getProductCategoryCode_QueryDerivedReferrer_ProductCategorySelfList() { return _productCategoryCode_QueryDerivedReferrer_ProductCategorySelfListMap; }
    public String keepProductCategoryCode_QueryDerivedReferrer_ProductCategorySelfList(MbProductCategoryCQ subQuery) {
    ...
    protected Map<String, MbProductCategoryCQ> _parentCategoryCode_InScopeRelation_ProductCategorySelfMap;
    public Map<String, MbProductCategoryCQ> getParentCategoryCode_InScopeRelation_ProductCategorySelf() { return _parentCategoryCode_InScopeRelation_ProductCategorySelfMap; }
    public String keepParentCategoryCode_InScopeRelation_ProductCategorySelf(MbProductCategoryCQ subQuery) {
    ...
    protected Map<String, MbProductCategoryCQ> _parentCategoryCode_NotInScopeRelation_ProductCategorySelfMap;
    public Map<String, MbProductCategoryCQ> getParentCategoryCode_NotInScopeRelation_ProductCategorySelf() { return _parentCategoryCode_NotInScopeRelation_ProductCategorySelfMap; }
    public String keepParentCategoryCode_NotInScopeRelation_ProductCategorySelf(MbProductCategoryCQ subQuery) {
     ...
     * @return this. (NotNull)
     */
    public MbBsProductCategoryCQ addSpecifiedDerivedOrderBy_Asc(String aliasName)
     ...
     * @return this. (NotNull)
     */
    public MbBsProductCategoryCQ addSpecifiedDerivedOrderBy_Desc(String aliasName)
    ...
    protected void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
        MbProductCategoryCQ baseQuery = (MbProductCategoryCQ)baseQueryAsSuper;
        MbProductCategoryCQ unionQuery = (MbProductCategoryCQ)unionQueryAsSuper;
    ...
    protected MbProductCategoryCQ _conditionQueryProductCategorySelf;
    ...
    protected void xsetupOuterJoinProductCategorySelf() {
        MbProductCategoryCQ cq = getConditionQueryProductCategorySelf();
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    protected Map<String, MbProductCategoryCQ> _scalarConditionMap;
    public Map<String, MbProductCategoryCQ> getScalarCondition() { return _scalarConditionMap; }
    ...
    //                                                                       MyselfDerived
    //                                                                       =============
    protected Map<String, MbProductCategoryCQ> _specifyMyselfDerivedMap;
    public Map<String, MbProductCategoryCQ> getSpecifyMyselfDerived() { return _specifyMyselfDerivedMap; }
    ...
    protected Map<String, MbProductCategoryCQ> _queryMyselfDerivedMap;
    public Map<String, MbProductCategoryCQ> getQueryMyselfDerived() { return _queryMyselfDerivedMap; }
    ...
    public Map<String, MbProductCategoryCQ> getMyselfExists() { return _myselfExistsMap; }
    ...
    //                                                                       MyselfInScope
    //                                                                       =============
    protected Map<String, MbProductCategoryCQ> _myselfInScopeMap;
    public Map<String, MbProductCategoryCQ> getMyselfInScope() { return _myselfInScopeMap; }

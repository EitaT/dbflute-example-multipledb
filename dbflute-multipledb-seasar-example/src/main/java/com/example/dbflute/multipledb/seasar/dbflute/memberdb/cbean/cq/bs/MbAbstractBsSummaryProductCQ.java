 ...
 */
public abstract class MbAbstractBsSummaryProductCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public MbAbstractBsSummaryProductCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_Equal()</span>.max(new SubQuery&lt;MbSummaryProductCB&gt;() {
     *     public void query(MbSummaryProductCB subCB) {
     ...
     */
    public HpSSQFunction<MbSummaryProductCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ.getOperand(), MbSummaryProductCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;MbSummaryProductCB&gt;() {
     *     public void query(MbSummaryProductCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MbSummaryProductCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES.getOperand(), MbSummaryProductCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;MbSummaryProductCB&gt;() {
     *     public void query(MbSummaryProductCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MbSummaryProductCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT.getOperand(), MbSummaryProductCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessThan()</span>.max(new SubQuery&lt;MbSummaryProductCB&gt;() {
     *     public void query(MbSummaryProductCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MbSummaryProductCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT.getOperand(), MbSummaryProductCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;MbSummaryProductCB&gt;() {
     *     public void query(MbSummaryProductCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MbSummaryProductCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE.getOperand(), MbSummaryProductCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;MbSummaryProductCB&gt;() {
     *     public void query(MbSummaryProductCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MbSummaryProductCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE.getOperand(), MbSummaryProductCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSSQOption<CB> op) {
        assertObjectNotNull("subQuery", sq);
        MbSummaryProductCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        op.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, op);
    }
    public abstract String keepScalarCondition(MbSummaryProductCQ sq);

    protected MbSummaryProductCB xcreateScalarConditionCB() {
        MbSummaryProductCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected MbSummaryProductCB xcreateScalarConditionPartitionByCB() {

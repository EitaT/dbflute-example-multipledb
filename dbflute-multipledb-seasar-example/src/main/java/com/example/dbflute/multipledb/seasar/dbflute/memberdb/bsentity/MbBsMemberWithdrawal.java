...
public abstract class MbBsMemberWithdrawal implements MbEntityDefinedCommonColumn, Serializable, Cloneable {
     ...
     */
    public void setWithdrawalReason(MbWithdrawalReason withdrawalReason) {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsMemberWithdrawal)) { return false; }
        MbBsMemberWithdrawal otherEntity = (MbBsMemberWithdrawal)other;

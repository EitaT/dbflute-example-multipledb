...
public abstract class MbAbstractBsMemberSecurityCQ extends AbstractConditionQuery {
    ...
    public HpSSQFunction<MbMemberSecurityCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, MbMemberSecurityCB.class);
    }
    ...
    public HpSSQFunction<MbMemberSecurityCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, MbMemberSecurityCB.class);
    }
    ...
    public HpSSQFunction<MbMemberSecurityCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, MbMemberSecurityCB.class);
    }
    ...
    public HpSSQFunction<MbMemberSecurityCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, MbMemberSecurityCB.class);
    }
    ...
    public HpSSQFunction<MbMemberSecurityCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, MbMemberSecurityCB.class);
    }
    ...
    public HpSSQFunction<MbMemberSecurityCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, MbMemberSecurityCB.class);
    }

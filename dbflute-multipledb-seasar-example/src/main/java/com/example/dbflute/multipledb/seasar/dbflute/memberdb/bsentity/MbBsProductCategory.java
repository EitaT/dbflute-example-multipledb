 ...
 */
public abstract class MbBsProductCategory extends AbstractEntity implements DomainEntity {
    ...
    protected MbProductCategory _productCategorySelf;
     ...
     */
    public MbProductCategory getProductCategorySelf() {
     ...
     */
    public void setProductCategorySelf(MbProductCategory productCategorySelf) {
    ...
    protected List<MbProductCategory> _productCategorySelfList;
     ...
     */
    public List<MbProductCategory> getProductCategorySelfList() {
     ...
     */
    public void setProductCategorySelfList(List<MbProductCategory> productCategorySelfList) {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof MbBsProductCategory) {
            MbBsProductCategory other = (MbBsProductCategory)obj;
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_productList != null) { for (MbProduct et : _productList)
        { if (et != null) { sb.append(li).append(xbRDS(et, "productList")); } } }
        if (_productCategorySelfList != null) { for (MbProductCategory et : _productCategorySelfList)
    ...
    @Override
    public MbProductCategory clone() {
        return (MbProductCategory)super.clone();
    }

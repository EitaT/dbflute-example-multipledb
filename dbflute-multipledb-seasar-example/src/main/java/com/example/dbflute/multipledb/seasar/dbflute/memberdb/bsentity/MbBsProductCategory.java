 ...
 */
public abstract class MbBsProductCategory implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsProductCategory)) { return false; }
        MbBsProductCategory otherEntity = (MbBsProductCategory)other;

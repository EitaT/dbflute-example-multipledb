...
public abstract class LdBsMyselfBhv extends AbstractBehaviorWritable {
    ...
    public LdMyself selectByPKValue(Integer myselfId) {
        return doSelectByPK(myselfId, LdMyself.class);
    }

    protected <ENTITY extends LdMyself> ENTITY doSelectByPK(Integer myselfId, Class<ENTITY> entityType) {
        return doSelectEntity(xprepareCBAsPK(myselfId), entityType);
    }

    protected <ENTITY extends LdMyself> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer myselfId, Class<ENTITY> entityType) {
    ...
    public LdMyself selectByPKValueWithDeletedCheck(Integer myselfId) {
        return doSelectByPKWithDeletedCheck(myselfId, LdMyself.class);
    }

    protected <ENTITY extends LdMyself> ENTITY doSelectByPKWithDeletedCheck(Integer myselfId, Class<ENTITY> entityType) {
    ...
    protected LdMyselfCB xprepareCBAsPK(Integer myselfId) {
        ...
        LdMyselfCB cb = newMyConditionBean(); cb.acceptPrimaryKey(myselfId);
        return cb;
    }
     ...
     */
    public NestedReferrerLoader<LdMyselfCheck> loadMyselfCheckList(List<LdMyself> myselfList, ConditionBeanSetupper<LdMyselfCheckCB> setupper) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<LdMyselfCheck> loadMyselfCheckList(LdMyself myself, ConditionBeanSetupper<LdMyselfCheckCB> setupper) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<LdMyselfCheck> loadMyselfCheckList(LdMyself myself, LoadReferrerOption<LdMyselfCheckCB, LdMyselfCheck> loadReferrerOption) {
    ...
    public NestedReferrerLoader<LdMyselfCheck> loadMyselfCheckList(List<LdMyself> myselfList, LoadReferrerOption<LdMyselfCheckCB, LdMyselfCheck> loadReferrerOption) {
        xassLRArg(myselfList, loadReferrerOption);
        if (myselfList.isEmpty()) { return (NestedReferrerLoader<LdMyselfCheck>)EMPTY_LOADER; }
        return doLoadMyselfCheckList(myselfList, loadReferrerOption);
    }

    protected NestedReferrerLoader<LdMyselfCheck> doLoadMyselfCheckList(List<LdMyself> myselfList, LoadReferrerOption<LdMyselfCheckCB, LdMyselfCheck> option) {
        final LdMyselfCheckBhv referrerBhv = xgetBSFLR().select(LdMyselfCheckBhv.class);
        return helpLoadReferrerInternally(myselfList, option, new InternalLoadReferrerCallback<LdMyself, Integer, LdMyselfCheckCB, LdMyselfCheck>() {

 ...
 */
public abstract class MbBsWithdrawalReason implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsWithdrawalReason)) { return false; }
        MbBsWithdrawalReason otherEntity = (MbBsWithdrawalReason)other;

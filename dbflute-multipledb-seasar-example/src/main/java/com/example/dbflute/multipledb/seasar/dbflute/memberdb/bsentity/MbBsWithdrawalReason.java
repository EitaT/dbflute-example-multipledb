 ...
 */
public abstract class MbBsWithdrawalReason extends AbstractEntity implements DomainEntity {
    ...
    protected List<MbMemberWithdrawal> _memberWithdrawalList;
     ...
     */
    public List<MbMemberWithdrawal> getMemberWithdrawalList() {
     ...
     */
    public void setMemberWithdrawalList(List<MbMemberWithdrawal> memberWithdrawalList) {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof MbBsWithdrawalReason) {
            MbBsWithdrawalReason other = (MbBsWithdrawalReason)obj;
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_memberWithdrawalList != null) { for (MbMemberWithdrawal et : _memberWithdrawalList)
    ...
    @Override
    public MbWithdrawalReason clone() {
        return (MbWithdrawalReason)super.clone();
    }

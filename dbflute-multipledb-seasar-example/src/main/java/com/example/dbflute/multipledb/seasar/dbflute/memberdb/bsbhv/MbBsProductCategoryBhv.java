...
public abstract class MbBsProductCategoryBhv extends AbstractBehaviorWritable {
    ...
    /** {@inheritDoc} */
    public MbProductCategoryCB newConditionBean() { return new MbProductCategoryCB(); }
    ...
    protected int facadeSelectCount(MbProductCategoryCB cb) {
     ...
     * MbProductCategoryCB cb = new MbProductCategoryCB();
     * cb.query().setFoo...(value);
     * MbProductCategory productCategory = productCategoryBhv.<span style="color: #DD4747">selectEntity</span>(cb);
    ...
    protected MbProductCategory facadeSelectEntity(MbProductCategoryCB cb) {
        return doSelectEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends MbProductCategory> ENTITY doSelectEntity(MbProductCategoryCB cb, Class<ENTITY> tp) {
        return helpSelectEntityInternally(cb, tp);
    }

    protected <ENTITY extends MbProductCategory> OptionalEntity<ENTITY> doSelectOptionalEntity(MbProductCategoryCB cb, Class<ENTITY> tp) {
     ...
     * MbProductCategoryCB cb = new MbProductCategoryCB();
     * cb.query().setFoo...(value);
     * MbProductCategory productCategory = productCategoryBhv.<span style="color: #DD4747">selectEntityWithDeletedCheck</span>(cb);
    ...
    protected MbProductCategory facadeSelectEntityWithDeletedCheck(MbProductCategoryCB cb) {
        return doSelectEntityWithDeletedCheck(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends MbProductCategory> ENTITY doSelectEntityWithDeletedCheck(MbProductCategoryCB cb, Class<ENTITY> tp) {
    ...
    protected MbProductCategory facadeSelectByPKValue(String productCategoryCode) {
        return doSelectByPK(productCategoryCode, typeOfSelectedEntity());
    }

    protected <ENTITY extends MbProductCategory> ENTITY doSelectByPK(String productCategoryCode, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(productCategoryCode), tp);
    }

    protected <ENTITY extends MbProductCategory> OptionalEntity<ENTITY> doSelectOptionalByPK(String productCategoryCode, Class<ENTITY> tp) {
    ...
    protected <ENTITY extends MbProductCategory> ENTITY doSelectByPKWithDeletedCheck(String productCategoryCode, Class<ENTITY> tp) {
     ...
     * ListResultBean&lt;MbProductCategory&gt; productCategoryList = productCategoryBhv.<span style="color: #DD4747">selectList</span>(cb);
    ...
    protected ListResultBean<MbProductCategory> facadeSelectList(MbProductCategoryCB cb) {
     ...
     * PagingResultBean&lt;MbProductCategory&gt; page = productCategoryBhv.<span style="color: #DD4747">selectPage</span>(cb);
    ...
    protected PagingResultBean<MbProductCategory> facadeSelectPage(MbProductCategoryCB cb) {
     ...
     * MbProductCategoryCB cb = new MbProductCategoryCB();
     * cb.query().setFoo...(value);
     * productCategoryBhv.<span style="color: #DD4747">selectCursor</span>(cb, new EntityRowHandler&lt;MbProductCategory&gt;() {
    ...
    protected void facadeSelectCursor(MbProductCategoryCB cb, EntityRowHandler<MbProductCategory> entityRowHandler) {
     ...
     */
    public <RESULT> HpSLSFunction<MbProductCategoryCB, RESULT> scalarSelect(Class<RESULT> resultType) {
        return facadeScalarSelect(resultType);
    }

    protected <RESULT> HpSLSFunction<MbProductCategoryCB, RESULT> facadeScalarSelect(Class<RESULT> resultType) {
        return doScalarSelect(resultType, newConditionBean());
    }

    protected <RESULT, CB extends MbProductCategoryCB> HpSLSFunction<CB, RESULT> doScalarSelect(final Class<RESULT> tp, final CB cb) {
     ...
     */
    public void load(List<MbProductCategory> productCategoryList, ReferrerLoaderHandler<MbLoaderOfProductCategory> handler) {
        xassLRArg(productCategoryList, handler);
        handler.handle(new MbLoaderOfProductCategory().ready(productCategoryList, _behaviorSelector));
    }
     ...
     * @param handler The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(MbProductCategory productCategory, ReferrerLoaderHandler<MbLoaderOfProductCategory> handler) {
        xassLRArg(productCategory, handler);
        handler.handle(new MbLoaderOfProductCategory().ready(xnewLRAryLs(productCategory), _behaviorSelector));
    }
     ...
     * <pre>
     * productCategoryBhv.<span style="color: #DD4747">loadProductList</span>(productCategoryList, new ConditionBeanSetupper&lt;MbProductCB&gt;() {
     ...
     */
    public NestedReferrerListGateway<MbProduct> loadProductList(List<MbProductCategory> productCategoryList, ConditionBeanSetupper<MbProductCB> setupper) {
        xassLRArg(productCategoryList, setupper);
        return doLoadProductList(productCategoryList, new LoadReferrerOption<MbProductCB, MbProduct>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MbProduct> loadProductList(MbProductCategory productCategory, ConditionBeanSetupper<MbProductCB> setupper) {
        xassLRArg(productCategory, setupper);
        return doLoadProductList(xnewLRLs(productCategory), new LoadReferrerOption<MbProductCB, MbProduct>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MbProduct> loadProductList(MbProductCategory productCategory, LoadReferrerOption<MbProductCB, MbProduct> loadReferrerOption) {
    ...
    public NestedReferrerListGateway<MbProduct> loadProductList(List<MbProductCategory> productCategoryList, LoadReferrerOption<MbProductCB, MbProduct> loadReferrerOption) {
        xassLRArg(productCategoryList, loadReferrerOption);
        if (productCategoryList.isEmpty()) { return (NestedReferrerListGateway<MbProduct>)EMPTY_NREF_LGWAY; }
        return doLoadProductList(productCategoryList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MbProduct> doLoadProductList(List<MbProductCategory> productCategoryList, LoadReferrerOption<MbProductCB, MbProduct> option) {
     ...
     * <pre>
     * productCategoryBhv.<span style="color: #DD4747">loadProductCategorySelfList</span>(productCategoryList, new ConditionBeanSetupper&lt;MbProductCategoryCB&gt;() {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MbProductCategory> loadProductCategorySelfList(List<MbProductCategory> productCategoryList, ConditionBeanSetupper<MbProductCategoryCB> setupper) {
        xassLRArg(productCategoryList, setupper);
        return doLoadProductCategorySelfList(productCategoryList, new LoadReferrerOption<MbProductCategoryCB, MbProductCategory>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MbProductCategory> loadProductCategorySelfList(MbProductCategory productCategory, ConditionBeanSetupper<MbProductCategoryCB> setupper) {
        xassLRArg(productCategory, setupper);
        return doLoadProductCategorySelfList(xnewLRLs(productCategory), new LoadReferrerOption<MbProductCategoryCB, MbProductCategory>().xinit(setupper));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MbProductCategory> loadProductCategorySelfList(MbProductCategory productCategory, LoadReferrerOption<MbProductCategoryCB, MbProductCategory> loadReferrerOption) {
        xassLRArg(productCategory, loadReferrerOption);
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<MbProductCategory> loadProductCategorySelfList(List<MbProductCategory> productCategoryList, LoadReferrerOption<MbProductCategoryCB, MbProductCategory> loadReferrerOption) {
        xassLRArg(productCategoryList, loadReferrerOption);
        if (productCategoryList.isEmpty()) { return (NestedReferrerListGateway<MbProductCategory>)EMPTY_NREF_LGWAY; }
        return doLoadProductCategorySelfList(productCategoryList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MbProductCategory> doLoadProductCategorySelfList(List<MbProductCategory> productCategoryList, LoadReferrerOption<MbProductCategoryCB, MbProductCategory> option) {
    ...
    protected void doInsert(MbProductCategory et, InsertOption<MbProductCategoryCB> op) {
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(MbProductCategory productCategory) {
        doUpdate(productCategory, null);
    }

    protected void doUpdate(MbProductCategory et, UpdateOption<MbProductCategoryCB> op) {
    ...
    { MbProductCategoryCB cb = newConditionBean(); cb.xsetupForVaryingUpdate(); return cb; }

    protected MbProductCategoryCB createCBForSpecifiedUpdate()
    { MbProductCategoryCB cb = newConditionBean(); cb.xsetupForSpecifiedUpdate(); return cb; }
    ...
    protected void doInsertOrUpdate(MbProductCategory et, InsertOption<MbProductCategoryCB> iop, UpdateOption<MbProductCategoryCB> uop) {
        assertObjectNotNull("productCategory", et); helpInsertOrUpdateInternally(et, iop, uop);
    }
    ...
    protected void doDelete(MbProductCategory et, final DeleteOption<MbProductCategoryCB> op) {
        assertObjectNotNull("productCategory", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<MbProductCategoryCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int[] doBatchInsert(List<MbProductCategory> ls, InsertOption<MbProductCategoryCB> op) {
        assertObjectNotNull("productCategoryList", ls);
        InsertOption<MbProductCategoryCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainInsertOption(); }
        prepareBatchInsertOption(ls, rlop); // required
        return delegateBatchInsert(ls, rlop);
    }

    protected void prepareBatchInsertOption(List<MbProductCategory> ls, InsertOption<MbProductCategoryCB> op) {
    ...
    protected int[] doBatchUpdate(List<MbProductCategory> ls, UpdateOption<MbProductCategoryCB> op) {
        assertObjectNotNull("productCategoryList", ls);
        UpdateOption<MbProductCategoryCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
        prepareBatchUpdateOption(ls, rlop); // required
        return delegateBatchUpdate(ls, rlop);
    }

    protected void prepareBatchUpdateOption(List<MbProductCategory> ls, UpdateOption<MbProductCategoryCB> op) {
     ...
     * productCategoryBhv.<span style="color: #DD4747">batchUpdate</span>(productCategoryList, new SpecifyQuery<MbProductCategoryCB>() {
    ...
    protected int[] doBatchDelete(List<MbProductCategory> ls, DeleteOption<MbProductCategoryCB> op) {
        assertObjectNotNull("productCategoryList", ls);
     ...
     * <pre>
     * productCategoryBhv.<span style="color: #DD4747">queryInsert</span>(new QueryInsertSetupper&lt;MbProductCategory, MbProductCategoryCB&gt;() {
    ...
    protected int doQueryInsert(QueryInsertSetupper<MbProductCategory, MbProductCategoryCB> sp, InsertOption<MbProductCategoryCB> op) {
        ...
        MbProductCategory et = newEntity(); MbProductCategoryCB cb = createCBForQueryInsert();
        return delegateQueryInsert(et, cb, sp.setup(et, cb), op);
    }

    protected MbProductCategoryCB createCBForQueryInsert()
    { MbProductCategoryCB cb = newConditionBean(); cb.xsetupForQueryInsert(); return cb; }
    ...
    protected int doQueryUpdate(MbProductCategory et, MbProductCategoryCB cb, UpdateOption<MbProductCategoryCB> op) {
        assertObjectNotNull("productCategory", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<MbProductCategory> typeOfSelectedEntity() { return MbProductCategory.class; }
    protected MbProductCategory downcast(Entity et) { return helpEntityDowncastInternally(et, MbProductCategory.class); }
    protected MbProductCategoryCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, MbProductCategoryCB.class); }
    @SuppressWarnings("unchecked")
    protected List<MbProductCategory> downcast(List<? extends Entity> ls) { return (List<MbProductCategory>)ls; }
    @SuppressWarnings("unchecked")
    protected InsertOption<MbProductCategoryCB> downcast(InsertOption<? extends ConditionBean> op) { return (InsertOption<MbProductCategoryCB>)op; }
    @SuppressWarnings("unchecked")
    protected UpdateOption<MbProductCategoryCB> downcast(UpdateOption<? extends ConditionBean> op) { return (UpdateOption<MbProductCategoryCB>)op; }
    @SuppressWarnings("unchecked")
    protected DeleteOption<MbProductCategoryCB> downcast(DeleteOption<? extends ConditionBean> op) { return (DeleteOption<MbProductCategoryCB>)op; }
    @SuppressWarnings("unchecked")

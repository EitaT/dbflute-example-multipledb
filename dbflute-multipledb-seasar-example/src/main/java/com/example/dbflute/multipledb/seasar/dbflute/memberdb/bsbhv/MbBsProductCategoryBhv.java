 ...
 */
public abstract class MbBsProductCategoryBhv extends AbstractBehaviorWritable<MbProductCategory, MbProductCategoryCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public MbProductCategoryDbm getDBMeta() { return MbProductCategoryDbm.getInstance(); }
    ...
    protected <ENTITY extends MbProductCategory> OptionalEntity<ENTITY> doSelectOptionalEntity(MbProductCategoryCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MbProductCategory> ENTITY doSelectByPK(String productCategoryCode, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(productCategoryCode), tp);
    }

    protected <ENTITY extends MbProductCategory> OptionalEntity<ENTITY> doSelectOptionalByPK(String productCategoryCode, Class<? extends ENTITY> tp) {
     ...
     *     public ConditionBean setup(MbProductCategory entity, MbProductCategoryCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
    ...
    public OutsideSqlBasicExecutor<MbProductCategoryBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<MbProductCategoryBhv> facadeExecutor = doOutsideSql();
    ...
    protected Class<MbProductCategory> typeOfHandlingEntity() { return MbProductCategory.class; }
    protected Class<MbProductCategoryCB> typeOfHandlingConditionBean() { return MbProductCategoryCB.class; }
}

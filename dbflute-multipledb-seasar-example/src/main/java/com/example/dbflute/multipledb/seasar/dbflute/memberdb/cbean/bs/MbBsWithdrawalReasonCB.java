...
public class MbBsWithdrawalReasonCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;MbWithdrawalReasonCB&gt;() {
    ...
    public void union(UnionQuery<MbWithdrawalReasonCB> unionQuery) {
        final MbWithdrawalReasonCB cb = new MbWithdrawalReasonCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;MbWithdrawalReasonCB&gt;() {
     *     public void query(MbWithdrawalReasonCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<MbWithdrawalReasonCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #FD4747">derivedMemberWithdrawalList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;MbMemberWithdrawalCB&gt;() {
         *     public void query(MbMemberWithdrawalCB subCB) {
         *         subCB.specify().<span style="color: #FD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, MbMemberWithdrawal.<span style="color: #FD4747">ALIAS_foo...</span>);
         * </pre>
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;MbWithdrawalReasonCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;MbWithdrawalReasonCB&gt;() {
     ...
     *     public void query(MbWithdrawalReasonCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MbWithdrawalReasonCB&gt;() {

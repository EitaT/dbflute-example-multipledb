 ...
 */
public class MbBsWithdrawalReasonCB extends AbstractConditionBean {
    ...
    public MbWithdrawalReasonCQ getConditionQuery() { // public for parameter comment and internal
    ...
    protected MbWithdrawalReasonCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MbWithdrawalReasonCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MbWithdrawalReasonCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MbWithdrawalReasonCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;MbWithdrawalReasonCB&gt;() {
     *     public void query(MbWithdrawalReasonCB unionCB) {
     ...
     */
    public void union(UnionQuery<MbWithdrawalReasonCB> unionQuery) {
        final MbWithdrawalReasonCB cb = new MbWithdrawalReasonCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MbWithdrawalReasonCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;MbWithdrawalReasonCB&gt;() {
     *     public void query(MbWithdrawalReasonCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<MbWithdrawalReasonCB> unionQuery) {
        final MbWithdrawalReasonCB cb = new MbWithdrawalReasonCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MbWithdrawalReasonCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<MbWithdrawalReasonCQ>() {
                public boolean has() { return true; }
                public MbWithdrawalReasonCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<MbWithdrawalReasonCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MbWithdrawalReasonCQ> qyCall
         ...
         * <pre>
         * cb.specify().<span style="color: #DD4747">derivedMemberWithdrawalList()</span>.<span style="color: #DD4747">max</span>(new SubQuery&lt;MbMemberWithdrawalCB&gt;() {
         *     public void query(MbMemberWithdrawalCB subCB) {
         *         subCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, MbMemberWithdrawal.<span style="color: #DD4747">ALIAS_foo...</span>);
         * </pre>
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;MbWithdrawalReasonCB&gt;() {
     *     public void query(MbWithdrawalReasonCB cb) {
     *         cb.specify().<span style="color: #DD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;MbWithdrawalReasonCB&gt;() {
     *     public void query(MbWithdrawalReasonCB cb) {
     ...
     */
    public MbWithdrawalReasonCB dreamCruiseCB() {
        MbWithdrawalReasonCB cb = new MbWithdrawalReasonCB();
        cb.xsetupForDreamCruise((MbWithdrawalReasonCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;MbWithdrawalReasonCB&gt;() {
     *     public void query(MbWithdrawalReasonCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<MbWithdrawalReasonCB> orQuery) {
        xorSQ((MbWithdrawalReasonCB)this, orQuery);
    }
     ...
     *     public void query(MbWithdrawalReasonCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MbWithdrawalReasonCB&gt;() {
     *             public void query(MbWithdrawalReasonCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MbWithdrawalReasonCB> andQuery) {
        xorSQAP((MbWithdrawalReasonCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MbWithdrawalReasonCB cb;
        if (mainCB != null) {
            cb = (MbWithdrawalReasonCB)mainCB;
        } else {
            cb = new MbWithdrawalReasonCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<MbWithdrawalReasonCQ>() {
            public boolean has() { return true; }
            public MbWithdrawalReasonCQ qy() { return cb.query(); }
        });
    }
    ...
    protected String getConditionBeanClassNameInternally() { return MbWithdrawalReasonCB.class.getName(); }
    protected String getConditionQueryClassNameInternally() { return MbWithdrawalReasonCQ.class.getName(); }

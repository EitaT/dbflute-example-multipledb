...
public abstract class MbAbstractBsWithdrawalReasonCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public MbAbstractBsWithdrawalReasonCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public HpSSQFunction<MbWithdrawalReasonCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, MbWithdrawalReasonCB.class);
    }
    ...
    public HpSSQFunction<MbWithdrawalReasonCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, MbWithdrawalReasonCB.class);
    }
    ...
    public HpSSQFunction<MbWithdrawalReasonCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, MbWithdrawalReasonCB.class);
    }
    ...
    public HpSSQFunction<MbWithdrawalReasonCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, MbWithdrawalReasonCB.class);
    }
    ...
    public HpSSQFunction<MbWithdrawalReasonCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, MbWithdrawalReasonCB.class);
    }
    ...
    public HpSSQFunction<MbWithdrawalReasonCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, MbWithdrawalReasonCB.class);
    }

 ...
 */
public class MbDBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("MEMBER", "com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.dbmeta.MbMemberDbm");
        tmpMap.put("MEMBER_ADDRESS", "com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.dbmeta.MbMemberAddressDbm");
        tmpMap.put("MEMBER_LOGIN", "com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.dbmeta.MbMemberLoginDbm");
        tmpMap.put("MEMBER_SECURITY", "com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.dbmeta.MbMemberSecurityDbm");
        tmpMap.put("MEMBER_SERVICE", "com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.dbmeta.MbMemberServiceDbm");
        tmpMap.put("MEMBER_STATUS", "com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.dbmeta.MbMemberStatusDbm");
        tmpMap.put("MEMBER_WITHDRAWAL", "com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.dbmeta.MbMemberWithdrawalDbm");
        tmpMap.put("PRODUCT", "com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.dbmeta.MbProductDbm");
        tmpMap.put("PRODUCT_CATEGORY", "com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.dbmeta.MbProductCategoryDbm");
        tmpMap.put("PRODUCT_STATUS", "com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.dbmeta.MbProductStatusDbm");
        tmpMap.put("PURCHASE", "com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.dbmeta.MbPurchaseDbm");
        tmpMap.put("REGION", "com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.dbmeta.MbRegionDbm");
        tmpMap.put("SERVICE_RANK", "com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.dbmeta.MbServiceRankDbm");
        tmpMap.put("SUMMARY_PRODUCT", "com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.dbmeta.MbSummaryProductDbm");
        tmpMap.put("WITHDRAWAL_REASON", "com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.dbmeta.MbWithdrawalReasonDbm");
    ...
    //                                                                  Provider Singleton
    //                                                                  ==================
    protected static final DBMetaProvider _provider = new MbDBMetaInstanceHandler();

 ...
 */
public abstract class MbBsServiceRank implements Entity, Serializable, Cloneable {
     ...
     */
    public MbCDef.Flg getNewAcceptableFlgAsFlg() {
        return MbCDef.Flg.codeOf(getNewAcceptableFlg());
    }
     ...
     */
    public void setNewAcceptableFlgAsFlg(MbCDef.Flg cdef) {
    ...
    public void setNewAcceptableFlg_True() {
        setNewAcceptableFlgAsFlg(MbCDef.Flg.True);
    }
    ...
    public void setNewAcceptableFlg_False() {
        setNewAcceptableFlgAsFlg(MbCDef.Flg.False);
    }
    ...
    public boolean isNewAcceptableFlgTrue() {
        MbCDef.Flg cdef = getNewAcceptableFlgAsFlg();
     ...
     */
    public void setMemberServiceList(List<MbMemberService> memberServiceList) {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsServiceRank)) { return false; }
        MbBsServiceRank otherEntity = (MbBsServiceRank)other;
     ...
     */
    public MbServiceRank clone() {
        try {
            return (MbServiceRank)super.clone();

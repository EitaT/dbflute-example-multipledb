 ...
 */
public abstract class MbBsUnpaidSummaryMember implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.customize.dbmeta.MbUnpaidSummaryMemberDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsUnpaidSummaryMember)) { return false; }
        MbBsUnpaidSummaryMember otherEntity = (MbBsUnpaidSummaryMember)other;
        if (!xSV(getMemberId(), otherEntity.getMemberId())) { return false; }
        if (!xSV(getMemberName(), otherEntity.getMemberName())) { return false; }
        if (!xSV(getUnpaidPriceSummary(), otherEntity.getUnpaidPriceSummary())) { return false; }
     ...
     */
    public MbUnpaidSummaryMember clone() {
        try {
            return (MbUnpaidSummaryMember)super.clone();

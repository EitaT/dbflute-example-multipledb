 ...
 */
public class MbBsMemberLoginCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public MbMemberLoginCB acceptUniqueOf(Integer memberId, java.sql.Timestamp loginDatetime) {
    ...
    public MbMemberLoginCQ getConditionQuery() { // public for parameter comment and internal
    ...
    protected MbMemberLoginCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MbMemberLoginCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MbMemberLoginCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MbMemberLoginCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;MbMemberLoginCB&gt;() {
     *     public void query(MbMemberLoginCB unionCB) {
     ...
     */
    public void union(UnionQuery<MbMemberLoginCB> unionQuery) {
        final MbMemberLoginCB cb = new MbMemberLoginCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MbMemberLoginCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;MbMemberLoginCB&gt;() {
     *     public void query(MbMemberLoginCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<MbMemberLoginCB> unionQuery) {
        final MbMemberLoginCB cb = new MbMemberLoginCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MbMemberLoginCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * MbMemberLogin memberLogin = memberLoginBhv.selectEntityWithDeletedCheck(cb);
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<MbMemberLoginCQ>() {
                public boolean has() { return true; }
                public MbMemberLoginCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<MbMemberLoginCQ> {
        protected MbMemberCB.HpSpecification _member;
        protected MbMemberStatusCB.HpSpecification _memberStatus;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MbMemberLoginCQ> qyCall
         ...
         */
        public HpSDRFunction<MbMemberLoginCB, MbMemberLoginCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return new HpSDRFunction<MbMemberLoginCB, MbMemberLoginCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<MbMemberLoginCB, MbMemberLoginCQ>() {
                public void setup(String fn, SubQuery<MbMemberLoginCB> sq, MbMemberLoginCQ cq, String al, DerivedReferrerOption op) {
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;MbMemberLoginCB&gt;() {
     *     public void query(MbMemberLoginCB cb) {
     *         cb.specify().<span style="color: #DD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;MbMemberLoginCB&gt;() {
     *     public void query(MbMemberLoginCB cb) {
     ...
     */
    public HpColQyOperand<MbMemberLoginCB> columnQuery(final SpecifyQuery<MbMemberLoginCB> leftSpecifyQuery) {
        return new HpColQyOperand<MbMemberLoginCB>(new HpColQyHandler<MbMemberLoginCB>() {
            public HpCalculator handle(SpecifyQuery<MbMemberLoginCB> rightSp, String operand) {
     ...
     */
    public MbMemberLoginCB dreamCruiseCB() {
        MbMemberLoginCB cb = new MbMemberLoginCB();
        cb.xsetupForDreamCruise((MbMemberLoginCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;MbMemberLoginCB&gt;() {
     *     public void query(MbMemberLoginCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<MbMemberLoginCB> orQuery) {
        xorSQ((MbMemberLoginCB)this, orQuery);
    }
     ...
     *     public void query(MbMemberLoginCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MbMemberLoginCB&gt;() {
     *             public void query(MbMemberLoginCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MbMemberLoginCB> andQuery) {
        xorSQAP((MbMemberLoginCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MbMemberLoginCB cb;
        if (mainCB != null) {
            cb = (MbMemberLoginCB)mainCB;
        } else {
            cb = new MbMemberLoginCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<MbMemberLoginCQ>() {
            public boolean has() { return true; }
            public MbMemberLoginCQ qy() { return cb.query(); }
        });
    }
    ...
    protected String getConditionBeanClassNameInternally() { return MbMemberLoginCB.class.getName(); }
    protected String getConditionQueryClassNameInternally() { return MbMemberLoginCQ.class.getName(); }

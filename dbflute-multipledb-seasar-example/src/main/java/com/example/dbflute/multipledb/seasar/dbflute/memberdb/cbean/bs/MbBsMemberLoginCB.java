...
public class MbBsMemberLoginCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;MbMemberLoginCB&gt;() {
    ...
    public void union(UnionQuery<MbMemberLoginCB> unionQuery) {
        final MbMemberLoginCB cb = new MbMemberLoginCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;MbMemberLoginCB&gt;() {
     *     public void query(MbMemberLoginCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<MbMemberLoginCQ> {
        ...
        public HpSDRFunction<MbMemberLoginCB, MbMemberLoginCQ> myselfDerived() {
            ...
            return new HpSDRFunction<MbMemberLoginCB, MbMemberLoginCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<MbMemberLoginCB, MbMemberLoginCQ>() {
                public void setup(String function, SubQuery<MbMemberLoginCB> subQuery, MbMemberLoginCQ cq, String aliasName, DerivedReferrerOption option) {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;MbMemberLoginCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;MbMemberLoginCB&gt;() {
     ...
     *     public void query(MbMemberLoginCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MbMemberLoginCB&gt;() {

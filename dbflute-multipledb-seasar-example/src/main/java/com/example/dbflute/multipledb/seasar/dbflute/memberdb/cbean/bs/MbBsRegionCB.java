...
public class MbBsRegionCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;MbRegionCB&gt;() {
    ...
    public void union(UnionQuery<MbRegionCB> unionQuery) {
        final MbRegionCB cb = new MbRegionCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;MbRegionCB&gt;() {
     *     public void query(MbRegionCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;MbRegionCB&gt;() {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;MbRegionCB&gt;() {
     ...
     *     public void query(MbRegionCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MbRegionCB&gt;() {

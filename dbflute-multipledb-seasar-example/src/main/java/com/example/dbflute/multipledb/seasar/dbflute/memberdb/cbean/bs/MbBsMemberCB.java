...
public class MbBsMemberCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public MbMemberCB acceptPK(Integer memberId) {
        assertObjectNotNull("memberId", memberId);
        MbBsMemberCB cb = this;
        cb.query().setMemberId_Equal(memberId);
        return (MbMemberCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public MbMemberCB acceptUniqueOf(String memberAccount) {
    ...
    public HpColQyOperand<MbMemberCB> columnQuery(final SpecifyQuery<MbMemberCB> leftSpecifyQuery) {
        return xcreateColQyOperand(new HpColQyHandler<MbMemberCB>() {

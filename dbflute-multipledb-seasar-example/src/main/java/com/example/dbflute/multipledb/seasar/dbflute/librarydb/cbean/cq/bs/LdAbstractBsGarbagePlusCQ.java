...
public abstract class LdAbstractBsGarbagePlusCQ extends AbstractConditionQuery {
    ...
    public HpSSQFunction<LdGarbagePlusCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, LdGarbagePlusCB.class);
    }
    ...
    public HpSSQFunction<LdGarbagePlusCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, LdGarbagePlusCB.class);
    }
    ...
    public HpSSQFunction<LdGarbagePlusCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, LdGarbagePlusCB.class);
    }
    ...
    public HpSSQFunction<LdGarbagePlusCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, LdGarbagePlusCB.class);
    }
    ...
    public HpSSQFunction<LdGarbagePlusCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, LdGarbagePlusCB.class);
    }
    ...
    public HpSSQFunction<LdGarbagePlusCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, LdGarbagePlusCB.class);
    }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected LdGarbagePlusCB newMyCB() {

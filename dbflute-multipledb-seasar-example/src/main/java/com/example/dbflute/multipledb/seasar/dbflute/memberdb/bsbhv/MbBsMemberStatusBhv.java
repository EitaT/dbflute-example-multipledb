 ...
 */
public abstract class MbBsMemberStatusBhv extends AbstractBehaviorWritable<MbMemberStatus, MbMemberStatusCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public MbMemberStatusDbm getDBMeta() { return MbMemberStatusDbm.getInstance(); }
    ...
    protected <ENTITY extends MbMemberStatus> OptionalEntity<ENTITY> doSelectOptionalEntity(MbMemberStatusCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MbMemberStatus> ENTITY doSelectByPK(String memberStatusCode, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberStatusCode), tp);
    }

    protected <ENTITY extends MbMemberStatus> OptionalEntity<ENTITY> doSelectOptionalByPK(String memberStatusCode, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MbMemberStatus> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer displayOrder, Class<? extends ENTITY> tp) {
     ...
     *     public ConditionBean setup(MbMemberStatus entity, MbMemberStatusCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
    ...
    public OutsideSqlBasicExecutor<MbMemberStatusBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<MbMemberStatusBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends MbMemberStatus> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends MbMemberStatus> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends MbMemberStatus> typeOfSelectedEntity() { return MbMemberStatus.class; }
    protected Class<MbMemberStatus> typeOfHandlingEntity() { return MbMemberStatus.class; }
    protected Class<MbMemberStatusCB> typeOfHandlingConditionBean() { return MbMemberStatusCB.class; }
}

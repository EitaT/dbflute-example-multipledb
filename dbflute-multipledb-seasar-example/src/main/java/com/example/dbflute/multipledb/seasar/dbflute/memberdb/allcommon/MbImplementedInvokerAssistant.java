 ...
 */
public class MbImplementedInvokerAssistant implements InvokerAssistant {
    ...
    protected MbDBFluteInitializer _introduction;
    ...
    public DataSource assistDataSource() { // DI component
        ...
        DataSourceHandler handler = MbDBFluteConfig.getInstance().getDataSourceHandler();
    ...
    protected MbImplementedSqlClauseCreator newImplementedSqlClauseCreator() {
        return new MbImplementedSqlClauseCreator();
    }
    ...
    protected StatementFactory createStatementFactory() {
        ...
        factory.setInternalDebug(MbDBFluteConfig.getInstance().isInternalDebug());
        factory.setCursorSelectFetchSize(MbDBFluteConfig.getInstance().getCursorSelectFetchSize());
        return factory;
    }

    protected TnStatementFactoryImpl newStatementFactoryImpl() {
        final Integer entitySelectFetchSize = MbDBFluteConfig.getInstance().getEntitySelectFetchSize();
    ...
    protected OutsideSqlExecutorFactory createOutsideSqlExecutorFactory() {
        OutsideSqlExecutorFactory factory = MbDBFluteConfig.getInstance().getOutsideSqlExecutorFactory();
        if (factory != null) {
            return factory;
        }
    ...
    protected SQLExceptionDigger createSQLExceptionDigger() {
        return MbDBFluteConfig.getInstance().getSQLExceptionDigger();
    }
    ...
    protected SequenceCacheHandler createSequenceCacheHandler() {
        ...
        SequenceCacheKeyGenerator generator = MbDBFluteConfig.getInstance().getSequenceCacheKeyGenerator();
        if (generator != null) {
            handler.setSequenceCacheKeyGenerator(generator);
        }
        handler.setInternalDebug(MbDBFluteConfig.getInstance().isInternalDebug());
        return handler;
    }
    ...
    public StatementConfig assistDefaultStatementConfig() {
        return MbDBFluteConfig.getInstance().getDefaultStatementConfig();
    }
    ...
    public GearedCipherManager assistGearedCipherManager() {
        return MbDBFluteConfig.getInstance().getGearedCipherManager();
    }
    ...
    protected ResourceParameter createResourceParameter() {
        ...
        parameter.setOutsideSqlPackage(MbDBFluteConfig.getInstance().getOutsideSqlPackage());
        parameter.setLogDateFormat(MbDBFluteConfig.getInstance().getLogDateFormat());
        parameter.setLogTimestampFormat(MbDBFluteConfig.getInstance().getLogTimestampFormat());
        parameter.setInternalDebug(MbDBFluteConfig.getInstance().isInternalDebug());
        return parameter;
    }
    ...
    public void setIntroduction(MbDBFluteInitializer introduction) {

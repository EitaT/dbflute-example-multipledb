...
public class MbImplementedInvokerAssistant implements InvokerAssistant {
    ...
    protected SqlClauseCreator createSqlClauseCreator() {
        ...
        return new MbImplementedSqlClauseCreator(); // as default
    }
    ...
    public ResourceParameter assistResourceParameter() {
        ...
        resourceParameter.setOutsideSqlPackage(MbDBFluteConfig.getInstance().getOutsideSqlPackage());
        resourceParameter.setLogDateFormat(MbDBFluteConfig.getInstance().getLogDateFormat());
        resourceParameter.setLogTimestampFormat(MbDBFluteConfig.getInstance().getLogTimestampFormat());
        resourceParameter.setInternalDebug(MbDBFluteConfig.getInstance().isInternalDebug());

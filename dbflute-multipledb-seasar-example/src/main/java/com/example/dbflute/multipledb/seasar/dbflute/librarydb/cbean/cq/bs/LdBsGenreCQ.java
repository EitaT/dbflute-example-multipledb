...
public class LdBsGenreCQ extends LdAbstractBsGenreCQ {
    ...
    public String keepGenreCode_ExistsReferrer_BookList(LdBookCQ subQuery) {
        if (_genreCode_ExistsReferrer_BookListMap == null) { _genreCode_ExistsReferrer_BookListMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_genreCode_ExistsReferrer_BookListMap.size() + 1);
        _genreCode_ExistsReferrer_BookListMap.put(key, subQuery); return "genreCode_ExistsReferrer_BookList." + key;
    }
    ...
    public String keepGenreCode_ExistsReferrer_GenreSelfList(LdGenreCQ subQuery) {
        if (_genreCode_ExistsReferrer_GenreSelfListMap == null) { _genreCode_ExistsReferrer_GenreSelfListMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_genreCode_ExistsReferrer_GenreSelfListMap.size() + 1);
        _genreCode_ExistsReferrer_GenreSelfListMap.put(key, subQuery); return "genreCode_ExistsReferrer_GenreSelfList." + key;
    }
    ...
    public String keepGenreCode_NotExistsReferrer_BookList(LdBookCQ subQuery) {
        if (_genreCode_NotExistsReferrer_BookListMap == null) { _genreCode_NotExistsReferrer_BookListMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_genreCode_NotExistsReferrer_BookListMap.size() + 1);
        _genreCode_NotExistsReferrer_BookListMap.put(key, subQuery); return "genreCode_NotExistsReferrer_BookList." + key;
    }
    ...
    public String keepGenreCode_NotExistsReferrer_GenreSelfList(LdGenreCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_genreCode_NotExistsReferrer_GenreSelfListMap.size() + 1);
        _genreCode_NotExistsReferrer_GenreSelfListMap.put(key, subQuery); return "genreCode_NotExistsReferrer_GenreSelfList." + key;
    }
    ...
    public String keepGenreCode_InScopeRelation_BookList(LdBookCQ subQuery) {
        if (_genreCode_InScopeRelation_BookListMap == null) { _genreCode_InScopeRelation_BookListMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_genreCode_InScopeRelation_BookListMap.size() + 1);
        _genreCode_InScopeRelation_BookListMap.put(key, subQuery); return "genreCode_InScopeRelation_BookList." + key;
    }
    ...
    public String keepGenreCode_InScopeRelation_GenreSelfList(LdGenreCQ subQuery) {
        if (_genreCode_InScopeRelation_GenreSelfListMap == null) { _genreCode_InScopeRelation_GenreSelfListMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_genreCode_InScopeRelation_GenreSelfListMap.size() + 1);
        _genreCode_InScopeRelation_GenreSelfListMap.put(key, subQuery); return "genreCode_InScopeRelation_GenreSelfList." + key;
    }
    ...
    public String keepGenreCode_NotInScopeRelation_BookList(LdBookCQ subQuery) {
        if (_genreCode_NotInScopeRelation_BookListMap == null) { _genreCode_NotInScopeRelation_BookListMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_genreCode_NotInScopeRelation_BookListMap.size() + 1);
        _genreCode_NotInScopeRelation_BookListMap.put(key, subQuery); return "genreCode_NotInScopeRelation_BookList." + key;
    }
    ...
    public String keepGenreCode_NotInScopeRelation_GenreSelfList(LdGenreCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_genreCode_NotInScopeRelation_GenreSelfListMap.size() + 1);
        _genreCode_NotInScopeRelation_GenreSelfListMap.put(key, subQuery); return "genreCode_NotInScopeRelation_GenreSelfList." + key;
    }
    ...
    public String keepParentGenreCode_InScopeRelation_GenreSelf(LdGenreCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_parentGenreCode_InScopeRelation_GenreSelfMap.size() + 1);
        _parentGenreCode_InScopeRelation_GenreSelfMap.put(key, subQuery); return "parentGenreCode_InScopeRelation_GenreSelf." + key;
    }
    ...
    public String keepParentGenreCode_NotInScopeRelation_GenreSelf(LdGenreCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_parentGenreCode_NotInScopeRelation_GenreSelfMap.size() + 1);
        _parentGenreCode_NotInScopeRelation_GenreSelfMap.put(key, subQuery); return "parentGenreCode_NotInScopeRelation_GenreSelf." + key;
    }

...
public class MbBsServiceRankCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;MbServiceRankCB&gt;() {
    ...
    public void union(UnionQuery<MbServiceRankCB> unionQuery) {
        final MbServiceRankCB cb = new MbServiceRankCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;MbServiceRankCB&gt;() {
     *     public void query(MbServiceRankCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<MbServiceRankCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #FD4747">derivedMemberServiceList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;MbMemberServiceCB&gt;() {
         *     public void query(MbMemberServiceCB subCB) {
         *         subCB.specify().<span style="color: #FD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, MbMemberService.<span style="color: #FD4747">ALIAS_foo...</span>);
         * </pre>
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;MbServiceRankCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;MbServiceRankCB&gt;() {
     ...
     *     public void query(MbServiceRankCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MbServiceRankCB&gt;() {

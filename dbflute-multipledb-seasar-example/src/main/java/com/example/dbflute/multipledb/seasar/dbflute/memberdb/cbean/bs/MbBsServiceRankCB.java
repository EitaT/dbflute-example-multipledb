 ...
 */
public class MbBsServiceRankCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MbServiceRankCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public MbBsServiceRankCB() {
     ...
     */
    public MbServiceRankCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return getConditionQuery();
    }

    public MbServiceRankCQ getConditionQuery() { // public for parameter comment and internal
    ...
    protected MbServiceRankCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MbServiceRankCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MbServiceRankCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MbServiceRankCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MbServiceRankCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;MbServiceRankCB&gt;() {
     *     public void query(MbServiceRankCB unionCB) {
     ...
     */
    public void union(UnionQuery<MbServiceRankCB> unionQuery) {
        final MbServiceRankCB cb = new MbServiceRankCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MbServiceRankCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;MbServiceRankCB&gt;() {
     *     public void query(MbServiceRankCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<MbServiceRankCB> unionQuery) {
        final MbServiceRankCB cb = new MbServiceRankCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MbServiceRankCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<MbServiceRankCQ>() {
                public boolean has() { return true; }
                public MbServiceRankCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<MbServiceRankCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MbServiceRankCQ> qyCall
         ...
         * <pre>
         * cb.specify().<span style="color: #DD4747">derivedMemberServiceList()</span>.<span style="color: #DD4747">max</span>(new SubQuery&lt;MbMemberServiceCB&gt;() {
         *     public void query(MbMemberServiceCB subCB) {
         *         subCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, MbMemberService.<span style="color: #DD4747">ALIAS_foo...</span>);
         * </pre>
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;MbServiceRankCB&gt;() {
     *     public void query(MbServiceRankCB cb) {
     *         cb.specify().<span style="color: #DD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;MbServiceRankCB&gt;() {
     *     public void query(MbServiceRankCB cb) {
     ...
     */
    public HpColQyOperand<MbServiceRankCB> columnQuery(final SpecifyQuery<MbServiceRankCB> leftSpecifyQuery) {
        return new HpColQyOperand<MbServiceRankCB>(new HpColQyHandler<MbServiceRankCB>() {
            public HpCalculator handle(SpecifyQuery<MbServiceRankCB> rightSp, String operand) {
                return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), leftSpecifyQuery, rightSp, operand);
            }
        });
    }

    protected MbServiceRankCB xcreateColumnQueryCB() {
        MbServiceRankCB cb = new MbServiceRankCB();
        cb.xsetupForColumnQuery((MbServiceRankCB)this);
        return cb;
    }
     ...
     */
    public MbServiceRankCB dreamCruiseCB() {
        MbServiceRankCB cb = new MbServiceRankCB();
        cb.xsetupForDreamCruise((MbServiceRankCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;MbServiceRankCB&gt;() {
     *     public void query(MbServiceRankCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<MbServiceRankCB> orQuery) {
        xorSQ((MbServiceRankCB)this, orQuery);
    }
     ...
     *     public void query(MbServiceRankCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MbServiceRankCB&gt;() {
     *             public void query(MbServiceRankCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MbServiceRankCB> andQuery) {
        xorSQAP((MbServiceRankCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MbServiceRankCB cb;
        if (mainCB != null) {
            cb = (MbServiceRankCB)mainCB;
        } else {
            cb = new MbServiceRankCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<MbServiceRankCQ>() {
            public boolean has() { return true; }
            public MbServiceRankCQ qy() { return cb.query(); }
        });
    }
    ...
    protected String getConditionBeanClassNameInternally() { return MbServiceRankCB.class.getName(); }
    protected String getConditionQueryClassNameInternally() { return MbServiceRankCQ.class.getName(); }

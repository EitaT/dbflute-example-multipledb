 ...
 */
public abstract class MbBsPurchaseMaxPriceMember implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.customize.dbmeta.MbPurchaseMaxPriceMemberDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsPurchaseMaxPriceMember)) { return false; }
        MbBsPurchaseMaxPriceMember otherEntity = (MbBsPurchaseMaxPriceMember)other;
     ...
     */
    public MbPurchaseMaxPriceMember clone() {
        try {
            return (MbPurchaseMaxPriceMember)super.clone();

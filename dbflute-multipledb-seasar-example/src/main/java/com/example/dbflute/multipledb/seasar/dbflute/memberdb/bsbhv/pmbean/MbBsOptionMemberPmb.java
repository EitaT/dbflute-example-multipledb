 ...
 * This is related to "<span style="color: #AD4747">selectOptionMember</span>" on MbMemberBhv.
 * @author DBFlute(AutoGenerator)
 */
public class MbBsOptionMemberPmb implements ListHandlingPmb<MbMemberBhv, MbOptionMember>, EntityHandlingPmb<MbMemberBhv, MbOptionMember>, FetchBean {
    ...
    /** The parameter of memberName:like. */
     ...
     */
    public Class<MbOptionMember> getEntityType() {
        return MbOptionMember.class;
    }
    ...
    /**
     * [set as likeSearch] memberName:like <br />
     * @param memberName The value of memberName. (NullAllowed)
     * @param memberNameOption The option of likeSearch for memberName which is NOT split mode. (NotNull)
     */
    public void setMemberName(String memberName, LikeSearchOption memberNameOption) {
        assertLikeSearchOptionValid("memberNameOption", memberNameOption);

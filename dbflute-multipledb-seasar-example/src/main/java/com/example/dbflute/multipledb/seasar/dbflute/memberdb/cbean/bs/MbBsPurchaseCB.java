 ...
 */
public class MbBsPurchaseCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public MbPurchaseCB acceptUniqueOf(Integer memberId, Integer productId, java.sql.Timestamp purchaseDatetime) {
    ...
    public MbPurchaseCQ getConditionQuery() { // public for parameter comment and internal
    ...
    protected MbPurchaseCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MbPurchaseCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MbPurchaseCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MbPurchaseCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;MbPurchaseCB&gt;() {
     *     public void query(MbPurchaseCB unionCB) {
     ...
     */
    public void union(UnionQuery<MbPurchaseCB> unionQuery) {
        final MbPurchaseCB cb = new MbPurchaseCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MbPurchaseCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;MbPurchaseCB&gt;() {
     *     public void query(MbPurchaseCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<MbPurchaseCB> unionQuery) {
        final MbPurchaseCB cb = new MbPurchaseCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MbPurchaseCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * MbPurchase purchase = purchaseBhv.selectEntityWithDeletedCheck(cb);
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<MbPurchaseCQ>() {
                public boolean has() { return true; }
                public MbPurchaseCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<MbPurchaseCQ> {
        protected MbMemberCB.HpSpecification _member;
        protected MbProductCB.HpSpecification _product;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MbPurchaseCQ> qyCall
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryProduct()
                    || qyCall().qy().xgetReferrerQuery() instanceof MbProductCQ) {
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public MbProductCB.HpSpecification specifyProduct() {
            assertRelation("product");
            if (_product == null) {
                _product = new MbProductCB.HpSpecification(_baseCB, new HpSpQyCall<MbProductCQ>() {
                    ...
                    , _purpose, _dbmetaProvider);
                if (xhasSyncQyCall()) { // inherits it
                    _product.xsetSyncQyCall(new HpSpQyCall<MbProductCQ>() {
                        public boolean has() { return xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryProduct(); }
                        public MbProductCQ qy() { return xsyncQyCall().qy().queryProduct(); }
                    });
                }
            }
            return _product;
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;MbPurchaseCB&gt;() {
     *     public void query(MbPurchaseCB cb) {
     *         cb.specify().<span style="color: #DD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;MbPurchaseCB&gt;() {
     *     public void query(MbPurchaseCB cb) {
     ...
     */
    public HpColQyOperand<MbPurchaseCB> columnQuery(final SpecifyQuery<MbPurchaseCB> leftSpecifyQuery) {
        return new HpColQyOperand<MbPurchaseCB>(new HpColQyHandler<MbPurchaseCB>() {
            public HpCalculator handle(SpecifyQuery<MbPurchaseCB> rightSp, String operand) {
     ...
     */
    public MbPurchaseCB dreamCruiseCB() {
        MbPurchaseCB cb = new MbPurchaseCB();
        cb.xsetupForDreamCruise((MbPurchaseCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;MbPurchaseCB&gt;() {
     *     public void query(MbPurchaseCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<MbPurchaseCB> orQuery) {
        xorSQ((MbPurchaseCB)this, orQuery);
    }
     ...
     *     public void query(MbPurchaseCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MbPurchaseCB&gt;() {
     *             public void query(MbPurchaseCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MbPurchaseCB> andQuery) {
        xorSQAP((MbPurchaseCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MbPurchaseCB cb;
        if (mainCB != null) {
            cb = (MbPurchaseCB)mainCB;
        } else {
            cb = new MbPurchaseCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<MbPurchaseCQ>() {
            public boolean has() { return true; }
            public MbPurchaseCQ qy() { return cb.query(); }
        });
    }
    ...
    protected String getConditionBeanClassNameInternally() { return MbPurchaseCB.class.getName(); }
    protected String getConditionQueryClassNameInternally() { return MbPurchaseCQ.class.getName(); }

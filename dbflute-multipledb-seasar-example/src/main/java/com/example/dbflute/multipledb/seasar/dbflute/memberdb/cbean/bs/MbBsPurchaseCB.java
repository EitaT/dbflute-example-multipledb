...
public class MbBsPurchaseCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;MbPurchaseCB&gt;() {
    ...
    public void union(UnionQuery<MbPurchaseCB> unionQuery) {
        final MbPurchaseCB cb = new MbPurchaseCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;MbPurchaseCB&gt;() {
     *     public void query(MbPurchaseCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;MbPurchaseCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;MbPurchaseCB&gt;() {
     ...
     *     public void query(MbPurchaseCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MbPurchaseCB&gt;() {

...
public abstract class MbAbstractBsMemberWithdrawalCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public MbAbstractBsMemberWithdrawalCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public void inScopeWithdrawalReason(SubQuery<MbWithdrawalReasonCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        MbWithdrawalReasonCB cb = new MbWithdrawalReasonCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
    ...
    public abstract String keepWithdrawalReasonCode_InScopeRelation_WithdrawalReason(MbWithdrawalReasonCQ sq);
    ...
    public abstract String keepWithdrawalReasonCode_NotInScopeRelation_WithdrawalReason(MbWithdrawalReasonCQ sq);
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_Equal()</span>.max(new SubQuery&lt;MbMemberWithdrawalCB&gt;() {
    ...
    public HpSSQFunction<MbMemberWithdrawalCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, MbMemberWithdrawalCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;MbMemberWithdrawalCB&gt;() {
     *     public void query(MbMemberWithdrawalCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
    ...
    public HpSSQFunction<MbMemberWithdrawalCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, MbMemberWithdrawalCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;MbMemberWithdrawalCB&gt;() {
     *     public void query(MbMemberWithdrawalCB subCB) {
    ...
    public HpSSQFunction<MbMemberWithdrawalCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, MbMemberWithdrawalCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessThan()</span>.max(new SubQuery&lt;MbMemberWithdrawalCB&gt;() {
     *     public void query(MbMemberWithdrawalCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<MbMemberWithdrawalCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, MbMemberWithdrawalCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;MbMemberWithdrawalCB&gt;() {
     *     public void query(MbMemberWithdrawalCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<MbMemberWithdrawalCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, MbMemberWithdrawalCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;MbMemberWithdrawalCB&gt;() {
     *     public void query(MbMemberWithdrawalCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<MbMemberWithdrawalCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, MbMemberWithdrawalCB.class);
    }
    ...
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<MbMemberWithdrawalCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
    ...
    public abstract String keepSpecifyMyselfDerived(MbMemberWithdrawalCQ sq);
    ...
    public abstract String keepQueryMyselfDerived(MbMemberWithdrawalCQ sq);
    ...
    public void myselfExists(SubQuery<MbMemberWithdrawalCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        MbMemberWithdrawalCB cb = new MbMemberWithdrawalCB(); cb.xsetupForMyselfExists(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(MbMemberWithdrawalCQ sq);
    ...
    public void myselfInScope(SubQuery<MbMemberWithdrawalCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        MbMemberWithdrawalCB cb = new MbMemberWithdrawalCB(); cb.xsetupForMyselfInScope(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepMyselfInScope(cb.query());
        registerMyselfInScope(cb.query(), pp);
    }
    public abstract String keepMyselfInScope(MbMemberWithdrawalCQ sq);

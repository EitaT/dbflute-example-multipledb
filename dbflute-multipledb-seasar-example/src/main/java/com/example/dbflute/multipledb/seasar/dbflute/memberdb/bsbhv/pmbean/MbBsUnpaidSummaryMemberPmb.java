 ...
 * This is related to "<span style="color: #AD4747">selectUnpaidSummaryMember</span>" on MbMemberBhv.
 * @author DBFlute(AutoGenerator)
 */
public class MbBsUnpaidSummaryMemberPmb extends SimplePagingBean implements EntityHandlingPmb<MbMemberBhv, MbUnpaidSummaryMember>, AutoPagingHandlingPmb<MbMemberBhv, MbUnpaidSummaryMember>, FetchBean {
     ...
     * This is related to "<span style="color: #AD4747">selectUnpaidSummaryMember</span>" on MbMemberBhv.
     */
    public MbBsUnpaidSummaryMemberPmb() {
     ...
     */
    public Class<MbUnpaidSummaryMember> getEntityType() {
        return MbUnpaidSummaryMember.class;
    }
    ...
    public void setMemberStatusCode_Provisional() {
        _memberStatusCode = MbCDef.MemberStatus.Provisional.code();
    }
    ...
    public void setMemberStatusCode_Formalized() {
        _memberStatusCode = MbCDef.MemberStatus.Formalized.code();
    }
    ...
    public void setMemberStatusCode_Withdrawal() {
        _memberStatusCode = MbCDef.MemberStatus.Withdrawal.code();
    }

...
public abstract class LdAbstractBsCollectionStatusCQ extends AbstractConditionQuery {
    ...
    public void inScopeCollectionStatusLookup(SubQuery<LdCollectionStatusLookupCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        LdCollectionStatusLookupCB cb = new LdCollectionStatusLookupCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepCollectionStatusCode_InScopeRelation_CollectionStatusLookup(cb.query());
    ...
    public void notInScopeCollectionStatusLookup(SubQuery<LdCollectionStatusLookupCB> subQuery) {
        ...
        LdCollectionStatusLookupCB cb = new LdCollectionStatusLookupCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepCollectionStatusCode_NotInScopeRelation_CollectionStatusLookup(cb.query());
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_Equal()</span>.max(new SubQuery&lt;LdCollectionStatusCB&gt;() {
    ...
    public HpSSQFunction<LdCollectionStatusCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ.getOperand(), LdCollectionStatusCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;LdCollectionStatusCB&gt;() {
     *     public void query(LdCollectionStatusCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
    ...
    public HpSSQFunction<LdCollectionStatusCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES.getOperand(), LdCollectionStatusCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;LdCollectionStatusCB&gt;() {
     *     public void query(LdCollectionStatusCB subCB) {
    ...
    public HpSSQFunction<LdCollectionStatusCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT.getOperand(), LdCollectionStatusCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessThan()</span>.max(new SubQuery&lt;LdCollectionStatusCB&gt;() {
     *     public void query(LdCollectionStatusCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<LdCollectionStatusCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT.getOperand(), LdCollectionStatusCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;LdCollectionStatusCB&gt;() {
     *     public void query(LdCollectionStatusCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<LdCollectionStatusCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE.getOperand(), LdCollectionStatusCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;LdCollectionStatusCB&gt;() {
     *     public void query(LdCollectionStatusCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<LdCollectionStatusCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE.getOperand(), LdCollectionStatusCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSSQOption<CB> op) {
        assertObjectNotNull("subQuery", sq);
        LdCollectionStatusCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
    ...
    protected LdCollectionStatusCB xcreateScalarConditionCB() {
        LdCollectionStatusCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected LdCollectionStatusCB xcreateScalarConditionPartitionByCB() {
        LdCollectionStatusCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }
    ...
    public HpQDRFunction<LdCollectionStatusCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(LdCollectionStatusCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        LdCollectionStatusCB cb = new LdCollectionStatusCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "COLLECTION_ID";
    ...
    public void myselfExists(SubQuery<LdCollectionStatusCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        LdCollectionStatusCB cb = new LdCollectionStatusCB(); cb.xsetupForMyselfExists(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
    ...
    public void myselfInScope(SubQuery<LdCollectionStatusCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        LdCollectionStatusCB cb = new LdCollectionStatusCB(); cb.xsetupForMyselfInScope(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected LdCollectionStatusCB newMyCB() {

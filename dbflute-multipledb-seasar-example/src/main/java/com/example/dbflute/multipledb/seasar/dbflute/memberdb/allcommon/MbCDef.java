 ...
 */
public interface MbCDef extends Classification {
     ...
     * フラグを示す
     */
    public enum Flg implements MbCDef {
        /** True: 有効を示す */
        ...
        public ClassificationMeta meta() { return MbCDef.DefMeta.Flg; }
     ...
     * 会員の状態を示す
     */
    public enum MemberStatus implements MbCDef {
        /** Provisional: 仮会員を示す */
        ...
        private String[] sisters() { return _sisters; }
        public Map<String, Object> subItemMap() { return EMPTY_SUB_ITEM_MAP; }
        public ClassificationMeta meta() { return MbCDef.DefMeta.MemberStatus; }
    ...
    public enum DefMeta implements ClassificationMeta {
        ...
        public Classification codeOf(Object code) {
            if ("Flg".equals(name())) { return MbCDef.Flg.codeOf(code); }
            if ("MemberStatus".equals(name())) { return MbCDef.MemberStatus.codeOf(code); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public Classification nameOf(String name) {
            if ("Flg".equals(name())) { return MbCDef.Flg.valueOf(name); }
            if ("MemberStatus".equals(name())) { return MbCDef.MemberStatus.valueOf(name); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public List<Classification> listAll() {
            if ("Flg".equals(name())) { return toClassificationList(MbCDef.Flg.listAll()); }
            if ("MemberStatus".equals(name())) { return toClassificationList(MbCDef.MemberStatus.listAll()); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

        public List<Classification> groupOf(String groupName) {
            if ("Flg".equals(name())) { return toClassificationList(MbCDef.Flg.groupOf(groupName)); }
            if ("MemberStatus".equals(name())) { return toClassificationList(MbCDef.MemberStatus.groupOf(groupName)); }
            throw new IllegalStateException("Unknown definition: " + this); // basically unreachable
        }

 ...
 */
public abstract class MbAbstractBsMemberLoginCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public MbAbstractBsMemberLoginCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void setMobileLoginFlg_Equal_AsFlg(MbCDef.Flg cdef) {
    ...
    public void setMobileLoginFlg_Equal_True() {
        setMobileLoginFlg_Equal_AsFlg(MbCDef.Flg.True);
    }
    ...
    public void setMobileLoginFlg_Equal_False() {
        setMobileLoginFlg_Equal_AsFlg(MbCDef.Flg.False);
    }
     ...
     * @param cdef The instance of classification definition (as ENUM type). (NullAllowed: if null, no condition)
     */
    public void setMobileLoginFlg_NotEqual_AsFlg(MbCDef.Flg cdef) {
    ...
    public void setMobileLoginFlg_NotEqual_True() {
        setMobileLoginFlg_NotEqual_AsFlg(MbCDef.Flg.True);
    }
    ...
    public void setMobileLoginFlg_NotEqual_False() {
        setMobileLoginFlg_NotEqual_AsFlg(MbCDef.Flg.False);
    }
     ...
     */
    public void setMobileLoginFlg_InScope_AsFlg(Collection<MbCDef.Flg> cdefList) {
    ...
    public abstract String keepLoginMemberStatusCode_InScopeRelation_MemberStatus(MbMemberStatusCQ subQuery);
    ...
    public abstract String keepLoginMemberStatusCode_NotInScopeRelation_MemberStatus(MbMemberStatusCQ subQuery);
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_Equal()</span>.max(new SubQuery&lt;MbMemberLoginCB&gt;() {
     ...
     */
    public HpSSQFunction<MbMemberLoginCB> scalar_Equal() {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;MbMemberLoginCB&gt;() {
     *     public void query(MbMemberLoginCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MbMemberLoginCB> scalar_NotEqual() {
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;MbMemberLoginCB&gt;() {
     *     public void query(MbMemberLoginCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MbMemberLoginCB> scalar_GreaterThan() {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessThan()</span>.max(new SubQuery&lt;MbMemberLoginCB&gt;() {
     *     public void query(MbMemberLoginCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MbMemberLoginCB> scalar_LessThan() {
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;MbMemberLoginCB&gt;() {
     *     public void query(MbMemberLoginCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MbMemberLoginCB> scalar_GreaterEqual() {
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;MbMemberLoginCB&gt;() {
     *     public void query(MbMemberLoginCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MbMemberLoginCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE.getOperand());
    }

    protected HpSSQFunction<MbMemberLoginCB> xcreateSSQFunction(final String operand) {
        return new HpSSQFunction<MbMemberLoginCB>(new HpSSQSetupper<MbMemberLoginCB>() {
            public void setup(String function, SubQuery<MbMemberLoginCB> subQuery, HpSSQOption<MbMemberLoginCB> option) {
                xscalarCondition(function, subQuery, operand, option);
            }
        });
    }

    protected void xscalarCondition(String function, SubQuery<MbMemberLoginCB> subQuery, String operand, HpSSQOption<MbMemberLoginCB> option) {
        assertObjectNotNull("subQuery<MbMemberLoginCB>", subQuery);
        MbMemberLoginCB cb = xcreateScalarConditionCB(); subQuery.query(cb);
        String subQueryPropertyName = keepScalarCondition(cb.query()); // for saving query-value
        option.setPartitionByCBean(xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(function, cb.query(), subQueryPropertyName, operand, option);
    }
    public abstract String keepScalarCondition(MbMemberLoginCQ subQuery);

    protected MbMemberLoginCB xcreateScalarConditionCB() {
        MbMemberLoginCB cb = new MbMemberLoginCB();
        cb.xsetupForScalarCondition(this);
        return cb;
    }

    protected MbMemberLoginCB xcreateScalarConditionPartitionByCB() {
        MbMemberLoginCB cb = new MbMemberLoginCB();
    ...
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String function, SubQuery<MbMemberLoginCB> subQuery, String aliasName, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<MbMemberLoginCB>", subQuery);
    ...
    public abstract String keepSpecifyMyselfDerived(MbMemberLoginCQ subQuery);

    /**
     * Prepare for (Query)MyselfDerived (SubQuery).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<MbMemberLoginCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived();
    }
    protected HpQDRFunction<MbMemberLoginCB> xcreateQDRFunctionMyselfDerived() {
    ...
    public void xqderiveMyselfDerived(String function, SubQuery<MbMemberLoginCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<MbMemberLoginCB>", subQuery);
        MbMemberLoginCB cb = new MbMemberLoginCB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
    ...
    public abstract String keepQueryMyselfDerived(MbMemberLoginCQ subQuery);
     ...
     */
    public void myselfExists(SubQuery<MbMemberLoginCB> subQuery) {
        assertObjectNotNull("subQuery<MbMemberLoginCB>", subQuery);
        MbMemberLoginCB cb = new MbMemberLoginCB(); cb.xsetupForMyselfExists(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfExists(cb.query()); // for saving query-value.
        registerMyselfExists(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfExists(MbMemberLoginCQ subQuery);
     ...
     * @param subQuery The implementation of sub query. (NotNull)
     */
    public void myselfInScope(SubQuery<MbMemberLoginCB> subQuery) {
        assertObjectNotNull("subQuery<MbMemberLoginCB>", subQuery);
        MbMemberLoginCB cb = new MbMemberLoginCB(); cb.xsetupForMyselfInScope(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfInScope(cb.query()); // for saving query-value.
        registerMyselfInScope(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfInScope(MbMemberLoginCQ subQuery);

    // ===================================================================================
    //                                                                       Very Internal
    //                                                                       =============
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabCB() { return MbMemberLoginCB.class.getName(); }
    protected String xabCQ() { return MbMemberLoginCQ.class.getName(); }

...
public abstract class MbAbstractBsMemberLoginCQ extends AbstractConditionQuery {
    ...
    public HpSSQFunction<MbMemberLoginCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, MbMemberLoginCB.class);
    }
    ...
    public HpSSQFunction<MbMemberLoginCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, MbMemberLoginCB.class);
    }
    ...
    public HpSSQFunction<MbMemberLoginCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, MbMemberLoginCB.class);
    }
    ...
    public HpSSQFunction<MbMemberLoginCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, MbMemberLoginCB.class);
    }
    ...
    public HpSSQFunction<MbMemberLoginCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, MbMemberLoginCB.class);
    }
    ...
    public HpSSQFunction<MbMemberLoginCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, MbMemberLoginCB.class);
    }

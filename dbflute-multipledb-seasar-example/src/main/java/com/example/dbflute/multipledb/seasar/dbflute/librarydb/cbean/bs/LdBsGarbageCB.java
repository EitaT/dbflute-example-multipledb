 ...
 */
public class LdBsGarbageCB extends AbstractConditionBean {
    ...
    public LdGarbageCQ getConditionQuery() { // public for parameter comment and internal
    ...
    protected LdGarbageCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected LdGarbageCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        LdGarbageCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected LdGarbageCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;LdGarbageCB&gt;() {
     ...
     */
    public void union(UnionQuery<LdGarbageCB> unionQuery) {
        final LdGarbageCB cb = new LdGarbageCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;LdGarbageCB&gt;() {
     *     public void query(LdGarbageCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<LdGarbageCB> unionQuery) {
        final LdGarbageCB cb = new LdGarbageCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<LdGarbageCQ>() {
                public boolean has() { return true; }
                public LdGarbageCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<LdGarbageCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<LdGarbageCQ> qyCall
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;LdGarbageCB&gt;() {
     *     public void query(LdGarbageCB cb) {
     *         cb.specify().<span style="color: #DD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;LdGarbageCB&gt;() {
     *     public void query(LdGarbageCB cb) {
     ...
     */
    public LdGarbageCB dreamCruiseCB() {
        LdGarbageCB cb = new LdGarbageCB();
        cb.xsetupForDreamCruise((LdGarbageCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;LdGarbageCB&gt;() {
     *     public void query(LdGarbageCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<LdGarbageCB> orQuery) {
     ...
     *     public void query(LdGarbageCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;LdGarbageCB&gt;() {
     *             public void query(LdGarbageCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<LdGarbageCB> andQuery) {
        xorSQAP((LdGarbageCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final LdGarbageCB cb;
        if (mainCB != null) {
            cb = (LdGarbageCB)mainCB;
        } else {
            cb = new LdGarbageCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<LdGarbageCQ>() {
            public boolean has() { return true; }
            public LdGarbageCQ qy() { return cb.query(); }
        });
    }

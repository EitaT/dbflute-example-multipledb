...
public abstract class MbBsMemberAddressBhv extends AbstractBehaviorWritable<MbMemberAddress, MbMemberAddressCB> {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends MbMemberAddress> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends MbMemberAddress> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {

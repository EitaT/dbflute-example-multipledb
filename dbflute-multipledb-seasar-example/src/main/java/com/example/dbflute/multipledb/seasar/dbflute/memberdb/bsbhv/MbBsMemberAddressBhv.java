...
public abstract class MbBsMemberAddressBhv extends AbstractBehaviorWritable {
    ...
    protected int facadeSelectCount(MbMemberAddressCB cb) {
    ...
    protected MbMemberAddress facadeSelectEntityWithDeletedCheck(MbMemberAddressCB cb) {
    ...
    protected <ENTITY extends MbMemberAddress> ENTITY doSelectByPK(Integer memberAddressId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberAddressId), tp);
    }

    protected <ENTITY extends MbMemberAddress> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer memberAddressId, Class<ENTITY> tp) {
    ...
    protected <ENTITY extends MbMemberAddress> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer memberId, java.util.Date validBeginDate, Class<ENTITY> tp) {
    ...
    protected ListResultBean<MbMemberAddress> facadeSelectList(MbMemberAddressCB cb) {
    ...
    protected PagingResultBean<MbMemberAddress> facadeSelectPage(MbMemberAddressCB cb) {
    ...
    protected void facadeSelectCursor(MbMemberAddressCB cb, EntityRowHandler<MbMemberAddress> entityRowHandler) {
    ...
    protected <RESULT> HpSLSFunction<MbMemberAddressCB, RESULT> facadeScalarSelect(Class<RESULT> resultType) {
        return doScalarSelect(resultType, newConditionBean());
    }

    protected <RESULT, CB extends MbMemberAddressCB> HpSLSFunction<CB, RESULT> doScalarSelect(final Class<RESULT> tp, final CB cb) {
    ...
    protected void doInsert(MbMemberAddress et, InsertOption<MbMemberAddressCB> op) {
    ...
    protected void doUpdate(MbMemberAddress et, UpdateOption<MbMemberAddressCB> op) {
    ...
    { MbMemberAddressCB cb = newConditionBean(); cb.xsetupForVaryingUpdate(); return cb; }

    protected MbMemberAddressCB createCBForSpecifiedUpdate()
    { MbMemberAddressCB cb = newConditionBean(); cb.xsetupForSpecifiedUpdate(); return cb; }
    ...
    protected void doUpdateNonstrict(MbMemberAddress et, UpdateOption<MbMemberAddressCB> op) {
    ...
    protected void doInsertOrUpdate(MbMemberAddress et, InsertOption<MbMemberAddressCB> iop, UpdateOption<MbMemberAddressCB> uop) {
    ...
    protected void doInsertOrUpdateNonstrict(MbMemberAddress et, InsertOption<MbMemberAddressCB> iop, UpdateOption<MbMemberAddressCB> uop) {
        assertObjectNotNull("memberAddress", et); helpInsertOrUpdateNonstrictInternally(et, iop, uop);
    }
    ...
    protected void doDelete(MbMemberAddress et, final DeleteOption<MbMemberAddressCB> op) {
        assertObjectNotNull("memberAddress", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<MbMemberAddressCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected void doDeleteNonstrict(MbMemberAddress et, final DeleteOption<MbMemberAddressCB> op) {
    ...
    protected int[] doBatchInsert(List<MbMemberAddress> ls, InsertOption<MbMemberAddressCB> op) {
        assertObjectNotNull("memberAddressList", ls);
        InsertOption<MbMemberAddressCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainInsertOption(); }
        prepareBatchInsertOption(ls, rlop); // required
        return delegateBatchInsert(ls, rlop);
    }

    protected void prepareBatchInsertOption(List<MbMemberAddress> ls, InsertOption<MbMemberAddressCB> op) {
    ...
    protected int[] doBatchUpdate(List<MbMemberAddress> ls, UpdateOption<MbMemberAddressCB> op) {
        assertObjectNotNull("memberAddressList", ls);
        UpdateOption<MbMemberAddressCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
        prepareBatchUpdateOption(ls, rlop); // required
        return delegateBatchUpdate(ls, rlop);
    }

    protected void prepareBatchUpdateOption(List<MbMemberAddress> ls, UpdateOption<MbMemberAddressCB> op) {
    ...
    protected int[] doBatchUpdateNonstrict(List<MbMemberAddress> ls, UpdateOption<MbMemberAddressCB> op) {
        assertObjectNotNull("memberAddressList", ls);
        UpdateOption<MbMemberAddressCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
    ...
    protected int[] doBatchDelete(List<MbMemberAddress> ls, DeleteOption<MbMemberAddressCB> op) {
        assertObjectNotNull("memberAddressList", ls);
    ...
    protected int[] doBatchDeleteNonstrict(List<MbMemberAddress> ls, DeleteOption<MbMemberAddressCB> op) {
        assertObjectNotNull("memberAddressList", ls);
        prepareDeleteOption(op);
    ...
    protected int doQueryInsert(QueryInsertSetupper<MbMemberAddress, MbMemberAddressCB> sp, InsertOption<MbMemberAddressCB> op) {
        ...
        MbMemberAddress et = newEntity(); MbMemberAddressCB cb = createCBForQueryInsert();
        return delegateQueryInsert(et, cb, sp.setup(et, cb), op);
    }

    protected MbMemberAddressCB createCBForQueryInsert()
    { MbMemberAddressCB cb = newConditionBean(); cb.xsetupForQueryInsert(); return cb; }
    ...
    protected int doQueryUpdate(MbMemberAddress et, MbMemberAddressCB cb, UpdateOption<MbMemberAddressCB> op) {
        assertObjectNotNull("memberAddress", et); assertCBStateValid(cb); prepareUpdateOption(op);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<MbMemberAddress> typeOfSelectedEntity() { return MbMemberAddress.class; }
    protected MbMemberAddress downcast(Entity et) { return helpEntityDowncastInternally(et, MbMemberAddress.class); }
    protected MbMemberAddressCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, MbMemberAddressCB.class); }
    @SuppressWarnings("unchecked")
    protected List<MbMemberAddress> downcast(List<? extends Entity> ls) { return (List<MbMemberAddress>)ls; }
    @SuppressWarnings("unchecked")
    protected InsertOption<MbMemberAddressCB> downcast(InsertOption<? extends ConditionBean> op) { return (InsertOption<MbMemberAddressCB>)op; }
    @SuppressWarnings("unchecked")
    protected UpdateOption<MbMemberAddressCB> downcast(UpdateOption<? extends ConditionBean> op) { return (UpdateOption<MbMemberAddressCB>)op; }
    @SuppressWarnings("unchecked")
    protected DeleteOption<MbMemberAddressCB> downcast(DeleteOption<? extends ConditionBean> op) { return (DeleteOption<MbMemberAddressCB>)op; }
    @SuppressWarnings("unchecked")

...
public class MbBsProductStatusCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public MbProductStatusCB acceptPK(String productStatusCode) {
     ...
     * @return this. (NotNull)
     */
    public MbProductStatusCB acceptUniqueOf(Integer displayOrder) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;MbProductStatusCB&gt;() {
    ...
    public void union(UnionQuery<MbProductStatusCB> unionQuery) {
        final MbProductStatusCB cb = new MbProductStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;MbProductStatusCB&gt;() {
     *     public void query(MbProductStatusCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;MbProductStatusCB&gt;() {
    ...
    public HpColQyOperand<MbProductStatusCB> columnQuery(final SpecifyQuery<MbProductStatusCB> leftSpecifyQuery) {
        return xcreateColQyOperand(new HpColQyHandler<MbProductStatusCB>() {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;MbProductStatusCB&gt;() {
     ...
     *     public void query(MbProductStatusCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MbProductStatusCB&gt;() {

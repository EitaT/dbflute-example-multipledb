...
public abstract class LdBsGarbageBhv extends AbstractBehaviorReadable<LdGarbage, LdGarbageCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public LdGarbageDbm getDBMeta() { return LdGarbageDbm.getInstance(); }
    ...
    public OutsideSqlBasicExecutor<LdGarbageBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<LdGarbageBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends LdGarbage> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends LdGarbage> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {

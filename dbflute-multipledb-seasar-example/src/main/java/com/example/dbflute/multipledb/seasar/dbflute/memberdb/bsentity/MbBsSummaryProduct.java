 ...
 */
public abstract class MbBsSummaryProduct implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsSummaryProduct)) { return false; }
        MbBsSummaryProduct otherEntity = (MbBsSummaryProduct)other;
     ...
     */
    public MbSummaryProduct clone() {
        try {
            return (MbSummaryProduct)super.clone();

...
public abstract class MbAbstractBsMemberAddressCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public MbAbstractBsMemberAddressCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public void inScopeRegion(SubQuery<MbRegionCB> subQuery) {
        ...
        MbRegionCB cb = new MbRegionCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
    ...
    public abstract String keepRegionId_InScopeRelation_Region(MbRegionCQ subQuery);
    ...
    public abstract String keepRegionId_NotInScopeRelation_Region(MbRegionCQ subQuery);
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_Equal()</span>.max(new SubQuery&lt;MbMemberAddressCB&gt;() {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;MbMemberAddressCB&gt;() {
     *     public void query(MbMemberAddressCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;MbMemberAddressCB&gt;() {
     *     public void query(MbMemberAddressCB subCB) {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessThan()</span>.max(new SubQuery&lt;MbMemberAddressCB&gt;() {
     *     public void query(MbMemberAddressCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;MbMemberAddressCB&gt;() {
     *     public void query(MbMemberAddressCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;MbMemberAddressCB&gt;() {
     *     public void query(MbMemberAddressCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    protected HpSSQFunction<MbMemberAddressCB> xcreateSSQFunction(final String operand) {
        return new HpSSQFunction<MbMemberAddressCB>(new HpSSQSetupper<MbMemberAddressCB>() {
            public void setup(String function, SubQuery<MbMemberAddressCB> subQuery, HpSSQOption<MbMemberAddressCB> option) {
                xscalarCondition(function, subQuery, operand, option);
            }
        });
    }

    protected void xscalarCondition(String function, SubQuery<MbMemberAddressCB> subQuery, String operand, HpSSQOption<MbMemberAddressCB> option) {
        assertObjectNotNull("subQuery<MbMemberAddressCB>", subQuery);
        MbMemberAddressCB cb = xcreateScalarConditionCB(); subQuery.query(cb);
        String subQueryPropertyName = keepScalarCondition(cb.query()); // for saving query-value
        option.setPartitionByCBean(xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(function, cb.query(), subQueryPropertyName, operand, option);
    }
    public abstract String keepScalarCondition(MbMemberAddressCQ subQuery);
    ...
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String function, SubQuery<MbMemberAddressCB> subQuery, String aliasName, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<MbMemberAddressCB>", subQuery);
    ...
    public abstract String keepSpecifyMyselfDerived(MbMemberAddressCQ subQuery);
    ...
    protected HpQDRFunction<MbMemberAddressCB> xcreateQDRFunctionMyselfDerived() {
    ...
    public void xqderiveMyselfDerived(String function, SubQuery<MbMemberAddressCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<MbMemberAddressCB>", subQuery);
        MbMemberAddressCB cb = new MbMemberAddressCB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
    ...
    public abstract String keepQueryMyselfDerived(MbMemberAddressCQ subQuery);
    ...
    public void myselfExists(SubQuery<MbMemberAddressCB> subQuery) {
        assertObjectNotNull("subQuery<MbMemberAddressCB>", subQuery);
        MbMemberAddressCB cb = new MbMemberAddressCB(); cb.xsetupForMyselfExists(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfExists(cb.query()); // for saving query-value.
        registerMyselfExists(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfExists(MbMemberAddressCQ subQuery);
    ...
    public void myselfInScope(SubQuery<MbMemberAddressCB> subQuery) {
        assertObjectNotNull("subQuery<MbMemberAddressCB>", subQuery);
        MbMemberAddressCB cb = new MbMemberAddressCB(); cb.xsetupForMyselfInScope(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfInScope(cb.query()); // for saving query-value.
        registerMyselfInScope(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfInScope(MbMemberAddressCQ subQuery);

    // ===================================================================================
    //                                                                       Very Internal
    //                                                                       =============
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabCB() { return MbMemberAddressCB.class.getName(); }

 ...
 */
public class MbMemberAddressCIQ extends MbAbstractBsMemberAddressCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public MbMemberAddressCIQ(ConditionQuery childQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, MbBsMemberAddressCQ myCQ) {
    ...
    public String keepScalarCondition(MbMemberAddressCQ subQuery)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(MbMemberAddressCQ subQuery)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(MbMemberAddressCQ subQuery)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object parameterValue)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(MbMemberAddressCQ subQuery)
    { throwIICBOE("MyselfExists"); return null;}
    public String keepMyselfInScope(MbMemberAddressCQ subQuery)
    ...
    protected String xinCB() { return MbMemberAddressCB.class.getName(); }
    protected String xinCQ() { return MbMemberAddressCQ.class.getName(); }
}

 ...
 */
public abstract class MbBsMemberLoginBhv extends AbstractBehaviorWritable<MbMemberLogin, MbMemberLoginCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public MbMemberLoginDbm getDBMeta() { return MbMemberLoginDbm.getInstance(); }
    ...
    protected <ENTITY extends MbMemberLogin> OptionalEntity<ENTITY> doSelectOptionalEntity(MbMemberLoginCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MbMemberLogin> ENTITY doSelectByPK(Long memberLoginId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberLoginId), tp);
    }

    protected <ENTITY extends MbMemberLogin> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberLoginId, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MbMemberLogin> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer memberId, java.sql.Timestamp loginDatetime, Class<? extends ENTITY> tp) {
     ...
     *     public ConditionBean setup(MbMemberLogin entity, MbMemberLoginCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
    ...
    public OutsideSqlBasicExecutor<MbMemberLoginBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<MbMemberLoginBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends MbMemberLogin> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends MbMemberLogin> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends MbMemberLogin> typeOfSelectedEntity() { return MbMemberLogin.class; }
    protected Class<MbMemberLogin> typeOfHandlingEntity() { return MbMemberLogin.class; }
    protected Class<MbMemberLoginCB> typeOfHandlingConditionBean() { return MbMemberLoginCB.class; }
}

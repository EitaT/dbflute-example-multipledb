...
public abstract class MbBsMemberLoginBhv extends AbstractBehaviorWritable {
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public MbMemberLogin newEntity() { return new MbMemberLogin(); }

    /** {@inheritDoc} */
    public MbMemberLoginCB newConditionBean() { return new MbMemberLoginCB(); }
    ...
    protected int facadeSelectCount(MbMemberLoginCB cb) {
    ...
    protected MbMemberLogin facadeSelectEntity(MbMemberLoginCB cb) {
    ...
    protected MbMemberLogin facadeSelectEntityWithDeletedCheck(MbMemberLoginCB cb) {
    ...
    protected MbMemberLogin facadeSelectByPKValue(Long memberLoginId) {
        return doSelectByPK(memberLoginId, typeOfSelectedEntity());
    }

    protected <ENTITY extends MbMemberLogin> ENTITY doSelectByPK(Long memberLoginId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberLoginId), tp);
    }

    protected <ENTITY extends MbMemberLogin> OptionalEntity<ENTITY> doSelectOptionalByPK(Long memberLoginId, Class<ENTITY> tp) {
    ...
    protected <ENTITY extends MbMemberLogin> ENTITY doSelectByPKWithDeletedCheck(Long memberLoginId, Class<ENTITY> tp) {
    ...
    protected OptionalEntity<MbMemberLogin> facadeSelectByUniqueOf(Integer memberId, java.sql.Timestamp loginDatetime) {
        return doSelectByUniqueOf(memberId, loginDatetime, typeOfSelectedEntity());
    }

    protected <ENTITY extends MbMemberLogin> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer memberId, java.sql.Timestamp loginDatetime, Class<ENTITY> tp) {
    ...
    protected ListResultBean<MbMemberLogin> facadeSelectList(MbMemberLoginCB cb) {
    ...
    protected PagingResultBean<MbMemberLogin> facadeSelectPage(MbMemberLoginCB cb) {
    ...
    protected void facadeSelectCursor(MbMemberLoginCB cb, EntityRowHandler<MbMemberLogin> entityRowHandler) {
     ...
     */
    public <RESULT> HpSLSFunction<MbMemberLoginCB, RESULT> scalarSelect(Class<RESULT> resultType) {
        return facadeScalarSelect(resultType);
    }

    protected <RESULT> HpSLSFunction<MbMemberLoginCB, RESULT> facadeScalarSelect(Class<RESULT> resultType) {
        return doScalarSelect(resultType, newConditionBean());
    }

    protected <RESULT, CB extends MbMemberLoginCB> HpSLSFunction<CB, RESULT> doScalarSelect(final Class<RESULT> tp, final CB cb) {
     ...
     */
    public void load(List<MbMemberLogin> memberLoginList, ReferrerLoaderHandler<MbLoaderOfMemberLogin> handler) {
        xassLRArg(memberLoginList, handler);
        handler.handle(new MbLoaderOfMemberLogin().ready(memberLoginList, _behaviorSelector));
    }
     ...
     * @param handler The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(MbMemberLogin memberLogin, ReferrerLoaderHandler<MbLoaderOfMemberLogin> handler) {
        xassLRArg(memberLogin, handler);
        handler.handle(new MbLoaderOfMemberLogin().ready(xnewLRAryLs(memberLogin), _behaviorSelector));
    }
    ...
    protected void doInsert(MbMemberLogin et, InsertOption<MbMemberLoginCB> op) {
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(MbMemberLogin memberLogin) {
        doUpdate(memberLogin, null);
    }

    protected void doUpdate(MbMemberLogin et, UpdateOption<MbMemberLoginCB> op) {
    ...
    { MbMemberLoginCB cb = newConditionBean(); cb.xsetupForVaryingUpdate(); return cb; }

    protected MbMemberLoginCB createCBForSpecifiedUpdate()
    { MbMemberLoginCB cb = newConditionBean(); cb.xsetupForSpecifiedUpdate(); return cb; }
    ...
    protected void doInsertOrUpdate(MbMemberLogin et, InsertOption<MbMemberLoginCB> iop, UpdateOption<MbMemberLoginCB> uop) {
    ...
    protected void doDelete(MbMemberLogin et, final DeleteOption<MbMemberLoginCB> op) {
        assertObjectNotNull("memberLogin", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<MbMemberLoginCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int[] doBatchInsert(List<MbMemberLogin> ls, InsertOption<MbMemberLoginCB> op) {
        assertObjectNotNull("memberLoginList", ls);
        InsertOption<MbMemberLoginCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainInsertOption(); }
        prepareBatchInsertOption(ls, rlop); // required
        return delegateBatchInsert(ls, rlop);
    }

    protected void prepareBatchInsertOption(List<MbMemberLogin> ls, InsertOption<MbMemberLoginCB> op) {
    ...
    protected int[] doBatchUpdate(List<MbMemberLogin> ls, UpdateOption<MbMemberLoginCB> op) {
        assertObjectNotNull("memberLoginList", ls);
        UpdateOption<MbMemberLoginCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
        prepareBatchUpdateOption(ls, rlop); // required
        return delegateBatchUpdate(ls, rlop);
    }

    protected void prepareBatchUpdateOption(List<MbMemberLogin> ls, UpdateOption<MbMemberLoginCB> op) {
    ...
    protected int[] doBatchDelete(List<MbMemberLogin> ls, DeleteOption<MbMemberLoginCB> op) {
        assertObjectNotNull("memberLoginList", ls);
    ...
    protected int doQueryInsert(QueryInsertSetupper<MbMemberLogin, MbMemberLoginCB> sp, InsertOption<MbMemberLoginCB> op) {
        ...
        MbMemberLogin et = newEntity(); MbMemberLoginCB cb = createCBForQueryInsert();
        return delegateQueryInsert(et, cb, sp.setup(et, cb), op);
    }

    protected MbMemberLoginCB createCBForQueryInsert()
    { MbMemberLoginCB cb = newConditionBean(); cb.xsetupForQueryInsert(); return cb; }
    ...
    protected int doQueryUpdate(MbMemberLogin et, MbMemberLoginCB cb, UpdateOption<MbMemberLoginCB> op) {
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<MbMemberLogin> typeOfSelectedEntity() { return MbMemberLogin.class; }
    protected MbMemberLogin downcast(Entity et) { return helpEntityDowncastInternally(et, MbMemberLogin.class); }
    protected MbMemberLoginCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, MbMemberLoginCB.class); }
    @SuppressWarnings("unchecked")
    protected List<MbMemberLogin> downcast(List<? extends Entity> ls) { return (List<MbMemberLogin>)ls; }
    @SuppressWarnings("unchecked")
    protected InsertOption<MbMemberLoginCB> downcast(InsertOption<? extends ConditionBean> op) { return (InsertOption<MbMemberLoginCB>)op; }
    @SuppressWarnings("unchecked")
    protected UpdateOption<MbMemberLoginCB> downcast(UpdateOption<? extends ConditionBean> op) { return (UpdateOption<MbMemberLoginCB>)op; }
    @SuppressWarnings("unchecked")
    protected DeleteOption<MbMemberLoginCB> downcast(DeleteOption<? extends ConditionBean> op) { return (DeleteOption<MbMemberLoginCB>)op; }
    @SuppressWarnings("unchecked")

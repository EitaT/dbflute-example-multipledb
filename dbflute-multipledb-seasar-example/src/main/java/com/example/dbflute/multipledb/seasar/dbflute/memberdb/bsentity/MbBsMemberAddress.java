 ...
 */
public abstract class MbBsMemberAddress implements MbEntityDefinedCommonColumn, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsMemberAddress)) { return false; }
        MbBsMemberAddress otherEntity = (MbBsMemberAddress)other;

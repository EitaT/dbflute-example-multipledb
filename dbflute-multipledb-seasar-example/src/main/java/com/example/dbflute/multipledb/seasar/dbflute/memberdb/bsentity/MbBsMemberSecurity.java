 ...
 */
public abstract class MbBsMemberSecurity implements MbEntityDefinedCommonColumn, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsMemberSecurity)) { return false; }
        MbBsMemberSecurity otherEntity = (MbBsMemberSecurity)other;
     ...
     */
    public MbMemberSecurity clone() {
        try {
            return (MbMemberSecurity)super.clone();

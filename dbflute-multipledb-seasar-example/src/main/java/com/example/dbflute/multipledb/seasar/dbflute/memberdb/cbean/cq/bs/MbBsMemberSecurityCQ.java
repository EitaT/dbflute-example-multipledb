 ...
 */
public class MbBsMemberSecurityCQ extends MbAbstractBsMemberSecurityCQ {
    ...
    protected MbMemberSecurityCIQ xcreateCIQ() {
        MbMemberSecurityCIQ ciq = xnewCIQ();
        ciq.xsetBaseCB(_baseCB);
        return ciq;
    }

    protected MbMemberSecurityCIQ xnewCIQ() {
        return new MbMemberSecurityCIQ(xgetReferrerQuery(), xgetSqlClause(), xgetAliasName(), xgetNestLevel(), this);
    }
    ...
    public MbMemberSecurityCIQ on() {
        ...
        MbMemberSecurityCIQ inlineQuery = inline(); inlineQuery.xsetOnClause(true); return inlineQuery;
    }
     ...
     * @return this. (NotNull)
     */
    public MbBsMemberSecurityCQ addOrderBy_ReminderUseCount_Asc() { regOBA("REMINDER_USE_COUNT"); return this; }
     ...
     * @return this. (NotNull)
     */
    public MbBsMemberSecurityCQ addOrderBy_ReminderUseCount_Desc() { regOBD("REMINDER_USE_COUNT"); return this; }
     ...
     * @return this. (NotNull)
     */
    public MbBsMemberSecurityCQ addSpecifiedDerivedOrderBy_Asc(String aliasName)
     ...
     * @return this. (NotNull)
     */
    public MbBsMemberSecurityCQ addSpecifiedDerivedOrderBy_Desc(String aliasName)
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    protected Map<String, MbMemberSecurityCQ> _scalarConditionMap;
    public Map<String, MbMemberSecurityCQ> getScalarCondition() { return _scalarConditionMap; }
    public String keepScalarCondition(MbMemberSecurityCQ subQuery) {
    ...
    //                                                                       MyselfDerived
    //                                                                       =============
    protected Map<String, MbMemberSecurityCQ> _specifyMyselfDerivedMap;
    public Map<String, MbMemberSecurityCQ> getSpecifyMyselfDerived() { return _specifyMyselfDerivedMap; }
    public String keepSpecifyMyselfDerived(MbMemberSecurityCQ subQuery) {
        if (_specifyMyselfDerivedMap == null) { _specifyMyselfDerivedMap = newLinkedHashMapSized(4); }
        String key = "subQueryMapKey" + (_specifyMyselfDerivedMap.size() + 1);
        _specifyMyselfDerivedMap.put(key, subQuery); return "specifyMyselfDerived." + key;
    }

    protected Map<String, MbMemberSecurityCQ> _queryMyselfDerivedMap;
    public Map<String, MbMemberSecurityCQ> getQueryMyselfDerived() { return _queryMyselfDerivedMap; }
    public String keepQueryMyselfDerived(MbMemberSecurityCQ subQuery) {
    ...
    //                                                                        MyselfExists
    //                                                                        ============
    protected Map<String, MbMemberSecurityCQ> _myselfExistsMap;
    public Map<String, MbMemberSecurityCQ> getMyselfExists() { return _myselfExistsMap; }
    public String keepMyselfExists(MbMemberSecurityCQ subQuery) {
    ...
    //                                                                       MyselfInScope
    //                                                                       =============
    protected Map<String, MbMemberSecurityCQ> _myselfInScopeMap;
    public Map<String, MbMemberSecurityCQ> getMyselfInScope() { return _myselfInScopeMap; }
    public String keepMyselfInScope(MbMemberSecurityCQ subQuery) {

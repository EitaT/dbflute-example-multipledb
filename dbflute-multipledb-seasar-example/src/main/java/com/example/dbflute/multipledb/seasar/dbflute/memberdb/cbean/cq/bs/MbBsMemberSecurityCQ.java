...
public class MbBsMemberSecurityCQ extends MbAbstractBsMemberSecurityCQ {
    ...
    //                                                                     ScalarCondition
    //                                                                     ===============
    public Map<String, MbMemberSecurityCQ> getScalarCondition() { return xgetSQueMap("scalarCondition"); }
    public String keepScalarCondition(MbMemberSecurityCQ sq) { return xkeepSQue("scalarCondition", sq); }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public Map<String, MbMemberSecurityCQ> getSpecifyMyselfDerived() { return xgetSQueMap("specifyMyselfDerived"); }
    public String keepSpecifyMyselfDerived(MbMemberSecurityCQ sq) { return xkeepSQue("specifyMyselfDerived", sq); }

    public Map<String, MbMemberSecurityCQ> getQueryMyselfDerived() { return xgetSQueMap("queryMyselfDerived"); }
    public String keepQueryMyselfDerived(MbMemberSecurityCQ sq) { return xkeepSQue("queryMyselfDerived", sq); }
    ...
    public Map<String, MbMemberSecurityCQ> getMyselfExists() { return xgetSQueMap("myselfExists"); }
    public String keepMyselfExists(MbMemberSecurityCQ sq) { return xkeepSQue("myselfExists", sq); }

    // ===================================================================================
    //                                                                       MyselfInScope
    //                                                                       =============
    public Map<String, MbMemberSecurityCQ> getMyselfInScope() { return xgetSQueMap("myselfInScope"); }
    public String keepMyselfInScope(MbMemberSecurityCQ sq) { return xkeepSQue("myselfInScope", sq); }

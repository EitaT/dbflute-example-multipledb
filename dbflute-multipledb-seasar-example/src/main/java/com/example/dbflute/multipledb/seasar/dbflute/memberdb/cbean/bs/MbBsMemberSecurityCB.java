...
public class MbBsMemberSecurityCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;MbMemberSecurityCB&gt;() {
    ...
    public void union(UnionQuery<MbMemberSecurityCB> unionQuery) {
        final MbMemberSecurityCB cb = new MbMemberSecurityCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;MbMemberSecurityCB&gt;() {
     *     public void query(MbMemberSecurityCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<MbMemberSecurityCQ> {
        ...
        public HpSDRFunction<MbMemberSecurityCB, MbMemberSecurityCQ> myselfDerived() {
            ...
            return new HpSDRFunction<MbMemberSecurityCB, MbMemberSecurityCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<MbMemberSecurityCB, MbMemberSecurityCQ>() {
                public void setup(String function, SubQuery<MbMemberSecurityCB> subQuery, MbMemberSecurityCQ cq, String aliasName, DerivedReferrerOption option) {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;MbMemberSecurityCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;MbMemberSecurityCB&gt;() {
     ...
     *     public void query(MbMemberSecurityCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MbMemberSecurityCB&gt;() {

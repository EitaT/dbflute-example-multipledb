...
public abstract class MbAbstractBsMemberServiceCQ extends AbstractConditionQuery {
    ...
    public void inScopeServiceRank(SubQuery<MbServiceRankCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        MbServiceRankCB cb = new MbServiceRankCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_Equal()</span>.max(new SubQuery&lt;MbMemberServiceCB&gt;() {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;MbMemberServiceCB&gt;() {
     *     public void query(MbMemberServiceCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;MbMemberServiceCB&gt;() {
     *     public void query(MbMemberServiceCB subCB) {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessThan()</span>.max(new SubQuery&lt;MbMemberServiceCB&gt;() {
     *     public void query(MbMemberServiceCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;MbMemberServiceCB&gt;() {
     *     public void query(MbMemberServiceCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;MbMemberServiceCB&gt;() {
     *     public void query(MbMemberServiceCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public void myselfExists(SubQuery<MbMemberServiceCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        MbMemberServiceCB cb = new MbMemberServiceCB(); cb.xsetupForMyselfExists(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
    ...
    public void myselfInScope(SubQuery<MbMemberServiceCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        MbMemberServiceCB cb = new MbMemberServiceCB(); cb.xsetupForMyselfInScope(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }

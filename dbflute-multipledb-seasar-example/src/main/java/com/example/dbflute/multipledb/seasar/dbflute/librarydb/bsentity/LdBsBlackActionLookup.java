 ...
 */
public abstract class LdBsBlackActionLookup implements LdEntityDefinedCommonColumn, Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof LdBsBlackActionLookup)) { return false; }
        LdBsBlackActionLookup other = (LdBsBlackActionLookup)obj;
        if (!xSV(getBlackActionCode(), other.getBlackActionCode())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = xCH(result, getBlackActionCode());
        return result;
    }
    ...
    public String toStringWithRelation() {
        ...
        sb.append(toString());
        String l = "\n  ";
        if (_blackActionList != null) { for (Entity e : _blackActionList)
        { if (e != null) { sb.append(l).append(xbRDS(e, "blackActionList")); } } }
        return sb.toString();
    }
    ...
    protected String buildRelationString() {
        ...
        { sb.append(c).append("blackActionList"); }

 ...
 */
public abstract class LdBsBlackActionLookup extends AbstractEntity implements DomainEntity, LdEntityDefinedCommonColumn {
    ...
    public void setBlackActionName(String blackActionName) {
        registerModifiedProperty("blackActionName");

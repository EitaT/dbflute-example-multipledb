...
public abstract class MbBsProductStatusBhv extends AbstractBehaviorWritable {
    ...
    public MbProductStatus selectByPKValue(String productStatusCode) {
        return doSelectByPK(productStatusCode, MbProductStatus.class);
    }

    protected <ENTITY extends MbProductStatus> ENTITY doSelectByPK(String productStatusCode, Class<ENTITY> entityType) {
        return doSelectEntity(xprepareCBAsPK(productStatusCode), entityType);
    }

    protected <ENTITY extends MbProductStatus> OptionalEntity<ENTITY> doSelectOptionalByPK(String productStatusCode, Class<ENTITY> entityType) {
    ...
    public MbProductStatus selectByPKValueWithDeletedCheck(String productStatusCode) {
        return doSelectByPKWithDeletedCheck(productStatusCode, MbProductStatus.class);
    }

    protected <ENTITY extends MbProductStatus> ENTITY doSelectByPKWithDeletedCheck(String productStatusCode, Class<ENTITY> entityType) {
    ...
    protected MbProductStatusCB xprepareCBAsPK(String productStatusCode) {
        ...
        MbProductStatusCB cb = newMyConditionBean(); cb.acceptPrimaryKey(productStatusCode);
        return cb;
    }
    ...
    public OptionalEntity<MbProductStatus> selectByUniqueOf(Integer displayOrder) {
        return doSelectByUniqueOf(displayOrder, MbProductStatus.class);
    }

    protected <ENTITY extends MbProductStatus> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer displayOrder, Class<ENTITY> entityType) {
    ...
    protected MbProductStatusCB xprepareCBAsUniqueOf(Integer displayOrder) {
        ...
        MbProductStatusCB cb = newMyConditionBean(); cb.acceptUniqueOf(displayOrder);
        return cb;
    }

...
public abstract class MbBsProductStatusBhv extends AbstractBehaviorWritable {
     ...
     * MbProductStatusCB cb = new MbProductStatusCB();
     * cb.query().setFoo...(value);
     * MbProductStatus productStatus = productStatusBhv.<span style="color: #FD4747">selectEntity</span>(cb);
    ...
    protected <ENTITY extends MbProductStatus> ENTITY doSelectEntity(final MbProductStatusCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityInternally(cb, entityType, new InternalSelectEntityCallback<ENTITY, MbProductStatusCB>() {
            public List<ENTITY> callbackSelectList(MbProductStatusCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); } });
    }
     ...
     * MbProductStatusCB cb = new MbProductStatusCB();
     * cb.query().setFoo...(value);
     * MbProductStatus productStatus = productStatusBhv.<span style="color: #FD4747">selectEntityWithDeletedCheck</span>(cb);
    ...
    protected <ENTITY extends MbProductStatus> ENTITY doSelectEntityWithDeletedCheck(final MbProductStatusCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityWithDeletedCheckInternally(cb, entityType, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, MbProductStatusCB>() {
            public List<ENTITY> callbackSelectList(MbProductStatusCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); } });
    }
     ...
     * ListResultBean&lt;MbProductStatus&gt; productStatusList = productStatusBhv.<span style="color: #FD4747">selectList</span>(cb);
    ...
    protected <ENTITY extends MbProductStatus> ListResultBean<ENTITY> doSelectList(MbProductStatusCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", entityType);
        assertSpecifyDerivedReferrerEntityProperty(cb, entityType);
        return helpSelectListInternally(cb, entityType, new InternalSelectListCallback<ENTITY, MbProductStatusCB>() {
            public List<ENTITY> callbackSelectList(MbProductStatusCB cb, Class<ENTITY> entityType) { return delegateSelectList(cb, entityType); } });
    }
     ...
     * PagingResultBean&lt;MbProductStatus&gt; page = productStatusBhv.<span style="color: #FD4747">selectPage</span>(cb);
    ...
    protected <ENTITY extends MbProductStatus> PagingResultBean<ENTITY> doSelectPage(MbProductStatusCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", entityType);
        return helpSelectPageInternally(cb, entityType, new InternalSelectPageCallback<ENTITY, MbProductStatusCB>() {
     ...
     * MbProductStatusCB cb = new MbProductStatusCB();
     * cb.query().setFoo...(value);
     * productStatusBhv.<span style="color: #FD4747">selectCursor</span>(cb, new EntityRowHandler&lt;MbProductStatus&gt;() {
    ...
    protected <ENTITY extends MbProductStatus> void doSelectCursor(MbProductStatusCB cb, EntityRowHandler<ENTITY> entityRowHandler, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityRowHandler<MbProductStatus>", entityRowHandler); assertObjectNotNull("entityType", entityType);
        assertSpecifyDerivedReferrerEntityProperty(cb, entityType);
        helpSelectCursorInternally(cb, entityRowHandler, entityType, new InternalSelectCursorCallback<ENTITY, MbProductStatusCB>() {
            public void callbackSelectCursor(MbProductStatusCB cb, EntityRowHandler<ENTITY> entityRowHandler, Class<ENTITY> entityType) { delegateSelectCursor(cb, entityRowHandler, entityType); }
            public List<ENTITY> callbackSelectList(MbProductStatusCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); }
        });
    }
    ...
    protected <RESULT, CB extends MbProductStatusCB> SLFunction<CB, RESULT> doScalarSelect(Class<RESULT> resultType, CB cb) {
        assertObjectNotNull("resultType", resultType); assertCBStateValid(cb);
        cb.xsetupForScalarSelect(); cb.getSqlClause().disableSelectIndex(); // for when you use union
        return createSLFunction(cb, resultType);
    }

    protected <RESULT, CB extends MbProductStatusCB> SLFunction<CB, RESULT> createSLFunction(CB cb, Class<RESULT> resultType) {
     ...
     */
    public void loadProductList(MbProductStatus productStatus, ConditionBeanSetupper<MbProductCB> conditionBeanSetupper) {
     ...
     * <pre>
     * productStatusBhv.<span style="color: #FD4747">loadProductList</span>(productStatusList, new ConditionBeanSetupper&lt;MbProductCB&gt;() {
     ...
     * @param conditionBeanSetupper The instance of referrer condition-bean set-upper for registering referrer condition. (NotNull)
     */
    public void loadProductList(List<MbProductStatus> productStatusList, ConditionBeanSetupper<MbProductCB> conditionBeanSetupper) {
        xassLRArg(productStatusList, conditionBeanSetupper);
        loadProductList(productStatusList, new LoadReferrerOption<MbProductCB, MbProduct>().xinit(conditionBeanSetupper));
    }
    /**
     * {Refer to overload method that has an argument of the list of entity.}
     * @param productStatus The entity of productStatus. (NotNull)
     ...
     */
    public void loadProductList(MbProductStatus productStatus, LoadReferrerOption<MbProductCB, MbProduct> loadReferrerOption) {
     ...
     * @param loadReferrerOption The option of load-referrer. (NotNull)
     */
    public void loadProductList(List<MbProductStatus> productStatusList, LoadReferrerOption<MbProductCB, MbProduct> loadReferrerOption) {
        ...
        helpLoadReferrerInternally(productStatusList, loadReferrerOption, new InternalLoadReferrerCallback<MbProductStatus, String, MbProductCB, MbProduct>() {
            public String getPKVal(MbProductStatus e)
            ...
            public String getFKVal(MbProduct e) { return e.getProductStatusCode(); }
    ...
    public List<String> extractProductStatusCodeList(List<MbProductStatus> productStatusList) {
        return helpExtractListInternally(productStatusList, new InternalExtractCallback<MbProductStatus, String>() {
            public String getCV(MbProductStatus e) { return e.getProductStatusCode(); }
        });
    }
    ...
    public List<Integer> extractDisplayOrderList(List<MbProductStatus> productStatusList) {
        return helpExtractListInternally(productStatusList, new InternalExtractCallback<MbProductStatus, Integer>() {
            public Integer getCV(MbProductStatus e) { return e.getDisplayOrder(); }
        });
    }
    ...
    protected void doInsert(MbProductStatus productStatus, InsertOption<MbProductStatusCB> option) {
        assertObjectNotNull("productStatus", productStatus);
        prepareInsertOption(option);
        delegateInsert(productStatus, option);
    }

    protected void prepareInsertOption(InsertOption<MbProductStatusCB> option) {
    ...
    protected void doUpdate(MbProductStatus productStatus, final UpdateOption<MbProductStatusCB> option) {
        assertObjectNotNull("productStatus", productStatus);
        prepareUpdateOption(option);
        helpUpdateInternally(productStatus, new InternalUpdateCallback<MbProductStatus>() {
            public int callbackDelegateUpdate(MbProductStatus entity) { return delegateUpdate(entity, option); } });
    }

    protected void prepareUpdateOption(UpdateOption<MbProductStatusCB> option) {
        if (option == null) { return; }
    ...
    protected void doInesrtOrUpdate(MbProductStatus productStatus, final InsertOption<MbProductStatusCB> insertOption, final UpdateOption<MbProductStatusCB> updateOption) {
        helpInsertOrUpdateInternally(productStatus, new InternalInsertOrUpdateCallback<MbProductStatus, MbProductStatusCB>() {
            public void callbackInsert(MbProductStatus entity) { doInsert(entity, insertOption); }
            public void callbackUpdate(MbProductStatus entity) { doUpdate(entity, updateOption); }
    ...
    protected void doCreateOrModify(Entity entity, InsertOption<? extends ConditionBean> insertOption,
        ...
        if (insertOption == null && updateOption == null) { insertOrUpdate(downcast(entity)); }
            ...
            insertOption = insertOption == null ? new InsertOption<MbProductStatusCB>() : insertOption;
            updateOption = updateOption == null ? new UpdateOption<MbProductStatusCB>() : updateOption;
    ...
    protected void doDelete(MbProductStatus productStatus, final DeleteOption<MbProductStatusCB> option) {
        assertObjectNotNull("productStatus", productStatus);
        prepareDeleteOption(option);
        helpDeleteInternally(productStatus, new InternalDeleteCallback<MbProductStatus>() {
            public int callbackDelegateDelete(MbProductStatus entity) { return delegateDelete(entity, option); } });
    }

    protected void prepareDeleteOption(DeleteOption<MbProductStatusCB> option) {
        if (option == null) { return; }
    ...
    public int[] batchInsert(List<MbProductStatus> productStatusList) {
        InsertOption<MbProductStatusCB> option = createInsertUpdateOption();
        return doBatchInsert(productStatusList, option);
    }

    protected int[] doBatchInsert(List<MbProductStatus> productStatusList, InsertOption<MbProductStatusCB> option) {
    ...
    protected void prepareBatchInsertOption(List<MbProductStatus> productStatusList, InsertOption<MbProductStatusCB> option) {
    ...
    public int[] batchUpdate(List<MbProductStatus> productStatusList) {
        UpdateOption<MbProductStatusCB> option = createPlainUpdateOption();
        return doBatchUpdate(productStatusList, option);
    }

    protected int[] doBatchUpdate(List<MbProductStatus> productStatusList, UpdateOption<MbProductStatusCB> option) {
        assertObjectNotNull("productStatusList", productStatusList);
        prepareBatchUpdateOption(productStatusList, option);
        return delegateBatchUpdate(productStatusList, option);
    }

    protected void prepareBatchUpdateOption(List<MbProductStatus> productStatusList, UpdateOption<MbProductStatusCB> option) {
     ...
     * productStatusBhv.<span style="color: #FD4747">batchUpdate</span>(productStatusList, new SpecifyQuery<MbProductStatusCB>() {
    ...
    protected int[] doBatchDelete(List<MbProductStatus> productStatusList, DeleteOption<MbProductStatusCB> option) {
        assertObjectNotNull("productStatusList", productStatusList);
        prepareDeleteOption(option);
     ...
     * <pre>
     * productStatusBhv.<span style="color: #FD4747">queryInsert</span>(new QueryInsertSetupper&lt;MbProductStatus, MbProductStatusCB&gt;() {
    ...
    protected int doQueryInsert(QueryInsertSetupper<MbProductStatus, MbProductStatusCB> setupper, InsertOption<MbProductStatusCB> option) {
        assertObjectNotNull("setupper", setupper);
        prepareInsertOption(option);
        MbProductStatus entity = new MbProductStatus();
        MbProductStatusCB intoCB = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(MbProductStatus productStatus, MbProductStatusCB cb, UpdateOption<MbProductStatusCB> option) {
    ...
    protected int doRangeModify(Entity entity, ConditionBean cb, UpdateOption<? extends ConditionBean> option) {
        if (option == null) { return queryUpdate(downcast(entity), (MbProductStatusCB)cb); }
        else { return varyingQueryUpdate(downcast(entity), (MbProductStatusCB)cb, downcast(option)); }
    }
    ...
    protected int doQueryDelete(MbProductStatusCB cb, DeleteOption<MbProductStatusCB> option) {
        assertCBStateValid(cb);
        prepareDeleteOption(option);
    ...
    protected int doRangeRemove(ConditionBean cb, DeleteOption<? extends ConditionBean> option) {
        if (option == null) { return queryDelete((MbProductStatusCB)cb); }
        else { return varyingQueryDelete((MbProductStatusCB)cb, downcast(option)); }
    }
    ...
    protected <ENTITY extends MbProductStatus> void delegateSelectCursor(MbProductStatusCB cb, EntityRowHandler<ENTITY> erh, Class<ENTITY> et)
    { invoke(createSelectCursorCBCommand(cb, erh, et)); }
    protected <ENTITY extends MbProductStatus> List<ENTITY> delegateSelectList(MbProductStatusCB cb, Class<ENTITY> et)
    { return invoke(createSelectListCBCommand(cb, et)); }

    // -----------------------------------------------------
    //                                                Update
    //                                                ------
    protected int delegateInsert(MbProductStatus e, InsertOption<MbProductStatusCB> op)
    { if (!processBeforeInsert(e, op)) { return 0; }
      return invoke(createInsertEntityCommand(e, op)); }
    protected int delegateUpdate(MbProductStatus e, UpdateOption<MbProductStatusCB> op)
    { if (!processBeforeUpdate(e, op)) { return 0; }
      return delegateUpdateNonstrict(e, op); }
    protected int delegateUpdateNonstrict(MbProductStatus e, UpdateOption<MbProductStatusCB> op)
    { if (!processBeforeUpdate(e, op)) { return 0; }
      return invoke(createUpdateNonstrictEntityCommand(e, op)); }
    protected int delegateDelete(MbProductStatus e, DeleteOption<MbProductStatusCB> op)
    { if (!processBeforeDelete(e, op)) { return 0; }
      return delegateDeleteNonstrict(e, op); }
    protected int delegateDeleteNonstrict(MbProductStatus e, DeleteOption<MbProductStatusCB> op)
    { if (!processBeforeDelete(e, op)) { return 0; }
    ...
    protected int delegateQueryInsert(MbProductStatus e, MbProductStatusCB inCB, ConditionBean resCB, InsertOption<MbProductStatusCB> op)
    { if (!processBeforeQueryInsert(e, inCB, resCB, op)) { return 0; } return invoke(createQueryInsertCBCommand(e, inCB, resCB, op));  }
    protected int delegateQueryUpdate(MbProductStatus e, MbProductStatusCB cb, UpdateOption<MbProductStatusCB> op)
    ...
    //                                                                     Downcast Helper
    //                                                                     ===============
    protected MbProductStatus downcast(Entity entity) {
        return helpEntityDowncastInternally(entity, MbProductStatus.class);
    }
    ...
    protected List<MbProductStatus> downcast(List<? extends Entity> entityList) {
        return (List<MbProductStatus>)entityList;
    }

    @SuppressWarnings("unchecked")
    protected InsertOption<MbProductStatusCB> downcast(InsertOption<? extends ConditionBean> option) {
        return (InsertOption<MbProductStatusCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected UpdateOption<MbProductStatusCB> downcast(UpdateOption<? extends ConditionBean> option) {
        return (UpdateOption<MbProductStatusCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected DeleteOption<MbProductStatusCB> downcast(DeleteOption<? extends ConditionBean> option) {
        return (DeleteOption<MbProductStatusCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected QueryInsertSetupper<MbProductStatus, MbProductStatusCB> downcast(QueryInsertSetupper<? extends Entity, ? extends ConditionBean> option) {
        return (QueryInsertSetupper<MbProductStatus, MbProductStatusCB>)option;
    }
}

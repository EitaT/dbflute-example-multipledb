...
public abstract class MbBsProductStatusBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends MbProductStatus> ENTITY doSelectEntity(final MbProductStatusCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends MbProductStatus> ENTITY doSelectEntityWithDeletedCheck(final MbProductStatusCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends MbProductStatus> ListResultBean<ENTITY> doSelectList(MbProductStatusCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectListInternally(cb, tp, new InternalSelectListCallback<ENTITY, MbProductStatusCB>() {
            public List<ENTITY> callbackSelectList(MbProductStatusCB cb, Class<ENTITY> tp) { return delegateSelectList(cb, tp); } });
    }

...
public abstract class MbBsMemberSecurityBhv extends AbstractBehaviorWritable {
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public MbMemberSecurity newEntity() { return new MbMemberSecurity(); }
    ...
    protected int facadeSelectCount(MbMemberSecurityCB cb) {
    ...
    protected MbMemberSecurity facadeSelectEntityWithDeletedCheck(MbMemberSecurityCB cb) {
    ...
    protected <ENTITY extends MbMemberSecurity> ENTITY doSelectByPK(Integer memberId, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(memberId), tp);
    }

    protected <ENTITY extends MbMemberSecurity> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer memberId, Class<ENTITY> tp) {
    ...
    protected ListResultBean<MbMemberSecurity> facadeSelectList(MbMemberSecurityCB cb) {
    ...
    protected PagingResultBean<MbMemberSecurity> facadeSelectPage(MbMemberSecurityCB cb) {
    ...
    protected void facadeSelectCursor(MbMemberSecurityCB cb, EntityRowHandler<MbMemberSecurity> entityRowHandler) {
    ...
    protected <RESULT> HpSLSFunction<MbMemberSecurityCB, RESULT> facadeScalarSelect(Class<RESULT> resultType) {
        return doScalarSelect(resultType, newConditionBean());
    }

    protected <RESULT, CB extends MbMemberSecurityCB> HpSLSFunction<CB, RESULT> doScalarSelect(final Class<RESULT> tp, final CB cb) {
    ...
    protected void doInsert(MbMemberSecurity et, InsertOption<MbMemberSecurityCB> op) {
    ...
    protected void doUpdate(MbMemberSecurity et, UpdateOption<MbMemberSecurityCB> op) {
    ...
    { MbMemberSecurityCB cb = newConditionBean(); cb.xsetupForVaryingUpdate(); return cb; }

    protected MbMemberSecurityCB createCBForSpecifiedUpdate()
    { MbMemberSecurityCB cb = newConditionBean(); cb.xsetupForSpecifiedUpdate(); return cb; }
    ...
    protected void doUpdateNonstrict(MbMemberSecurity et, UpdateOption<MbMemberSecurityCB> op) {
    ...
    protected void doInsertOrUpdate(MbMemberSecurity et, InsertOption<MbMemberSecurityCB> iop, UpdateOption<MbMemberSecurityCB> uop) {
    ...
    protected void doInsertOrUpdateNonstrict(MbMemberSecurity et, InsertOption<MbMemberSecurityCB> iop, UpdateOption<MbMemberSecurityCB> uop) {
    ...
    protected void doDelete(MbMemberSecurity et, final DeleteOption<MbMemberSecurityCB> op) {
        assertObjectNotNull("memberSecurity", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<MbMemberSecurityCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected void doDeleteNonstrict(MbMemberSecurity et, final DeleteOption<MbMemberSecurityCB> op) {
    ...
    protected int[] doBatchInsert(List<MbMemberSecurity> ls, InsertOption<MbMemberSecurityCB> op) {
        assertObjectNotNull("memberSecurityList", ls);
        InsertOption<MbMemberSecurityCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainInsertOption(); }
        prepareBatchInsertOption(ls, rlop); // required
        return delegateBatchInsert(ls, rlop);
    }

    protected void prepareBatchInsertOption(List<MbMemberSecurity> ls, InsertOption<MbMemberSecurityCB> op) {
    ...
    protected int[] doBatchUpdate(List<MbMemberSecurity> ls, UpdateOption<MbMemberSecurityCB> op) {
        assertObjectNotNull("memberSecurityList", ls);
        UpdateOption<MbMemberSecurityCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
        prepareBatchUpdateOption(ls, rlop); // required
        return delegateBatchUpdate(ls, rlop);
    }

    protected void prepareBatchUpdateOption(List<MbMemberSecurity> ls, UpdateOption<MbMemberSecurityCB> op) {
    ...
    protected int[] doBatchUpdateNonstrict(List<MbMemberSecurity> ls, UpdateOption<MbMemberSecurityCB> op) {
        assertObjectNotNull("memberSecurityList", ls);
        UpdateOption<MbMemberSecurityCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
    ...
    protected int[] doBatchDelete(List<MbMemberSecurity> ls, DeleteOption<MbMemberSecurityCB> op) {
        assertObjectNotNull("memberSecurityList", ls);
    ...
    protected int[] doBatchDeleteNonstrict(List<MbMemberSecurity> ls, DeleteOption<MbMemberSecurityCB> op) {
        assertObjectNotNull("memberSecurityList", ls);
        prepareDeleteOption(op);
    ...
    protected int doQueryInsert(QueryInsertSetupper<MbMemberSecurity, MbMemberSecurityCB> sp, InsertOption<MbMemberSecurityCB> op) {
        ...
        MbMemberSecurity et = newEntity(); MbMemberSecurityCB cb = createCBForQueryInsert();
        return delegateQueryInsert(et, cb, sp.setup(et, cb), op);
    }

    protected MbMemberSecurityCB createCBForQueryInsert()
    { MbMemberSecurityCB cb = newConditionBean(); cb.xsetupForQueryInsert(); return cb; }
    ...
    protected int doQueryUpdate(MbMemberSecurity et, MbMemberSecurityCB cb, UpdateOption<MbMemberSecurityCB> op) {
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<MbMemberSecurity> typeOfSelectedEntity() { return MbMemberSecurity.class; }
    protected MbMemberSecurity downcast(Entity et) { return helpEntityDowncastInternally(et, MbMemberSecurity.class); }
    protected MbMemberSecurityCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, MbMemberSecurityCB.class); }
    @SuppressWarnings("unchecked")
    protected List<MbMemberSecurity> downcast(List<? extends Entity> ls) { return (List<MbMemberSecurity>)ls; }
    @SuppressWarnings("unchecked")
    protected InsertOption<MbMemberSecurityCB> downcast(InsertOption<? extends ConditionBean> op) { return (InsertOption<MbMemberSecurityCB>)op; }
    @SuppressWarnings("unchecked")
    protected UpdateOption<MbMemberSecurityCB> downcast(UpdateOption<? extends ConditionBean> op) { return (UpdateOption<MbMemberSecurityCB>)op; }
    @SuppressWarnings("unchecked")
    protected DeleteOption<MbMemberSecurityCB> downcast(DeleteOption<? extends ConditionBean> op) { return (DeleteOption<MbMemberSecurityCB>)op; }
    @SuppressWarnings("unchecked")

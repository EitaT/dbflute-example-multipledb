...
public class MbBsProductCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;MbProductCB&gt;() {
    ...
    public void union(UnionQuery<MbProductCB> unionQuery) {
        final MbProductCB cb = new MbProductCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;MbProductCB&gt;() {
     *     public void query(MbProductCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<MbProductCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #FD4747">derivedPurchaseList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;MbPurchaseCB&gt;() {
         *     public void query(MbPurchaseCB subCB) {
         *         subCB.specify().<span style="color: #FD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, MbPurchase.<span style="color: #FD4747">ALIAS_foo...</span>);
         * </pre>
        ...
        public HpSDRFunction<MbPurchaseCB, MbProductCQ> derivedPurchaseList() {
            ...
            return new HpSDRFunction<MbPurchaseCB, MbProductCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<MbPurchaseCB, MbProductCQ>() {
                public void setup(String function, SubQuery<MbPurchaseCB> subQuery, MbProductCQ cq, String aliasName, DerivedReferrerOption option) {
        ...
        public HpSDRFunction<MbProductCB, MbProductCQ> myselfDerived() {
            ...
            return new HpSDRFunction<MbProductCB, MbProductCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<MbProductCB, MbProductCQ>() {
                public void setup(String function, SubQuery<MbProductCB> subQuery, MbProductCQ cq, String aliasName, DerivedReferrerOption option) {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;MbProductCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;MbProductCB&gt;() {
     ...
     *     public void query(MbProductCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MbProductCB&gt;() {

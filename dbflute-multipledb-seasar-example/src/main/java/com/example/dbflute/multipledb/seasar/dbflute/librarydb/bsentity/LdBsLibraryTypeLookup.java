...
public abstract class LdBsLibraryTypeLookup implements LdEntityDefinedCommonColumn, Serializable, Cloneable {
    ...
    public int hashCode() {
        ...
        result = xCH(result, getLibraryTypeCode());
        return result;
    }
    ...
    public String toStringWithRelation() {
        ...
        sb.append(toString());
        String l = "\n  ";
        if (_libraryList != null) { for (Entity e : _libraryList)
        { if (e != null) { sb.append(l).append(xbRDS(e, "libraryList")); } } }
        return sb.toString();
    }
    ...
    protected String buildRelationString() {
        ...
        { sb.append(c).append("libraryList"); }

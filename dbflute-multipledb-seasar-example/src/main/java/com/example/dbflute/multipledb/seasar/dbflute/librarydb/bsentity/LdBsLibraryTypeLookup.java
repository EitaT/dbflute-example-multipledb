 ...
 */
public abstract class LdBsLibraryTypeLookup implements LdEntityDefinedCommonColumn, Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof LdBsLibraryTypeLookup)) { return false; }
        LdBsLibraryTypeLookup other = (LdBsLibraryTypeLookup)obj;
        if (!xSV(getLibraryTypeCode(), other.getLibraryTypeCode())) { return false; }
        return true;
    }
    ...
    public String toStringWithRelation() {
        ...
        sb.append(toString());
        String li = "\n  ";
        if (_libraryList != null) { for (Entity et : _libraryList)
    ...
    protected String buildColumnString() {
        ...
        sb.append(dm).append(getLibraryTypeName());
    ...
    protected String buildRelationString() {
        ...
        { sb.append(cm).append("libraryList"); }

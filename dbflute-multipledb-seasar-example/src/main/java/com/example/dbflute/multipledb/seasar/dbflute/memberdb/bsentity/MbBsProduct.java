 ...
 */
public abstract class MbBsProduct implements MbEntityDefinedCommonColumn, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsProduct)) { return false; }
        MbBsProduct otherEntity = (MbBsProduct)other;
     ...
     */
    public MbProduct clone() {
        try {
            return (MbProduct)super.clone();

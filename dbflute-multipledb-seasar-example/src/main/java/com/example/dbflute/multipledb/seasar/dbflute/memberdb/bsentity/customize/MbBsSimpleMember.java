 ...
 */
public abstract class MbBsSimpleMember implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.multipledb.seasar.dbflute.memberdb.bsentity.customize.dbmeta.MbSimpleMemberDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsSimpleMember)) { return false; }
        MbBsSimpleMember otherEntity = (MbBsSimpleMember)other;
     ...
     */
    public MbSimpleMember clone() {
        try {
            return (MbSimpleMember)super.clone();

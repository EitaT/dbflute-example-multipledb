...
public class MbBsMemberServiceCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;MbMemberServiceCB&gt;() {
    ...
    public void union(UnionQuery<MbMemberServiceCB> unionQuery) {
        final MbMemberServiceCB cb = new MbMemberServiceCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;MbMemberServiceCB&gt;() {
     *     public void query(MbMemberServiceCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<MbMemberServiceCQ> {
        ...
        public HpSDRFunction<MbMemberServiceCB, MbMemberServiceCQ> myselfDerived() {
            ...
            return new HpSDRFunction<MbMemberServiceCB, MbMemberServiceCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<MbMemberServiceCB, MbMemberServiceCQ>() {
                public void setup(String function, SubQuery<MbMemberServiceCB> subQuery, MbMemberServiceCQ cq, String aliasName, DerivedReferrerOption option) {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;MbMemberServiceCB&gt;() {
    ...
    public HpColQyOperand<MbMemberServiceCB> columnQuery(final SpecifyQuery<MbMemberServiceCB> leftSpecifyQuery) {
        return new HpColQyOperand<MbMemberServiceCB>(new HpColQyHandler<MbMemberServiceCB>() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;MbMemberServiceCB&gt;() {
     ...
     *     public void query(MbMemberServiceCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MbMemberServiceCB&gt;() {

...
public abstract class MbAbstractBsPurchaseCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public MbAbstractBsPurchaseCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public abstract String keepProductId_InScopeRelation_Product(MbProductCQ subQuery);
    ...
    public abstract String keepProductId_NotInScopeRelation_Product(MbProductCQ subQuery);
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_Equal()</span>.max(new SubQuery&lt;MbPurchaseCB&gt;() {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;MbPurchaseCB&gt;() {
     *     public void query(MbPurchaseCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;MbPurchaseCB&gt;() {
     *     public void query(MbPurchaseCB subCB) {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessThan()</span>.max(new SubQuery&lt;MbPurchaseCB&gt;() {
     *     public void query(MbPurchaseCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;MbPurchaseCB&gt;() {
     *     public void query(MbPurchaseCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;MbPurchaseCB&gt;() {
     *     public void query(MbPurchaseCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    protected HpSSQFunction<MbPurchaseCB> xcreateSSQFunction(final String operand) {
        return new HpSSQFunction<MbPurchaseCB>(new HpSSQSetupper<MbPurchaseCB>() {
            public void setup(String function, SubQuery<MbPurchaseCB> subQuery, HpSSQOption<MbPurchaseCB> option) {
                xscalarCondition(function, subQuery, operand, option);
            }
        });
    }

    protected void xscalarCondition(String function, SubQuery<MbPurchaseCB> subQuery, String operand, HpSSQOption<MbPurchaseCB> option) {
        assertObjectNotNull("subQuery<MbPurchaseCB>", subQuery);
        MbPurchaseCB cb = xcreateScalarConditionCB(); subQuery.query(cb);
        String subQueryPropertyName = keepScalarCondition(cb.query()); // for saving query-value
        option.setPartitionByCBean(xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(function, cb.query(), subQueryPropertyName, operand, option);
    }
    public abstract String keepScalarCondition(MbPurchaseCQ subQuery);
    ...
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String function, SubQuery<MbPurchaseCB> subQuery, String aliasName, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<MbPurchaseCB>", subQuery);
    ...
    public abstract String keepSpecifyMyselfDerived(MbPurchaseCQ subQuery);
    ...
    public void xqderiveMyselfDerived(String function, SubQuery<MbPurchaseCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<MbPurchaseCB>", subQuery);
        MbPurchaseCB cb = new MbPurchaseCB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
    ...
    public abstract String keepQueryMyselfDerived(MbPurchaseCQ subQuery);
    ...
    public void myselfExists(SubQuery<MbPurchaseCB> subQuery) {
        assertObjectNotNull("subQuery<MbPurchaseCB>", subQuery);
        MbPurchaseCB cb = new MbPurchaseCB(); cb.xsetupForMyselfExists(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfExists(cb.query()); // for saving query-value.
        registerMyselfExists(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfExists(MbPurchaseCQ subQuery);
    ...
    public void myselfInScope(SubQuery<MbPurchaseCB> subQuery) {
        assertObjectNotNull("subQuery<MbPurchaseCB>", subQuery);
        MbPurchaseCB cb = new MbPurchaseCB(); cb.xsetupForMyselfInScope(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfInScope(cb.query()); // for saving query-value.
        registerMyselfInScope(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfInScope(MbPurchaseCQ subQuery);

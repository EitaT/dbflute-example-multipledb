 ...
 */
public abstract class MbBsMemberStatus implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MbBsMemberStatus)) { return false; }
        MbBsMemberStatus otherEntity = (MbBsMemberStatus)other;

 ...
 */
public abstract class MbBsMemberStatus extends AbstractEntity implements DomainEntity {
    ...
    protected List<MbMember> _memberList;
     ...
     */
    public List<MbMember> getMemberList() {
     ...
     */
    public void setMemberList(List<MbMember> memberList) {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof MbBsMemberStatus) {
            MbBsMemberStatus other = (MbBsMemberStatus)obj;
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_memberList != null) { for (MbMember et : _memberList)
    ...
    @Override
    public MbMemberStatus clone() {
        return (MbMemberStatus)super.clone();
    }

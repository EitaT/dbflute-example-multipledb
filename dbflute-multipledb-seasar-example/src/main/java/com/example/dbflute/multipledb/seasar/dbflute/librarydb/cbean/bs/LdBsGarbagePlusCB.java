 ...
 */
public class LdBsGarbagePlusCB extends AbstractConditionBean {
    ...
    public LdGarbagePlusCQ getConditionQuery() { // public for parameter comment and internal
    ...
    protected LdGarbagePlusCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected LdGarbagePlusCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        LdGarbagePlusCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected LdGarbagePlusCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;LdGarbagePlusCB&gt;() {
     ...
     */
    public void union(UnionQuery<LdGarbagePlusCB> unionQuery) {
        final LdGarbagePlusCB cb = new LdGarbagePlusCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;LdGarbagePlusCB&gt;() {
     *     public void query(LdGarbagePlusCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<LdGarbagePlusCB> unionQuery) {
        final LdGarbagePlusCB cb = new LdGarbagePlusCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionQuery.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<LdGarbagePlusCQ>() {
                public boolean has() { return true; }
                public LdGarbagePlusCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<LdGarbagePlusCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<LdGarbagePlusCQ> qyCall
         ...
         */
        public HpSpecifiedColumn columnGarbageMemo() { return doColumn("GARBAGE_MEMO"); }
        /**
         * GARBAGE_TIME: {TIMESTAMP(26, 6)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnGarbageTime() { return doColumn("GARBAGE_TIME"); }
        /**
         * GARBAGE_COUNT: {INTEGER(10)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnGarbageCount() { return doColumn("GARBAGE_COUNT"); }
        /**
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;LdGarbagePlusCB&gt;() {
     *     public void query(LdGarbagePlusCB cb) {
     *         cb.specify().<span style="color: #DD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;LdGarbagePlusCB&gt;() {
     *     public void query(LdGarbagePlusCB cb) {
     ...
     */
    public HpColQyOperand<LdGarbagePlusCB> columnQuery(final SpecifyQuery<LdGarbagePlusCB> leftSpecifyQuery) {
        return new HpColQyOperand<LdGarbagePlusCB>(new HpColQyHandler<LdGarbagePlusCB>() {
            public HpCalculator handle(SpecifyQuery<LdGarbagePlusCB> rightSp, String operand) {
     ...
     */
    public LdGarbagePlusCB dreamCruiseCB() {
        LdGarbagePlusCB cb = new LdGarbagePlusCB();
        cb.xsetupForDreamCruise((LdGarbagePlusCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;LdGarbagePlusCB&gt;() {
     *     public void query(LdGarbagePlusCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<LdGarbagePlusCB> orQuery) {
        xorSQ((LdGarbagePlusCB)this, orQuery);
    }
     ...
     *     public void query(LdGarbagePlusCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;LdGarbagePlusCB&gt;() {
     *             public void query(LdGarbagePlusCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<LdGarbagePlusCB> andQuery) {
        xorSQAP((LdGarbagePlusCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final LdGarbagePlusCB cb;
        if (mainCB != null) {
            cb = (LdGarbagePlusCB)mainCB;
        } else {
            cb = new LdGarbagePlusCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<LdGarbagePlusCQ>() {
            public boolean has() { return true; }
            public LdGarbagePlusCQ qy() { return cb.query(); }
        });
    }

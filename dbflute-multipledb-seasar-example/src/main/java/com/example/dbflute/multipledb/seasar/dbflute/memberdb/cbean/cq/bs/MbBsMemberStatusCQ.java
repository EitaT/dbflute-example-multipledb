...
public class MbBsMemberStatusCQ extends MbAbstractBsMemberStatusCQ {
    ...
    public String keepMemberStatusCode_ExistsReferrer_MemberList(MbMemberCQ subQuery) {
    ...
    public String keepMemberStatusCode_ExistsReferrer_MemberLoginList(MbMemberLoginCQ subQuery) {
    ...
    public String keepMemberStatusCode_NotExistsReferrer_MemberList(MbMemberCQ subQuery) {
    ...
    public String keepMemberStatusCode_NotExistsReferrer_MemberLoginList(MbMemberLoginCQ subQuery) {
    ...
    public String keepMemberStatusCode_InScopeRelation_MemberList(MbMemberCQ subQuery) {
    ...
    public String keepMemberStatusCode_InScopeRelation_MemberLoginList(MbMemberLoginCQ subQuery) {
    ...
    public String keepMemberStatusCode_NotInScopeRelation_MemberList(MbMemberCQ subQuery) {
    ...
    public String keepMemberStatusCode_NotInScopeRelation_MemberLoginList(MbMemberLoginCQ subQuery) {
    ...
    public String keepMemberStatusCode_SpecifyDerivedReferrer_MemberList(MbMemberCQ subQuery) {
    ...
    public String keepMemberStatusCode_SpecifyDerivedReferrer_MemberLoginList(MbMemberLoginCQ subQuery) {
    ...
    public String keepMemberStatusCode_QueryDerivedReferrer_MemberList(MbMemberCQ subQuery) {
    ...
    public String keepMemberStatusCode_QueryDerivedReferrer_MemberLoginList(MbMemberLoginCQ subQuery) {

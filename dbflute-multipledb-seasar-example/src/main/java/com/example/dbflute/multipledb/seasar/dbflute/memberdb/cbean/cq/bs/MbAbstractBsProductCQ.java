 ...
 */
public abstract class MbAbstractBsProductCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public MbAbstractBsProductCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public abstract String keepProductId_ExistsReferrer_PurchaseList(MbPurchaseCQ subQuery);
    ...
    public abstract String keepProductId_NotExistsReferrer_PurchaseList(MbPurchaseCQ subQuery);
    ...
    public abstract String keepProductId_InScopeRelation_PurchaseList(MbPurchaseCQ subQuery);
    ...
    public abstract String keepProductId_NotInScopeRelation_PurchaseList(MbPurchaseCQ subQuery);
    ...
    public abstract String keepProductId_SpecifyDerivedReferrer_PurchaseList(MbPurchaseCQ subQuery);
     ...
     */
    public void inScopeProductCategory(SubQuery<MbProductCategoryCB> subQuery) {
    ...
    public abstract String keepProductCategoryCode_InScopeRelation_ProductCategory(MbProductCategoryCQ subQuery);
     ...
     */
    public void notInScopeProductCategory(SubQuery<MbProductCategoryCB> subQuery) {
        assertObjectNotNull("subQuery<MbProductCategoryCB>", subQuery);
        MbProductCategoryCB cb = new MbProductCategoryCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
    ...
    public abstract String keepProductCategoryCode_NotInScopeRelation_ProductCategory(MbProductCategoryCQ subQuery);
     ...
     */
    public void inScopeProductStatus(SubQuery<MbProductStatusCB> subQuery) {
        assertObjectNotNull("subQuery<MbProductStatusCB>", subQuery);
        MbProductStatusCB cb = new MbProductStatusCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
    ...
    public abstract String keepProductStatusCode_InScopeRelation_ProductStatus(MbProductStatusCQ subQuery);
     ...
     */
    public void notInScopeProductStatus(SubQuery<MbProductStatusCB> subQuery) {
        assertObjectNotNull("subQuery<MbProductStatusCB>", subQuery);
        MbProductStatusCB cb = new MbProductStatusCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
    ...
    public abstract String keepProductStatusCode_NotInScopeRelation_ProductStatus(MbProductStatusCQ subQuery);
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_Equal()</span>.max(new SubQuery&lt;MbProductCB&gt;() {
     ...
     */
    public HpSSQFunction<MbProductCB> scalar_Equal() {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;MbProductCB&gt;() {
     *     public void query(MbProductCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MbProductCB> scalar_NotEqual() {
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;MbProductCB&gt;() {
     *     public void query(MbProductCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MbProductCB> scalar_GreaterThan() {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessThan()</span>.max(new SubQuery&lt;MbProductCB&gt;() {
     *     public void query(MbProductCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MbProductCB> scalar_LessThan() {
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;MbProductCB&gt;() {
     *     public void query(MbProductCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MbProductCB> scalar_GreaterEqual() {
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;MbProductCB&gt;() {
     *     public void query(MbProductCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<MbProductCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE.getOperand());
    }

    protected HpSSQFunction<MbProductCB> xcreateSSQFunction(final String operand) {
        return new HpSSQFunction<MbProductCB>(new HpSSQSetupper<MbProductCB>() {
            public void setup(String function, SubQuery<MbProductCB> subQuery, HpSSQOption<MbProductCB> option) {
                xscalarCondition(function, subQuery, operand, option);
            }
        });
    }

    protected void xscalarCondition(String function, SubQuery<MbProductCB> subQuery, String operand, HpSSQOption<MbProductCB> option) {
        assertObjectNotNull("subQuery<MbProductCB>", subQuery);
        MbProductCB cb = xcreateScalarConditionCB(); subQuery.query(cb);
        String subQueryPropertyName = keepScalarCondition(cb.query()); // for saving query-value
        option.setPartitionByCBean(xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(function, cb.query(), subQueryPropertyName, operand, option);
    }
    public abstract String keepScalarCondition(MbProductCQ subQuery);

    protected MbProductCB xcreateScalarConditionCB() {
        MbProductCB cb = new MbProductCB();
        cb.xsetupForScalarCondition(this);
        return cb;
    }

    protected MbProductCB xcreateScalarConditionPartitionByCB() {
        MbProductCB cb = new MbProductCB();
    ...
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String function, SubQuery<MbProductCB> subQuery, String aliasName, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<MbProductCB>", subQuery);
    ...
    public abstract String keepSpecifyMyselfDerived(MbProductCQ subQuery);

    /**
     * Prepare for (Query)MyselfDerived (SubQuery).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<MbProductCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived();
    }
    protected HpQDRFunction<MbProductCB> xcreateQDRFunctionMyselfDerived() {
    ...
    public void xqderiveMyselfDerived(String function, SubQuery<MbProductCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<MbProductCB>", subQuery);
        MbProductCB cb = new MbProductCB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
    ...
    public abstract String keepQueryMyselfDerived(MbProductCQ subQuery);
     ...
     */
    public void myselfExists(SubQuery<MbProductCB> subQuery) {
        assertObjectNotNull("subQuery<MbProductCB>", subQuery);
        MbProductCB cb = new MbProductCB(); cb.xsetupForMyselfExists(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfExists(cb.query()); // for saving query-value.
        registerMyselfExists(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfExists(MbProductCQ subQuery);
     ...
     * @param subQuery The implementation of sub query. (NotNull)
     */
    public void myselfInScope(SubQuery<MbProductCB> subQuery) {
        assertObjectNotNull("subQuery<MbProductCB>", subQuery);
        MbProductCB cb = new MbProductCB(); cb.xsetupForMyselfInScope(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfInScope(cb.query()); // for saving query-value.
        registerMyselfInScope(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfInScope(MbProductCQ subQuery);

    // ===================================================================================
    //                                                                       Very Internal
    //                                                                       =============
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabCB() { return MbProductCB.class.getName(); }
    protected String xabCQ() { return MbProductCQ.class.getName(); }

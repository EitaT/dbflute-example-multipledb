...
public class LdDBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("AUTHOR", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdAuthorDbm");
        tmpMap.put("BLACK_ACTION", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdBlackActionDbm");
        tmpMap.put("BLACK_ACTION_LOOKUP", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdBlackActionLookupDbm");
        tmpMap.put("BLACK_LIST", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdBlackListDbm");
        tmpMap.put("BOOK", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdBookDbm");
        tmpMap.put("COLLECTION", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdCollectionDbm");
        tmpMap.put("COLLECTION_STATUS", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdCollectionStatusDbm");
        tmpMap.put("COLLECTION_STATUS_LOOKUP", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdCollectionStatusLookupDbm");
        tmpMap.put("GARBAGE", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdGarbageDbm");
        tmpMap.put("GARBAGE_PLUS", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdGarbagePlusDbm");
        tmpMap.put("GENRE", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdGenreDbm");
        tmpMap.put("LB_USER", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdLbUserDbm");
        tmpMap.put("LENDING", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdLendingDbm");
        tmpMap.put("LENDING_COLLECTION", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdLendingCollectionDbm");
        tmpMap.put("LIBRARY", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdLibraryDbm");
        tmpMap.put("LIBRARY_TYPE_LOOKUP", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdLibraryTypeLookupDbm");
        tmpMap.put("LIBRARY_USER", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdLibraryUserDbm");
        tmpMap.put("MYSELF", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdMyselfDbm");
        tmpMap.put("MYSELF_CHECK", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdMyselfCheckDbm");
        tmpMap.put("NEXT_LIBRARY", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdNextLibraryDbm");
        tmpMap.put("PUBLISHER", "com.example.dbflute.multipledb.seasar.dbflute.librarydb.bsentity.dbmeta.LdPublisherDbm");

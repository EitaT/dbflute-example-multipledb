 ...
 */
public abstract class MbBsWithdrawalReasonBhv extends AbstractBehaviorWritable<MbWithdrawalReason, MbWithdrawalReasonCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public MbWithdrawalReasonDbm getDBMeta() { return MbWithdrawalReasonDbm.getInstance(); }
    ...
    protected <ENTITY extends MbWithdrawalReason> OptionalEntity<ENTITY> doSelectOptionalEntity(MbWithdrawalReasonCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MbWithdrawalReason> ENTITY doSelectByPK(String withdrawalReasonCode, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(withdrawalReasonCode), tp);
    }

    protected <ENTITY extends MbWithdrawalReason> OptionalEntity<ENTITY> doSelectOptionalByPK(String withdrawalReasonCode, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends MbWithdrawalReason> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer displayOrder, Class<? extends ENTITY> tp) {
     ...
     *     public ConditionBean setup(MbWithdrawalReason entity, MbWithdrawalReasonCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
    ...
    public OutsideSqlBasicExecutor<MbWithdrawalReasonBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<MbWithdrawalReasonBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends MbWithdrawalReason> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends MbWithdrawalReason> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends MbWithdrawalReason> typeOfSelectedEntity() { return MbWithdrawalReason.class; }
    protected Class<MbWithdrawalReason> typeOfHandlingEntity() { return MbWithdrawalReason.class; }
    protected Class<MbWithdrawalReasonCB> typeOfHandlingConditionBean() { return MbWithdrawalReasonCB.class; }
}

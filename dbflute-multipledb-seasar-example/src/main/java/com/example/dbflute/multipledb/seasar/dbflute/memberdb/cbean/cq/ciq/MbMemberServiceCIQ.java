 ...
 */
public class MbMemberServiceCIQ extends MbAbstractBsMemberServiceCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MbBsMemberServiceCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public MbMemberServiceCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, MbBsMemberServiceCQ myCQ) {
    ...
    protected String xinCB() { return MbMemberServiceCB.class.getName(); }
    protected String xinCQ() { return MbMemberServiceCQ.class.getName(); }
}

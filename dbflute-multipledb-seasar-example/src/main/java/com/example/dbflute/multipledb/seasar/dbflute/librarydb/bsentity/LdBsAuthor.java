...
public abstract class LdBsAuthor implements LdEntityDefinedCommonColumn, Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof LdBsAuthor)) { return false; }
        LdBsAuthor other = (LdBsAuthor)obj;
        if (!xSV(getAuthorId(), other.getAuthorId())) { return false; }
        return true;
    }
    ...
    protected String buildColumnString() {
        ...
        sb.append(dm).append(getAuthorName());
        sb.append(dm).append(getAuthorAge());

...
public abstract class MbBsServiceRankBhv extends AbstractBehaviorWritable {
    ...
    protected int facadeSelectCount(MbServiceRankCB cb) {
    ...
    protected <ENTITY extends MbServiceRank> ENTITY doSelectEntity(MbServiceRankCB cb, Class<ENTITY> tp) {
        return helpSelectEntityInternally(cb, tp);
    }

    protected <ENTITY extends MbServiceRank> OptionalEntity<ENTITY> doSelectOptionalEntity(MbServiceRankCB cb, Class<ENTITY> tp) {
    ...
    protected MbServiceRank facadeSelectEntityWithDeletedCheck(MbServiceRankCB cb) {
        return doSelectEntityWithDeletedCheck(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends MbServiceRank> ENTITY doSelectEntityWithDeletedCheck(MbServiceRankCB cb, Class<ENTITY> tp) {
    ...
    protected <ENTITY extends MbServiceRank> ENTITY doSelectByPK(String serviceRankCode, Class<ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(serviceRankCode), tp);
    }

    protected <ENTITY extends MbServiceRank> OptionalEntity<ENTITY> doSelectOptionalByPK(String serviceRankCode, Class<ENTITY> tp) {
    ...
    protected <ENTITY extends MbServiceRank> OptionalEntity<ENTITY> doSelectByUniqueOf(Integer displayOrder, Class<ENTITY> tp) {
    ...
    protected ListResultBean<MbServiceRank> facadeSelectList(MbServiceRankCB cb) {
    ...
    protected PagingResultBean<MbServiceRank> facadeSelectPage(MbServiceRankCB cb) {
    ...
    protected void facadeSelectCursor(MbServiceRankCB cb, EntityRowHandler<MbServiceRank> entityRowHandler) {
    ...
    protected <RESULT> HpSLSFunction<MbServiceRankCB, RESULT> facadeScalarSelect(Class<RESULT> resultType) {
        return doScalarSelect(resultType, newConditionBean());
    }

    protected <RESULT, CB extends MbServiceRankCB> HpSLSFunction<CB, RESULT> doScalarSelect(final Class<RESULT> tp, final CB cb) {
    ...
    protected void doInsert(MbServiceRank et, InsertOption<MbServiceRankCB> op) {
    ...
    protected void doUpdate(MbServiceRank et, UpdateOption<MbServiceRankCB> op) {
    ...
    { MbServiceRankCB cb = newConditionBean(); cb.xsetupForVaryingUpdate(); return cb; }

    protected MbServiceRankCB createCBForSpecifiedUpdate()
    { MbServiceRankCB cb = newConditionBean(); cb.xsetupForSpecifiedUpdate(); return cb; }
    ...
    protected void doInsertOrUpdate(MbServiceRank et, InsertOption<MbServiceRankCB> iop, UpdateOption<MbServiceRankCB> uop) {
    ...
    protected void doDelete(MbServiceRank et, final DeleteOption<MbServiceRankCB> op) {
        assertObjectNotNull("serviceRank", et); prepareDeleteOption(op); helpDeleteInternally(et, op);
    }

    protected void prepareDeleteOption(DeleteOption<MbServiceRankCB> op) { if (op != null) { assertDeleteOptionStatus(op); } }
    ...
    protected int[] doBatchInsert(List<MbServiceRank> ls, InsertOption<MbServiceRankCB> op) {
        assertObjectNotNull("serviceRankList", ls);
        InsertOption<MbServiceRankCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainInsertOption(); }
        prepareBatchInsertOption(ls, rlop); // required
        return delegateBatchInsert(ls, rlop);
    }

    protected void prepareBatchInsertOption(List<MbServiceRank> ls, InsertOption<MbServiceRankCB> op) {
    ...
    protected int[] doBatchUpdate(List<MbServiceRank> ls, UpdateOption<MbServiceRankCB> op) {
        assertObjectNotNull("serviceRankList", ls);
        UpdateOption<MbServiceRankCB> rlop; if (op != null) { rlop = op; } else { rlop = createPlainUpdateOption(); }
        prepareBatchUpdateOption(ls, rlop); // required
        return delegateBatchUpdate(ls, rlop);
    }

    protected void prepareBatchUpdateOption(List<MbServiceRank> ls, UpdateOption<MbServiceRankCB> op) {
    ...
    protected int[] doBatchDelete(List<MbServiceRank> ls, DeleteOption<MbServiceRankCB> op) {
        assertObjectNotNull("serviceRankList", ls);
    ...
    protected int doQueryInsert(QueryInsertSetupper<MbServiceRank, MbServiceRankCB> sp, InsertOption<MbServiceRankCB> op) {
        ...
        MbServiceRank et = newEntity(); MbServiceRankCB cb = createCBForQueryInsert();
        return delegateQueryInsert(et, cb, sp.setup(et, cb), op);
    }

    protected MbServiceRankCB createCBForQueryInsert()
    { MbServiceRankCB cb = newConditionBean(); cb.xsetupForQueryInsert(); return cb; }
    ...
    protected int doQueryUpdate(MbServiceRank et, MbServiceRankCB cb, UpdateOption<MbServiceRankCB> op) {
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Class<MbServiceRank> typeOfSelectedEntity() { return MbServiceRank.class; }
    protected MbServiceRank downcast(Entity et) { return helpEntityDowncastInternally(et, MbServiceRank.class); }
    protected MbServiceRankCB downcast(ConditionBean cb) { return helpConditionBeanDowncastInternally(cb, MbServiceRankCB.class); }
    @SuppressWarnings("unchecked")
    protected List<MbServiceRank> downcast(List<? extends Entity> ls) { return (List<MbServiceRank>)ls; }
    @SuppressWarnings("unchecked")
    protected InsertOption<MbServiceRankCB> downcast(InsertOption<? extends ConditionBean> op) { return (InsertOption<MbServiceRankCB>)op; }
    @SuppressWarnings("unchecked")
    protected UpdateOption<MbServiceRankCB> downcast(UpdateOption<? extends ConditionBean> op) { return (UpdateOption<MbServiceRankCB>)op; }
    @SuppressWarnings("unchecked")
    protected DeleteOption<MbServiceRankCB> downcast(DeleteOption<? extends ConditionBean> op) { return (DeleteOption<MbServiceRankCB>)op; }
    @SuppressWarnings("unchecked")

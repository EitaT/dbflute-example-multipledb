...
public abstract class MbBsServiceRankBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends MbServiceRank> ENTITY doSelectEntity(MbServiceRankCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectEntityInternally(cb, tp, new InternalSelectEntityCallback<ENTITY, MbServiceRankCB>() {
            public List<ENTITY> callbackSelectList(MbServiceRankCB lcb, Class<ENTITY> ltp) { return doSelectList(lcb, ltp); } });
    }
    ...
    protected <ENTITY extends MbServiceRank> ListResultBean<ENTITY> doSelectList(MbServiceRankCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectListInternally(cb, tp, new InternalSelectListCallback<ENTITY, MbServiceRankCB>() {
            public List<ENTITY> callbackSelectList(MbServiceRankCB lcb, Class<ENTITY> ltp) { return delegateSelectList(lcb, ltp); } });
    }
     ...
     */
    public NestedReferrerLoader<MbMemberService> loadMemberServiceList(List<MbServiceRank> serviceRankList, ConditionBeanSetupper<MbMemberServiceCB> setupper) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<MbMemberService> loadMemberServiceList(MbServiceRank serviceRank, ConditionBeanSetupper<MbMemberServiceCB> setupper) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerLoader<MbMemberService> loadMemberServiceList(MbServiceRank serviceRank, LoadReferrerOption<MbMemberServiceCB, MbMemberService> loadReferrerOption) {
    ...
    public NestedReferrerLoader<MbMemberService> loadMemberServiceList(List<MbServiceRank> serviceRankList, LoadReferrerOption<MbMemberServiceCB, MbMemberService> loadReferrerOption) {
        xassLRArg(serviceRankList, loadReferrerOption);
        if (serviceRankList.isEmpty()) { return (NestedReferrerLoader<MbMemberService>)EMPTY_LOADER; }
        return doLoadMemberServiceList(serviceRankList, loadReferrerOption);
    }

    protected NestedReferrerLoader<MbMemberService> doLoadMemberServiceList(List<MbServiceRank> serviceRankList, LoadReferrerOption<MbMemberServiceCB, MbMemberService> option) {
        final MbMemberServiceBhv referrerBhv = xgetBSFLR().select(MbMemberServiceBhv.class);
        return helpLoadReferrerInternally(serviceRankList, option, new InternalLoadReferrerCallback<MbServiceRank, String, MbMemberServiceCB, MbMemberService>() {

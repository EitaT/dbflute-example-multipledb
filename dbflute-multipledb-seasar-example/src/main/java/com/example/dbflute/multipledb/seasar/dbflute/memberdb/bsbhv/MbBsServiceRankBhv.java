...
public abstract class MbBsServiceRankBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends MbServiceRank> ENTITY doSelectEntity(final MbServiceRankCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityInternally(cb, entityType, new InternalSelectEntityCallback<ENTITY, MbServiceRankCB>() {
            public List<ENTITY> callbackSelectList(MbServiceRankCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends MbServiceRank> ENTITY doSelectEntityWithDeletedCheck(final MbServiceRankCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityWithDeletedCheckInternally(cb, entityType, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, MbServiceRankCB>() {
            public List<ENTITY> callbackSelectList(MbServiceRankCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends MbServiceRank> ListResultBean<ENTITY> doSelectList(MbServiceRankCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", entityType);
        assertSpecifyDerivedReferrerEntityProperty(cb, entityType);
        return helpSelectListInternally(cb, entityType, new InternalSelectListCallback<ENTITY, MbServiceRankCB>() {
            public List<ENTITY> callbackSelectList(MbServiceRankCB cb, Class<ENTITY> entityType) { return delegateSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends MbServiceRank> PagingResultBean<ENTITY> doSelectPage(MbServiceRankCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", entityType);
        return helpSelectPageInternally(cb, entityType, new InternalSelectPageCallback<ENTITY, MbServiceRankCB>() {
    ...
    protected <ENTITY extends MbServiceRank> void doSelectCursor(MbServiceRankCB cb, EntityRowHandler<ENTITY> entityRowHandler, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityRowHandler<MbServiceRank>", entityRowHandler); assertObjectNotNull("entityType", entityType);
        assertSpecifyDerivedReferrerEntityProperty(cb, entityType);
        helpSelectCursorInternally(cb, entityRowHandler, entityType, new InternalSelectCursorCallback<ENTITY, MbServiceRankCB>() {
            public void callbackSelectCursor(MbServiceRankCB cb, EntityRowHandler<ENTITY> entityRowHandler, Class<ENTITY> entityType) { delegateSelectCursor(cb, entityRowHandler, entityType); }
            public List<ENTITY> callbackSelectList(MbServiceRankCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); }
        });
    }
    ...
    protected <RESULT, CB extends MbServiceRankCB> SLFunction<CB, RESULT> doScalarSelect(Class<RESULT> resultType, CB cb) {
        assertObjectNotNull("resultType", resultType); assertCBStateValid(cb);
        cb.xsetupForScalarSelect(); cb.getSqlClause().disableSelectIndex(); // for when you use union
        return createSLFunction(cb, resultType);
    }

    protected <RESULT, CB extends MbServiceRankCB> SLFunction<CB, RESULT> createSLFunction(CB cb, Class<RESULT> resultType) {
    ...
    public void loadMemberServiceList(List<MbServiceRank> serviceRankList, LoadReferrerOption<MbMemberServiceCB, MbMemberService> loadReferrerOption) {
        ...
        helpLoadReferrerInternally(serviceRankList, loadReferrerOption, new InternalLoadReferrerCallback<MbServiceRank, String, MbMemberServiceCB, MbMemberService>() {
            public String getPKVal(MbServiceRank e)
            ...
            public String getFKVal(MbMemberService e) { return e.getServiceRankCode(); }
    ...
    public List<String> extractServiceRankCodeList(List<MbServiceRank> serviceRankList) {
        return helpExtractListInternally(serviceRankList, new InternalExtractCallback<MbServiceRank, String>() {
            public String getCV(MbServiceRank e) { return e.getServiceRankCode(); }
        });
    }
    ...
    public List<Integer> extractDisplayOrderList(List<MbServiceRank> serviceRankList) {
        return helpExtractListInternally(serviceRankList, new InternalExtractCallback<MbServiceRank, Integer>() {
            public Integer getCV(MbServiceRank e) { return e.getDisplayOrder(); }
        });
    }
    ...
    protected void doInsert(MbServiceRank serviceRank, InsertOption<MbServiceRankCB> option) {
        assertObjectNotNull("serviceRank", serviceRank);
        prepareInsertOption(option);
        delegateInsert(serviceRank, option);
    }

    protected void prepareInsertOption(InsertOption<MbServiceRankCB> option) {
    ...
    protected void doUpdate(MbServiceRank serviceRank, final UpdateOption<MbServiceRankCB> option) {
        assertObjectNotNull("serviceRank", serviceRank);
        prepareUpdateOption(option);
        helpUpdateInternally(serviceRank, new InternalUpdateCallback<MbServiceRank>() {
            public int callbackDelegateUpdate(MbServiceRank entity) { return delegateUpdate(entity, option); } });
    }

    protected void prepareUpdateOption(UpdateOption<MbServiceRankCB> option) {
        if (option == null) { return; }
    ...
    protected void doInesrtOrUpdate(MbServiceRank serviceRank, final InsertOption<MbServiceRankCB> insertOption, final UpdateOption<MbServiceRankCB> updateOption) {
        helpInsertOrUpdateInternally(serviceRank, new InternalInsertOrUpdateCallback<MbServiceRank, MbServiceRankCB>() {
            public void callbackInsert(MbServiceRank entity) { doInsert(entity, insertOption); }
            public void callbackUpdate(MbServiceRank entity) { doUpdate(entity, updateOption); }
    ...
    protected void doCreateOrModify(Entity entity, InsertOption<? extends ConditionBean> insertOption,
        ...
        if (insertOption == null && updateOption == null) { insertOrUpdate(downcast(entity)); }
            ...
            insertOption = insertOption == null ? new InsertOption<MbServiceRankCB>() : insertOption;
            updateOption = updateOption == null ? new UpdateOption<MbServiceRankCB>() : updateOption;
    ...
    protected void doDelete(MbServiceRank serviceRank, final DeleteOption<MbServiceRankCB> option) {
        assertObjectNotNull("serviceRank", serviceRank);
        prepareDeleteOption(option);
        helpDeleteInternally(serviceRank, new InternalDeleteCallback<MbServiceRank>() {
            public int callbackDelegateDelete(MbServiceRank entity) { return delegateDelete(entity, option); } });
    }

    protected void prepareDeleteOption(DeleteOption<MbServiceRankCB> option) {
        if (option == null) { return; }
    ...
    public int[] batchInsert(List<MbServiceRank> serviceRankList) {
        InsertOption<MbServiceRankCB> option = createInsertUpdateOption();
        return doBatchInsert(serviceRankList, option);
    }

    protected int[] doBatchInsert(List<MbServiceRank> serviceRankList, InsertOption<MbServiceRankCB> option) {
    ...
    protected void prepareBatchInsertOption(List<MbServiceRank> serviceRankList, InsertOption<MbServiceRankCB> option) {
    ...
    public int[] batchUpdate(List<MbServiceRank> serviceRankList) {
        UpdateOption<MbServiceRankCB> option = createPlainUpdateOption();
        return doBatchUpdate(serviceRankList, option);
    }

    protected int[] doBatchUpdate(List<MbServiceRank> serviceRankList, UpdateOption<MbServiceRankCB> option) {
        assertObjectNotNull("serviceRankList", serviceRankList);
        prepareBatchUpdateOption(serviceRankList, option);
        return delegateBatchUpdate(serviceRankList, option);
    }

    protected void prepareBatchUpdateOption(List<MbServiceRank> serviceRankList, UpdateOption<MbServiceRankCB> option) {
    ...
    protected int[] doBatchDelete(List<MbServiceRank> serviceRankList, DeleteOption<MbServiceRankCB> option) {
        assertObjectNotNull("serviceRankList", serviceRankList);
        prepareDeleteOption(option);
    ...
    protected int doQueryInsert(QueryInsertSetupper<MbServiceRank, MbServiceRankCB> setupper, InsertOption<MbServiceRankCB> option) {
        assertObjectNotNull("setupper", setupper);
        prepareInsertOption(option);
        MbServiceRank entity = new MbServiceRank();
        MbServiceRankCB intoCB = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(MbServiceRank serviceRank, MbServiceRankCB cb, UpdateOption<MbServiceRankCB> option) {
    ...
    protected int doRangeModify(Entity entity, ConditionBean cb, UpdateOption<? extends ConditionBean> option) {
        if (option == null) { return queryUpdate(downcast(entity), (MbServiceRankCB)cb); }
        else { return varyingQueryUpdate(downcast(entity), (MbServiceRankCB)cb, downcast(option)); }
    }
    ...
    protected int doQueryDelete(MbServiceRankCB cb, DeleteOption<MbServiceRankCB> option) {
        assertCBStateValid(cb);
        prepareDeleteOption(option);
    ...
    protected int doRangeRemove(ConditionBean cb, DeleteOption<? extends ConditionBean> option) {
        if (option == null) { return queryDelete((MbServiceRankCB)cb); }
        else { return varyingQueryDelete((MbServiceRankCB)cb, downcast(option)); }
    }
    ...
    protected <ENTITY extends MbServiceRank> void delegateSelectCursor(MbServiceRankCB cb, EntityRowHandler<ENTITY> erh, Class<ENTITY> et)
    { invoke(createSelectCursorCBCommand(cb, erh, et)); }
    protected <ENTITY extends MbServiceRank> List<ENTITY> delegateSelectList(MbServiceRankCB cb, Class<ENTITY> et)
    { return invoke(createSelectListCBCommand(cb, et)); }

    // -----------------------------------------------------
    //                                                Update
    //                                                ------
    protected int delegateInsert(MbServiceRank e, InsertOption<MbServiceRankCB> op)
    { if (!processBeforeInsert(e, op)) { return 0; }
      return invoke(createInsertEntityCommand(e, op)); }
    protected int delegateUpdate(MbServiceRank e, UpdateOption<MbServiceRankCB> op)
    { if (!processBeforeUpdate(e, op)) { return 0; }
      return delegateUpdateNonstrict(e, op); }
    protected int delegateUpdateNonstrict(MbServiceRank e, UpdateOption<MbServiceRankCB> op)
    { if (!processBeforeUpdate(e, op)) { return 0; }
      return invoke(createUpdateNonstrictEntityCommand(e, op)); }
    protected int delegateDelete(MbServiceRank e, DeleteOption<MbServiceRankCB> op)
    { if (!processBeforeDelete(e, op)) { return 0; }
      return delegateDeleteNonstrict(e, op); }
    protected int delegateDeleteNonstrict(MbServiceRank e, DeleteOption<MbServiceRankCB> op)
    { if (!processBeforeDelete(e, op)) { return 0; }
    ...
    protected int delegateQueryInsert(MbServiceRank e, MbServiceRankCB inCB, ConditionBean resCB, InsertOption<MbServiceRankCB> op)
    { if (!processBeforeQueryInsert(e, inCB, resCB, op)) { return 0; } return invoke(createQueryInsertCBCommand(e, inCB, resCB, op));  }
    protected int delegateQueryUpdate(MbServiceRank e, MbServiceRankCB cb, UpdateOption<MbServiceRankCB> op)
    ...
    //                                                                     Downcast Helper
    //                                                                     ===============
    protected MbServiceRank downcast(Entity entity) {
        return helpEntityDowncastInternally(entity, MbServiceRank.class);
    }
    ...
    protected List<MbServiceRank> downcast(List<? extends Entity> entityList) {
        return (List<MbServiceRank>)entityList;
    }

    @SuppressWarnings("unchecked")
    protected InsertOption<MbServiceRankCB> downcast(InsertOption<? extends ConditionBean> option) {
        return (InsertOption<MbServiceRankCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected UpdateOption<MbServiceRankCB> downcast(UpdateOption<? extends ConditionBean> option) {
        return (UpdateOption<MbServiceRankCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected DeleteOption<MbServiceRankCB> downcast(DeleteOption<? extends ConditionBean> option) {
        return (DeleteOption<MbServiceRankCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected QueryInsertSetupper<MbServiceRank, MbServiceRankCB> downcast(QueryInsertSetupper<? extends Entity, ? extends ConditionBean> option) {
        return (QueryInsertSetupper<MbServiceRank, MbServiceRankCB>)option;
    }
}

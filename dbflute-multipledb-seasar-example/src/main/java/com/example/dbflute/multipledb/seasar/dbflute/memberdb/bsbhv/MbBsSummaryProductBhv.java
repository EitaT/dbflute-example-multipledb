...
public abstract class MbBsSummaryProductBhv extends AbstractBehaviorReadable<MbSummaryProduct, MbSummaryProductCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public MbSummaryProductDbm getDBMeta() { return MbSummaryProductDbm.getInstance(); }
    ...
    public OutsideSqlBasicExecutor<MbSummaryProductBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<MbSummaryProductBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends MbSummaryProduct> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends MbSummaryProduct> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {

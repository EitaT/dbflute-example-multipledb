 ...
 */
public abstract class LdBsMyselfBhv extends AbstractBehaviorWritable<LdMyself, LdMyselfCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public LdMyselfDbm getDBMeta() { return LdMyselfDbm.getInstance(); }
    ...
    protected <ENTITY extends LdMyself> OptionalEntity<ENTITY> doSelectOptionalEntity(LdMyselfCB cb, Class<? extends ENTITY> tp) {
    ...
    protected <ENTITY extends LdMyself> ENTITY doSelectByPK(Integer myselfId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(myselfId), tp);
    }

    protected <ENTITY extends LdMyself> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer myselfId, Class<? extends ENTITY> tp) {
     ...
     *     public ConditionBean setup(LdMyself entity, LdMyselfCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends LdMyself> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends LdMyself> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends LdMyself> typeOfSelectedEntity() { return LdMyself.class; }
    protected Class<LdMyself> typeOfHandlingEntity() { return LdMyself.class; }
    protected Class<LdMyselfCB> typeOfHandlingConditionBean() { return LdMyselfCB.class; }
}

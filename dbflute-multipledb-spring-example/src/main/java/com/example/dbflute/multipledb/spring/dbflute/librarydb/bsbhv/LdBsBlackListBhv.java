...
public abstract class LdBsBlackListBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends LdBlackList> ENTITY doSelectEntity(final LdBlackListCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends LdBlackList> ENTITY doSelectEntityWithDeletedCheck(final LdBlackListCB cb, Class<ENTITY> tp) {
        assertCBStateValid(cb);
    ...
    protected <ENTITY extends LdBlackList> ListResultBean<ENTITY> doSelectList(LdBlackListCB cb, Class<ENTITY> tp) {
        ...
        return helpSelectListInternally(cb, tp, new InternalSelectListCallback<ENTITY, LdBlackListCB>() {
            public List<ENTITY> callbackSelectList(LdBlackListCB cb, Class<ENTITY> tp) { return delegateSelectList(cb, tp); } });
    }

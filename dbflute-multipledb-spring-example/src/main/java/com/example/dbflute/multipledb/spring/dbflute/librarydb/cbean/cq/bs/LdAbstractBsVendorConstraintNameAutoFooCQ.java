...
public abstract class LdAbstractBsVendorConstraintNameAutoFooCQ extends AbstractConditionQuery {
    ...
    protected HpSSQFunction<LdVendorConstraintNameAutoFooCB> xcreateSSQFunction(final String rd) {
        return new HpSSQFunction<LdVendorConstraintNameAutoFooCB>(new HpSSQSetupper<LdVendorConstraintNameAutoFooCB>() {
            public void setup(String fn, SubQuery<LdVendorConstraintNameAutoFooCB> sq, HpSSQOption<LdVendorConstraintNameAutoFooCB> op) {
                xscalarCondition(fn, sq, rd, op);
            }
        });
    }

    protected void xscalarCondition(String fn, SubQuery<LdVendorConstraintNameAutoFooCB> sq, String rd, HpSSQOption<LdVendorConstraintNameAutoFooCB> op) {
        assertObjectNotNull("subQuery", sq);
        LdVendorConstraintNameAutoFooCB cb = xcreateScalarConditionCB(); sq.query(cb);
    ...
    protected HpQDRFunction<LdVendorConstraintNameAutoFooCB> xcreateQDRFunctionMyselfDerived() {
        return new HpQDRFunction<LdVendorConstraintNameAutoFooCB>(new HpQDRSetupper<LdVendorConstraintNameAutoFooCB>() {
            public void setup(String fn, SubQuery<LdVendorConstraintNameAutoFooCB> sq, String rd, Object vl, DerivedReferrerOption op) {
                xqderiveMyselfDerived(fn, sq, rd, vl, op);
            }
        });
    }
    public void xqderiveMyselfDerived(String fn, SubQuery<LdVendorConstraintNameAutoFooCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        LdVendorConstraintNameAutoFooCB cb = new LdVendorConstraintNameAutoFooCB(); cb.xsetupForDerivedReferrer(this); sq.query(cb);
        String pk = "CONSTRAINT_NAME_AUTO_FOO_ID";

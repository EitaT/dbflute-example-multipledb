...
public class LdBsLendingCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;LdLendingCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;LdLendingCB&gt;() {
     *     public void query(LdLendingCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * ... = lending.<span style="color: #FD4747">getLibraryUser()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;LdLendingCB&gt;() {
    ...
    public HpColQyOperand<LdLendingCB> columnQuery(final SpecifyQuery<LdLendingCB> leftSpecifyQuery) {
        return new HpColQyOperand<LdLendingCB>(new HpColQyHandler<LdLendingCB>() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;LdLendingCB&gt;() {
     ...
     *     public void query(LdLendingCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;LdLendingCB&gt;() {

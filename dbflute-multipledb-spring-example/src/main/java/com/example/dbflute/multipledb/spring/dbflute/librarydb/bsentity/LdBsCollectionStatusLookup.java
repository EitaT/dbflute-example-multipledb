 ...
 */
public abstract class LdBsCollectionStatusLookup implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        ...
        if (!xSV(getCollectionStatusCode(), otherEntity.getCollectionStatusCode())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = xCH(result, getCollectionStatusCode());
        return result;
    }
    ...
    public String toStringWithRelation() {
        ...
        sb.append(toString());
        String l = "\n  ";
        if (_collectionStatusList != null) { for (Entity e : _collectionStatusList)

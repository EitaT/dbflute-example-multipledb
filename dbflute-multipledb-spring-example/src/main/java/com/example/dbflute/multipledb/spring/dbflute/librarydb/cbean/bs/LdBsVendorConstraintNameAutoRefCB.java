...
public class LdBsVendorConstraintNameAutoRefCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public LdVendorConstraintNameAutoRefCB acceptPK(java.math.BigDecimal constraintNameAutoRefId) {
        ...
        return (LdVendorConstraintNameAutoRefCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public LdVendorConstraintNameAutoRefCB acceptUniqueOf(String constraintNameAutoUnique) {
    ...
    public HpColQyOperand<LdVendorConstraintNameAutoRefCB> columnQuery(final SpecifyQuery<LdVendorConstraintNameAutoRefCB> leftSpecifyQuery) {
        return xcreateColQyOperand(new HpColQyHandler<LdVendorConstraintNameAutoRefCB>() {

...
public class LdBsPublisherCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;LdPublisherCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;LdPublisherCB&gt;() {
     *     public void query(LdPublisherCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<LdPublisherCQ> {
        ...
        public HpSDRFunction<LdBookCB, LdPublisherCQ> derivedBookList() {
            ...
            return new HpSDRFunction<LdBookCB, LdPublisherCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<LdBookCB, LdPublisherCQ>() {
                public void setup(String function, SubQuery<LdBookCB> subQuery, LdPublisherCQ cq, String aliasName, DerivedReferrerOption option) {
        ...
        public HpSDRFunction<LdPublisherCB, LdPublisherCQ> myselfDerived() {
            ...
            return new HpSDRFunction<LdPublisherCB, LdPublisherCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<LdPublisherCB, LdPublisherCQ>() {
                public void setup(String function, SubQuery<LdPublisherCB> subQuery, LdPublisherCQ cq, String aliasName, DerivedReferrerOption option) {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;LdPublisherCB&gt;() {
    ...
    public HpColQyOperand<LdPublisherCB> columnQuery(final SpecifyQuery<LdPublisherCB> leftSpecifyQuery) {
        return new HpColQyOperand<LdPublisherCB>(new HpColQyHandler<LdPublisherCB>() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;LdPublisherCB&gt;() {
     ...
     *     public void query(LdPublisherCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;LdPublisherCB&gt;() {

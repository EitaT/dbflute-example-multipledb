package com.example.dbflute.multipledb.spring.dbflute.memberdb.cbean.bs;
...
import com.example.dbflute.multipledb.spring.dbflute.memberdb.allcommon.DBFluteConfig;
import com.example.dbflute.multipledb.spring.dbflute.memberdb.allcommon.DBMetaInstanceHandler;
import com.example.dbflute.multipledb.spring.dbflute.memberdb.allcommon.ImplementedInvokerAssistant;
import com.example.dbflute.multipledb.spring.dbflute.memberdb.allcommon.ImplementedSqlClauseCreator;
...
import com.example.dbflute.multipledb.spring.dbflute.memberdb.cbean.nss.*;
...
public class BsProductCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;ProductCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;ProductCB&gt;() {
     *     public void query(ProductCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">setupSelect_ProductCategory()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * Product product = productBhv.selectEntityWithDeletedCheck(cb);
     * ... = product.<span style="color: #FD4747">getProductCategory()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     ...
     * <pre>
     * ProductCB cb = new ProductCB();
     * cb.<span style="color: #FD4747">setupSelect_ProductStatus()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * Product product = productBhv.selectEntityWithDeletedCheck(cb);
     * ... = product.<span style="color: #FD4747">getProductStatus()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<ProductCQ> {
        ...
        public HpSDRFunction<PurchaseCB, ProductCQ> derivedPurchaseList() {
            ...
            return new HpSDRFunction<PurchaseCB, ProductCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<PurchaseCB, ProductCQ>() {
                public void setup(String function, SubQuery<PurchaseCB> subQuery, ProductCQ cq, String aliasName, DerivedReferrerOption option) {
        ...
        public HpSDRFunction<ProductCB, ProductCQ> myselfDerived() {
            ...
            return new HpSDRFunction<ProductCB, ProductCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<ProductCB, ProductCQ>() {
                public void setup(String function, SubQuery<ProductCB> subQuery, ProductCQ cq, String aliasName, DerivedReferrerOption option) {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;ProductCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;ProductCB&gt;() {
     ...
     *     public void query(ProductCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;ProductCB&gt;() {

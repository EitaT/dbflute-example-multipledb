package com.example.dbflute.multipledb.spring.dbflute.memberdb.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("MEMBER", "com.example.dbflute.multipledb.spring.dbflute.memberdb.bsentity.dbmeta.MemberDbm");
        tmpMap.put("MEMBER_ADDRESS", "com.example.dbflute.multipledb.spring.dbflute.memberdb.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("MEMBER_LOGIN", "com.example.dbflute.multipledb.spring.dbflute.memberdb.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("MEMBER_SECURITY", "com.example.dbflute.multipledb.spring.dbflute.memberdb.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("MEMBER_SERVICE", "com.example.dbflute.multipledb.spring.dbflute.memberdb.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("MEMBER_STATUS", "com.example.dbflute.multipledb.spring.dbflute.memberdb.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("MEMBER_WITHDRAWAL", "com.example.dbflute.multipledb.spring.dbflute.memberdb.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("PRODUCT", "com.example.dbflute.multipledb.spring.dbflute.memberdb.bsentity.dbmeta.ProductDbm");
        tmpMap.put("PRODUCT_CATEGORY", "com.example.dbflute.multipledb.spring.dbflute.memberdb.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("PRODUCT_STATUS", "com.example.dbflute.multipledb.spring.dbflute.memberdb.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("PURCHASE", "com.example.dbflute.multipledb.spring.dbflute.memberdb.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("REGION", "com.example.dbflute.multipledb.spring.dbflute.memberdb.bsentity.dbmeta.RegionDbm");
        tmpMap.put("SERVICE_RANK", "com.example.dbflute.multipledb.spring.dbflute.memberdb.bsentity.dbmeta.ServiceRankDbm");
        tmpMap.put("SUMMARY_PRODUCT", "com.example.dbflute.multipledb.spring.dbflute.memberdb.bsentity.dbmeta.SummaryProductDbm");
        tmpMap.put("WITHDRAWAL_REASON", "com.example.dbflute.multipledb.spring.dbflute.memberdb.bsentity.dbmeta.WithdrawalReasonDbm");

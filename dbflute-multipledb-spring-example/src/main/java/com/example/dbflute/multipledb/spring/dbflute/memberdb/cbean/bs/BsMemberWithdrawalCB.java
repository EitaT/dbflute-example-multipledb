...
public class BsMemberWithdrawalCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;MemberWithdrawalCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;MemberWithdrawalCB&gt;() {
     *     public void query(MemberWithdrawalCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;MemberWithdrawalCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;MemberWithdrawalCB&gt;() {
     ...
     *     public void query(MemberWithdrawalCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;MemberWithdrawalCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MemberWithdrawalCB> andQuery) {
        xorSQAP((MemberWithdrawalCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        ...
        specify().xsetSyncQyCall(new HpSpQyCall<MemberWithdrawalCQ>() {
            public boolean has() { return true; }
            public MemberWithdrawalCQ qy() { return cb.query(); }
        });
    }

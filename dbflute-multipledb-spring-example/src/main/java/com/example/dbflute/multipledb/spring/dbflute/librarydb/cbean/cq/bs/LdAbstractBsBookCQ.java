...
public abstract class LdAbstractBsBookCQ extends AbstractConditionQuery {
    ...
    public void existsCollectionList(SubQuery<LdCollectionCB> subQuery) {
        ...
        String subQueryPropertyName = keepBookId_ExistsReferrer_CollectionList(cb.query()); // for saving query-value.
        registerExistsReferrer(cb.query(), "BOOK_ID", "BOOK_ID", subQueryPropertyName, "collectionList");
    }
    public abstract String keepBookId_ExistsReferrer_CollectionList(LdCollectionCQ subQuery);
    ...
    public void notExistsCollectionList(SubQuery<LdCollectionCB> subQuery) {
        assertObjectNotNull("subQuery<LdCollectionCB>", subQuery);
        LdCollectionCB cb = new LdCollectionCB(); cb.xsetupForExistsReferrer(this); subQuery.query(cb);
        String subQueryPropertyName = keepBookId_NotExistsReferrer_CollectionList(cb.query()); // for saving query-value.
        registerNotExistsReferrer(cb.query(), "BOOK_ID", "BOOK_ID", subQueryPropertyName, "collectionList");
    }
    public abstract String keepBookId_NotExistsReferrer_CollectionList(LdCollectionCQ subQuery);
    ...
    public void inScopeCollectionList(SubQuery<LdCollectionCB> subQuery) {
        ...
        String subQueryPropertyName = keepBookId_InScopeRelation_CollectionList(cb.query()); // for saving query-value.
        registerInScopeRelation(cb.query(), "BOOK_ID", "BOOK_ID", subQueryPropertyName, "collectionList");
    }
    public abstract String keepBookId_InScopeRelation_CollectionList(LdCollectionCQ subQuery);
    ...
    public void notInScopeCollectionList(SubQuery<LdCollectionCB> subQuery) {
        assertObjectNotNull("subQuery<LdCollectionCB>", subQuery);
        LdCollectionCB cb = new LdCollectionCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String subQueryPropertyName = keepBookId_NotInScopeRelation_CollectionList(cb.query()); // for saving query-value.
        registerNotInScopeRelation(cb.query(), "BOOK_ID", "BOOK_ID", subQueryPropertyName, "collectionList");
    }
    public abstract String keepBookId_NotInScopeRelation_CollectionList(LdCollectionCQ subQuery);
    ...
    public void xsderiveCollectionList(String function, SubQuery<LdCollectionCB> subQuery, String aliasName, DerivedReferrerOption option) {
        ...
        registerSpecifyDerivedReferrer(function, cb.query(), "BOOK_ID", "BOOK_ID", subQueryPropertyName, "collectionList", aliasName, option);
    }
    ...
    public void xqderiveCollectionList(String function, SubQuery<LdCollectionCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
        ...
        registerQueryDerivedReferrer(function, cb.query(), "BOOK_ID", "BOOK_ID", subQueryPropertyName, "collectionList", operand, value, parameterPropertyName, option);
    }
     ...
     * <pre>e.g. setIsbn_LikeSearch("xxx", new <span style="color: #FD4747">LikeSearchOption</span>().likeContain());</pre>
    ...
    protected void regIsbn(ConditionKey k, Object v) { regQ(k, v, getCValueIsbn(), "ISBN"); }
    abstract protected ConditionValue getCValueIsbn();
     ...
     * <pre>e.g. setBookName_LikeSearch("xxx", new <span style="color: #FD4747">LikeSearchOption</span>().likeContain());</pre>
    ...
    protected void regBookName(ConditionKey k, Object v) { regQ(k, v, getCValueBookName(), "BOOK_NAME"); }
    abstract protected ConditionValue getCValueBookName();
    ...
    public void inScopeAuthor(SubQuery<LdAuthorCB> subQuery) {
        ...
        LdAuthorCB cb = new LdAuthorCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String subQueryPropertyName = keepAuthorId_InScopeRelation_Author(cb.query()); // for saving query-value.
        registerInScopeRelation(cb.query(), "AUTHOR_ID", "AUTHOR_ID", subQueryPropertyName, "author");
    }
    public abstract String keepAuthorId_InScopeRelation_Author(LdAuthorCQ subQuery);
    ...
    public void notInScopeAuthor(SubQuery<LdAuthorCB> subQuery) {
        assertObjectNotNull("subQuery<LdAuthorCB>", subQuery);
        LdAuthorCB cb = new LdAuthorCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String subQueryPropertyName = keepAuthorId_NotInScopeRelation_Author(cb.query()); // for saving query-value.
        registerNotInScopeRelation(cb.query(), "AUTHOR_ID", "AUTHOR_ID", subQueryPropertyName, "author");
    }
    public abstract String keepAuthorId_NotInScopeRelation_Author(LdAuthorCQ subQuery);
    ...
    public void inScopePublisher(SubQuery<LdPublisherCB> subQuery) {
        ...
        LdPublisherCB cb = new LdPublisherCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String subQueryPropertyName = keepPublisherId_InScopeRelation_Publisher(cb.query()); // for saving query-value.
        registerInScopeRelation(cb.query(), "PUBLISHER_ID", "PUBLISHER_ID", subQueryPropertyName, "publisher");
    }
    public abstract String keepPublisherId_InScopeRelation_Publisher(LdPublisherCQ subQuery);
    ...
    public void notInScopePublisher(SubQuery<LdPublisherCB> subQuery) {
        assertObjectNotNull("subQuery<LdPublisherCB>", subQuery);
        LdPublisherCB cb = new LdPublisherCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String subQueryPropertyName = keepPublisherId_NotInScopeRelation_Publisher(cb.query()); // for saving query-value.
        registerNotInScopeRelation(cb.query(), "PUBLISHER_ID", "PUBLISHER_ID", subQueryPropertyName, "publisher");
    }
    public abstract String keepPublisherId_NotInScopeRelation_Publisher(LdPublisherCQ subQuery);
    ...
    public void inScopeGenre(SubQuery<LdGenreCB> subQuery) {
        ...
        String subQueryPropertyName = keepGenreCode_InScopeRelation_Genre(cb.query()); // for saving query-value.
        registerInScopeRelation(cb.query(), "GENRE_CODE", "GENRE_CODE", subQueryPropertyName, "genre");
    }
    public abstract String keepGenreCode_InScopeRelation_Genre(LdGenreCQ subQuery);
    ...
    public void notInScopeGenre(SubQuery<LdGenreCB> subQuery) {
        assertObjectNotNull("subQuery<LdGenreCB>", subQuery);
        LdGenreCB cb = new LdGenreCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String subQueryPropertyName = keepGenreCode_NotInScopeRelation_Genre(cb.query()); // for saving query-value.
        registerNotInScopeRelation(cb.query(), "GENRE_CODE", "GENRE_CODE", subQueryPropertyName, "genre");
    }
    public abstract String keepGenreCode_NotInScopeRelation_Genre(LdGenreCQ subQuery);
     ...
     * <pre>e.g. setOpeningPart_LikeSearch("xxx", new <span style="color: #FD4747">LikeSearchOption</span>().likeContain());</pre>
    ...
    protected void regOpeningPart(ConditionKey k, Object v) { regQ(k, v, getCValueOpeningPart(), "OPENING_PART"); }
    abstract protected ConditionValue getCValueOpeningPart();
    ...
    protected void regMaxLendingDateCount(ConditionKey k, Object v) { regQ(k, v, getCValueMaxLendingDateCount(), "MAX_LENDING_DATE_COUNT"); }
    abstract protected ConditionValue getCValueMaxLendingDateCount();
    ...
    /**
     * Equal(=). As Yes (y). And OnlyOnceRegistered. <br />
     * はい
     */
    public void setOutOfUserSelectYn_Equal_Yes() {
        setOutOfUserSelectYn_Equal_AsYesNo(LdCDef.YesNo.Yes);
    }

    /**
     * Equal(=). As No (n). And OnlyOnceRegistered. <br />
     * いいえ
     */
    public void setOutOfUserSelectYn_Equal_No() {
        setOutOfUserSelectYn_Equal_AsYesNo(LdCDef.YesNo.No);
    }
    ...
    /**
     * NotEqual(&lt;&gt;). As Yes (y). And OnlyOnceRegistered. <br />
     * はい
     */
    public void setOutOfUserSelectYn_NotEqual_Yes() {
        setOutOfUserSelectYn_NotEqual_AsYesNo(LdCDef.YesNo.Yes);
    }

    /**
     * NotEqual(&lt;&gt;). As No (n). And OnlyOnceRegistered. <br />
     * いいえ
     */
    public void setOutOfUserSelectYn_NotEqual_No() {
        setOutOfUserSelectYn_NotEqual_AsYesNo(LdCDef.YesNo.No);
    }
    ...
    protected void regOutOfUserSelectYn(ConditionKey k, Object v) { regQ(k, v, getCValueOutOfUserSelectYn(), "OUT_OF_USER_SELECT_YN"); }
    abstract protected ConditionValue getCValueOutOfUserSelectYn();
     ...
     * <pre>e.g. setOutOfUserSelectReason_LikeSearch("xxx", new <span style="color: #FD4747">LikeSearchOption</span>().likeContain());</pre>
    ...
    protected void regOutOfUserSelectReason(ConditionKey k, Object v) { regQ(k, v, getCValueOutOfUserSelectReason(), "OUT_OF_USER_SELECT_REASON"); }
    abstract protected ConditionValue getCValueOutOfUserSelectReason();
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_Equal()</span>.max(new SubQuery&lt;LdBookCB&gt;() {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;LdBookCB&gt;() {
     *     public void query(LdBookCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;LdBookCB&gt;() {
     *     public void query(LdBookCB subCB) {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessThan()</span>.max(new SubQuery&lt;LdBookCB&gt;() {
     *     public void query(LdBookCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;LdBookCB&gt;() {
     *     public void query(LdBookCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;LdBookCB&gt;() {
     *     public void query(LdBookCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    protected HpSSQFunction<LdBookCB> xcreateSSQFunction(final String operand) {
        return new HpSSQFunction<LdBookCB>(new HpSSQSetupper<LdBookCB>() {
            public void setup(String function, SubQuery<LdBookCB> subQuery, HpSSQOption<LdBookCB> option) {
                xscalarCondition(function, subQuery, operand, option);
            }
        });
    }

    protected void xscalarCondition(String function, SubQuery<LdBookCB> subQuery, String operand, HpSSQOption<LdBookCB> option) {
        assertObjectNotNull("subQuery<LdBookCB>", subQuery);
        LdBookCB cb = xcreateScalarConditionCB(); subQuery.query(cb);
        String subQueryPropertyName = keepScalarCondition(cb.query()); // for saving query-value
        option.setPartitionByCBean(xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(function, cb.query(), subQueryPropertyName, operand, option);
    }
    public abstract String keepScalarCondition(LdBookCQ subQuery);
    ...
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String function, SubQuery<LdBookCB> subQuery, String aliasName, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<LdBookCB>", subQuery);
        LdBookCB cb = new LdBookCB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
        String subQueryPropertyName = keepSpecifyMyselfDerived(cb.query()); // for saving query-value.
        registerSpecifyMyselfDerived(function, cb.query(), "BOOK_ID", "BOOK_ID", subQueryPropertyName, "myselfDerived", aliasName, option);
    }
    public abstract String keepSpecifyMyselfDerived(LdBookCQ subQuery);
    ...
    protected HpQDRFunction<LdBookCB> xcreateQDRFunctionMyselfDerived() {
    ...
    public void xqderiveMyselfDerived(String function, SubQuery<LdBookCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<LdBookCB>", subQuery);
        LdBookCB cb = new LdBookCB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
        String subQueryPropertyName = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String parameterPropertyName = keepQueryMyselfDerivedParameter(value);
        registerQueryMyselfDerived(function, cb.query(), "BOOK_ID", "BOOK_ID", subQueryPropertyName, "myselfDerived", operand, value, parameterPropertyName, option);
    }
    public abstract String keepQueryMyselfDerived(LdBookCQ subQuery);
    ...
    public void myselfExists(SubQuery<LdBookCB> subQuery) {
        assertObjectNotNull("subQuery<LdBookCB>", subQuery);
        LdBookCB cb = new LdBookCB(); cb.xsetupForMyselfExists(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfExists(cb.query()); // for saving query-value.
        registerMyselfExists(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfExists(LdBookCQ subQuery);
    ...
    public void myselfInScope(SubQuery<LdBookCB> subQuery) {
        assertObjectNotNull("subQuery<LdBookCB>", subQuery);
        LdBookCB cb = new LdBookCB(); cb.xsetupForMyselfInScope(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfInScope(cb.query()); // for saving query-value.
        registerMyselfInScope(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfInScope(LdBookCQ subQuery);

    // ===================================================================================
    //                                                                       Very Internal
    //                                                                       =============
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabCB() { return LdBookCB.class.getName(); }

...
public abstract class LdAbstractBsVendorCheckCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LdAbstractBsVendorCheckCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>e.g. setTypeOfLongVarchar_LikeSearch("xxx", new <span style="color: #FD4747">LikeSearchOption</span>().likeContain());</pre>
    ...
    protected void regTypeOfLongVarchar(ConditionKey k, Object v) { regQ(k, v, getCValueTypeOfLongVarchar(), "TYPE_OF_LONG_VARCHAR"); }
    abstract protected ConditionValue getCValueTypeOfLongVarchar();
    ...
    abstract protected ConditionValue getCValueTypeOfDecimalInteger();
    ...
    abstract protected ConditionValue getCValueTypeOfDecimalBigint();
    ...
    abstract protected ConditionValue getCValueTypeOfDecimalDecimal();
    ...
    protected String xabCB() { return LdVendorCheckCB.class.getName(); }

...
public abstract class LdBsCollectionStatusBhv extends AbstractBehaviorWritable<LdCollectionStatus, LdCollectionStatusCB> {
    ...
    public OutsideSqlBasicExecutor<LdCollectionStatusBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<LdCollectionStatusBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends LdCollectionStatus> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends LdCollectionStatus> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {

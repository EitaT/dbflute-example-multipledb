...
public abstract class LdBsVendorConstraintNameAutoBar implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof LdBsVendorConstraintNameAutoBar)) { return false; }
        LdBsVendorConstraintNameAutoBar other = (LdBsVendorConstraintNameAutoBar)obj;
        if (!xSV(getConstraintNameAutoBarId(), other.getConstraintNameAutoBarId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hs = xCH(hs, getConstraintNameAutoBarId());
        return hs;
    }
    ...
    protected String buildColumnString() {
        ...
        sb.append(dm).append(getConstraintNameAutoBarName());

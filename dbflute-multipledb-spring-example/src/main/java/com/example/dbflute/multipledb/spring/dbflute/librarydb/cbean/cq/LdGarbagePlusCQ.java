...
import com.example.dbflute.multipledb.spring.dbflute.librarydb.cbean.cq.bs.LdBsGarbagePlusCQ;
...
public class LdGarbagePlusCQ extends LdBsGarbagePlusCQ {
     ...
     */
    public LdGarbagePlusCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {

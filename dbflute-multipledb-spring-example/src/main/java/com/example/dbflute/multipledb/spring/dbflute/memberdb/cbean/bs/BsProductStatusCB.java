...
public class BsProductStatusCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;ProductStatusCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;ProductStatusCB&gt;() {
     *     public void query(ProductStatusCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<ProductStatusCQ> {
         ...
         */
        public HpSDRFunction<ProductCB, ProductStatusCQ> derivedProductList() {
            ...
            return new HpSDRFunction<ProductCB, ProductStatusCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<ProductCB, ProductStatusCQ>() {
                public void setup(String function, SubQuery<ProductCB> subQuery, ProductStatusCQ cq, String aliasName, DerivedReferrerOption option) {
                    cq.xsderiveProductList(function, subQuery, aliasName, option); } }, _dbmetaProvider);
        }
        /**
        ...
        public HpSDRFunction<ProductStatusCB, ProductStatusCQ> myselfDerived() {
            ...
            return new HpSDRFunction<ProductStatusCB, ProductStatusCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<ProductStatusCB, ProductStatusCQ>() {
                public void setup(String function, SubQuery<ProductStatusCB> subQuery, ProductStatusCQ cq, String aliasName, DerivedReferrerOption option) {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;ProductStatusCB&gt;() {
    ...
    public HpColQyOperand<ProductStatusCB> columnQuery(final SpecifyQuery<ProductStatusCB> leftSpecifyQuery) {
        return new HpColQyOperand<ProductStatusCB>(new HpColQyHandler<ProductStatusCB>() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;ProductStatusCB&gt;() {
     ...
     *     public void query(ProductStatusCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;ProductStatusCB&gt;() {

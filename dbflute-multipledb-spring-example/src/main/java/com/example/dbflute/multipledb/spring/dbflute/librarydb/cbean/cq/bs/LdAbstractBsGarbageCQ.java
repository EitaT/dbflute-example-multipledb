...
public abstract class LdAbstractBsGarbageCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LdAbstractBsGarbageCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>e.g. setGarbageMemo_LikeSearch("xxx", new <span style="color: #DD4747">LikeSearchOption</span>().likeContain());</pre>
     ...
     * GARBAGE_TIME: {TIMESTAMP(26, 6)}
     * <pre>e.g. setGarbageTime_FromTo(fromDate, toDate, new <span style="color: #DD4747">FromToOption</span>().compareAsDate());</pre>
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_Equal()</span>.max(new SubQuery&lt;LdGarbageCB&gt;() {
     *     public void query(LdGarbageCB subCB) {
     ...
     */
    public HpSSQFunction<LdGarbageCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ.getOperand(), LdGarbageCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;LdGarbageCB&gt;() {
     *     public void query(LdGarbageCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<LdGarbageCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES.getOperand(), LdGarbageCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;LdGarbageCB&gt;() {
     *     public void query(LdGarbageCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<LdGarbageCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT.getOperand(), LdGarbageCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessThan()</span>.max(new SubQuery&lt;LdGarbageCB&gt;() {
     *     public void query(LdGarbageCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<LdGarbageCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT.getOperand(), LdGarbageCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;LdGarbageCB&gt;() {
     *     public void query(LdGarbageCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<LdGarbageCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE.getOperand(), LdGarbageCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;LdGarbageCB&gt;() {
     *     public void query(LdGarbageCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<LdGarbageCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE.getOperand(), LdGarbageCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSSQOption<CB> op) {
        assertObjectNotNull("subQuery", sq);
        LdGarbageCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        op.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, op);
    }
    public abstract String keepScalarCondition(LdGarbageCQ sq);

    protected LdGarbageCB xcreateScalarConditionCB() {
        LdGarbageCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected LdGarbageCB xcreateScalarConditionPartitionByCB() {
        LdGarbageCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

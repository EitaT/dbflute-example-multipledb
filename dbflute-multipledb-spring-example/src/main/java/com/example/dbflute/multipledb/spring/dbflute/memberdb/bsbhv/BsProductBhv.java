...
public abstract class BsProductBhv extends AbstractBehaviorWritable<Product, ProductCB> {
    ...
    public OutsideSqlBasicExecutor<ProductBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<ProductBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends Product> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
        return new com.example.dbflute.multipledb.spring.dbflute.memberdb.allcommon.DBFluteConfig.SelectCursorCBCommandHyperPatch<RESULT>();
    }

    @Override
    protected <RESULT extends Product> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {
        return new com.example.dbflute.multipledb.spring.dbflute.memberdb.allcommon.DBFluteConfig.SelectListCBCommandHyperPatch<RESULT>();
    }

...
public abstract class LdBsBlackActionBhv extends AbstractBehaviorWritable<LdBlackAction, LdBlackActionCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public LdBlackActionDbm getDBMeta() { return LdBlackActionDbm.getInstance(); }
    ...
    public OutsideSqlBasicExecutor<LdBlackActionBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<LdBlackActionBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends LdBlackAction> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends LdBlackAction> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {

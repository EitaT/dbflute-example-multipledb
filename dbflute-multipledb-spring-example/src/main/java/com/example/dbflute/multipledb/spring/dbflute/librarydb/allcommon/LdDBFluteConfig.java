...
public class LdDBFluteConfig {
    ...
    //                                                                          ==========
    /** Log instance. */
    private static final Log _log = LogFactory.getLog(LdDBFluteConfig.class);
    ...
    protected String _outsideSqlPackage = "com.example.dbflute.multipledb.spring.dbflute.librarydb";
     ...
     * Constructor.
     */
    private LdDBFluteConfig() { // adjusts default settings
    ...
    public static class ImplementedOracleAgent implements OracleAgent {
        ...
        public PhysicalConnectionDigger getPhysicalConnectionDigger() {
            return LdDBFluteConfig.getInstance().getPhysicalConnectionDigger();
        }
    }

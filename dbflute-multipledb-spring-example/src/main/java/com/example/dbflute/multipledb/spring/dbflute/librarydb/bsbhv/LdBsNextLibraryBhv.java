...
public abstract class LdBsNextLibraryBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends LdNextLibrary> ENTITY doSelectEntity(final LdNextLibraryCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityInternally(cb, entityType, new InternalSelectEntityCallback<ENTITY, LdNextLibraryCB>() {
            public List<ENTITY> callbackSelectList(LdNextLibraryCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends LdNextLibrary> ENTITY doSelectEntityWithDeletedCheck(final LdNextLibraryCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityWithDeletedCheckInternally(cb, entityType, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, LdNextLibraryCB>() {
            public List<ENTITY> callbackSelectList(LdNextLibraryCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends LdNextLibrary> ListResultBean<ENTITY> doSelectList(LdNextLibraryCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", entityType);
        assertSpecifyDerivedReferrerEntityProperty(cb, entityType);
        return helpSelectListInternally(cb, entityType, new InternalSelectListCallback<ENTITY, LdNextLibraryCB>() {
            public List<ENTITY> callbackSelectList(LdNextLibraryCB cb, Class<ENTITY> entityType) { return delegateSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends LdNextLibrary> PagingResultBean<ENTITY> doSelectPage(LdNextLibraryCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", entityType);
        return helpSelectPageInternally(cb, entityType, new InternalSelectPageCallback<ENTITY, LdNextLibraryCB>() {
    ...
    protected <ENTITY extends LdNextLibrary> void doSelectCursor(LdNextLibraryCB cb, EntityRowHandler<ENTITY> entityRowHandler, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityRowHandler<LdNextLibrary>", entityRowHandler); assertObjectNotNull("entityType", entityType);
        assertSpecifyDerivedReferrerEntityProperty(cb, entityType);
        helpSelectCursorInternally(cb, entityRowHandler, entityType, new InternalSelectCursorCallback<ENTITY, LdNextLibraryCB>() {
            public void callbackSelectCursor(LdNextLibraryCB cb, EntityRowHandler<ENTITY> entityRowHandler, Class<ENTITY> entityType) { delegateSelectCursor(cb, entityRowHandler, entityType); }
            public List<ENTITY> callbackSelectList(LdNextLibraryCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); }
        });
    }
    ...
    protected <RESULT, CB extends LdNextLibraryCB> SLFunction<CB, RESULT> doScalarSelect(Class<RESULT> resultType, CB cb) {
        assertObjectNotNull("resultType", resultType); assertCBStateValid(cb);
        cb.xsetupForScalarSelect(); cb.getSqlClause().disableSelectIndex(); // for when you use union
        return createSLFunction(cb, resultType);
    }

    protected <RESULT, CB extends LdNextLibraryCB> SLFunction<CB, RESULT> createSLFunction(CB cb, Class<RESULT> resultType) {
    ...
    public List<LdLibrary> pulloutLibraryByLibraryId(List<LdNextLibrary> nextLibraryList) {
        return helpPulloutInternally(nextLibraryList, new InternalPulloutCallback<LdNextLibrary, LdLibrary>() {
            public LdLibrary getFr(LdNextLibrary e) { return e.getLibraryByLibraryId(); }
    ...
    public List<LdLibrary> pulloutLibraryByNextLibraryId(List<LdNextLibrary> nextLibraryList) {
        return helpPulloutInternally(nextLibraryList, new InternalPulloutCallback<LdNextLibrary, LdLibrary>() {
            public LdLibrary getFr(LdNextLibrary e) { return e.getLibraryByNextLibraryId(); }
            public boolean hasRf() { return true; }
            public void setRfLs(LdLibrary e, List<LdNextLibrary> ls)
    ...
    protected void doInsert(LdNextLibrary nextLibrary, InsertOption<LdNextLibraryCB> option) {
        assertObjectNotNull("nextLibrary", nextLibrary);
        prepareInsertOption(option);
        delegateInsert(nextLibrary, option);
    }

    protected void prepareInsertOption(InsertOption<LdNextLibraryCB> option) {
    ...
    protected void doUpdate(LdNextLibrary nextLibrary, final UpdateOption<LdNextLibraryCB> option) {
        assertObjectNotNull("nextLibrary", nextLibrary);
        prepareUpdateOption(option);
        helpUpdateInternally(nextLibrary, new InternalUpdateCallback<LdNextLibrary>() {
            public int callbackDelegateUpdate(LdNextLibrary entity) { return delegateUpdate(entity, option); } });
    }

    protected void prepareUpdateOption(UpdateOption<LdNextLibraryCB> option) {
        if (option == null) { return; }
    ...
    protected void doUpdateNonstrict(LdNextLibrary nextLibrary, final UpdateOption<LdNextLibraryCB> option) {
        assertObjectNotNull("nextLibrary", nextLibrary);
        prepareUpdateOption(option);
        helpUpdateNonstrictInternally(nextLibrary, new InternalUpdateNonstrictCallback<LdNextLibrary>() {
            public int callbackDelegateUpdateNonstrict(LdNextLibrary entity) { return delegateUpdateNonstrict(entity, option); } });
    }
    ...
    protected void doInesrtOrUpdate(LdNextLibrary nextLibrary, final InsertOption<LdNextLibraryCB> insertOption, final UpdateOption<LdNextLibraryCB> updateOption) {
        helpInsertOrUpdateInternally(nextLibrary, new InternalInsertOrUpdateCallback<LdNextLibrary, LdNextLibraryCB>() {
            public void callbackInsert(LdNextLibrary entity) { doInsert(entity, insertOption); }
            public void callbackUpdate(LdNextLibrary entity) { doUpdate(entity, updateOption); }
    ...
    protected void doCreateOrModify(Entity entity, InsertOption<? extends ConditionBean> insertOption,
        ...
        if (insertOption == null && updateOption == null) { insertOrUpdate(downcast(entity)); }
            ...
            insertOption = insertOption == null ? new InsertOption<LdNextLibraryCB>() : insertOption;
            updateOption = updateOption == null ? new UpdateOption<LdNextLibraryCB>() : updateOption;
    ...
    protected void doInesrtOrUpdateNonstrict(LdNextLibrary nextLibrary, final InsertOption<LdNextLibraryCB> insertOption, final UpdateOption<LdNextLibraryCB> updateOption) {
        helpInsertOrUpdateInternally(nextLibrary, new InternalInsertOrUpdateNonstrictCallback<LdNextLibrary>() {
            public void callbackInsert(LdNextLibrary entity) { doInsert(entity, insertOption); }
            public void callbackUpdateNonstrict(LdNextLibrary entity) { doUpdateNonstrict(entity, updateOption); }
        });
    }
    ...
    protected void doDelete(LdNextLibrary nextLibrary, final DeleteOption<LdNextLibraryCB> option) {
        assertObjectNotNull("nextLibrary", nextLibrary);
        prepareDeleteOption(option);
        helpDeleteInternally(nextLibrary, new InternalDeleteCallback<LdNextLibrary>() {
            public int callbackDelegateDelete(LdNextLibrary entity) { return delegateDelete(entity, option); } });
    }

    protected void prepareDeleteOption(DeleteOption<LdNextLibraryCB> option) {
        if (option == null) { return; }
    ...
    protected void doDeleteNonstrict(LdNextLibrary nextLibrary, final DeleteOption<LdNextLibraryCB> option) {
        assertObjectNotNull("nextLibrary", nextLibrary);
        prepareDeleteOption(option);
        helpDeleteNonstrictInternally(nextLibrary, new InternalDeleteNonstrictCallback<LdNextLibrary>() {
            public int callbackDelegateDeleteNonstrict(LdNextLibrary entity) { return delegateDeleteNonstrict(entity, option); } });
    }
    ...
    protected void doDeleteNonstrictIgnoreDeleted(LdNextLibrary nextLibrary, final DeleteOption<LdNextLibraryCB> option) {
        assertObjectNotNull("nextLibrary", nextLibrary);
        prepareDeleteOption(option);
    ...
    public int[] batchInsert(List<LdNextLibrary> nextLibraryList) {
        InsertOption<LdNextLibraryCB> option = createInsertUpdateOption();
        return doBatchInsert(nextLibraryList, option);
    }

    protected int[] doBatchInsert(List<LdNextLibrary> nextLibraryList, InsertOption<LdNextLibraryCB> option) {
        assertObjectNotNull("nextLibraryList", nextLibraryList);
        prepareBatchInsertOption(nextLibraryList, option);
        return delegateBatchInsert(nextLibraryList, option);
    }

    protected void prepareBatchInsertOption(List<LdNextLibrary> nextLibraryList, InsertOption<LdNextLibraryCB> option) {
        option.xallowInsertColumnModifiedPropertiesFragmented();
        option.xacceptInsertColumnModifiedPropertiesIfNeeds(nextLibraryList);
        prepareInsertOption(option);
    }
    ...
    protected int[] doBatchUpdate(List<LdNextLibrary> nextLibraryList, UpdateOption<LdNextLibraryCB> option) {
        assertObjectNotNull("nextLibraryList", nextLibraryList);
        prepareBatchUpdateOption(nextLibraryList, option);
        return delegateBatchUpdate(nextLibraryList, option);
    }

    protected void prepareBatchUpdateOption(List<LdNextLibrary> nextLibraryList, UpdateOption<LdNextLibraryCB> option) {
        option.xacceptUpdateColumnModifiedPropertiesIfNeeds(nextLibraryList);
        prepareUpdateOption(option);
    }
    ...
    protected int[] doBatchUpdateNonstrict(List<LdNextLibrary> nextLibraryList, UpdateOption<LdNextLibraryCB> option) {
        assertObjectNotNull("nextLibraryList", nextLibraryList);
        prepareBatchUpdateOption(nextLibraryList, option);
        return delegateBatchUpdateNonstrict(nextLibraryList, option);
    }
    ...
    protected int[] doBatchDelete(List<LdNextLibrary> nextLibraryList, DeleteOption<LdNextLibraryCB> option) {
        assertObjectNotNull("nextLibraryList", nextLibraryList);
        prepareDeleteOption(option);
        return delegateBatchDelete(nextLibraryList, option);
    }
    ...
    protected int[] doBatchDeleteNonstrict(List<LdNextLibrary> nextLibraryList, DeleteOption<LdNextLibraryCB> option) {
        assertObjectNotNull("nextLibraryList", nextLibraryList);
        prepareDeleteOption(option);
        return delegateBatchDeleteNonstrict(nextLibraryList, option);
    }
    ...
    protected int doQueryInsert(QueryInsertSetupper<LdNextLibrary, LdNextLibraryCB> setupper, InsertOption<LdNextLibraryCB> option) {
        assertObjectNotNull("setupper", setupper);
        prepareInsertOption(option);
        LdNextLibrary entity = new LdNextLibrary();
        LdNextLibraryCB intoCB = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(LdNextLibrary nextLibrary, LdNextLibraryCB cb, UpdateOption<LdNextLibraryCB> option) {
        assertObjectNotNull("nextLibrary", nextLibrary); assertCBStateValid(cb);
        prepareUpdateOption(option);
        return checkCountBeforeQueryUpdateIfNeeds(cb) ? delegateQueryUpdate(nextLibrary, cb, option) : 0;
    }

    @Override
    protected int doRangeModify(Entity entity, ConditionBean cb, UpdateOption<? extends ConditionBean> option) {
        if (option == null) { return queryUpdate(downcast(entity), (LdNextLibraryCB)cb); }
        else { return varyingQueryUpdate(downcast(entity), (LdNextLibraryCB)cb, downcast(option)); }
    }
    ...
    protected int doQueryDelete(LdNextLibraryCB cb, DeleteOption<LdNextLibraryCB> option) {
        assertCBStateValid(cb);
        prepareDeleteOption(option);
    ...
    protected int doRangeRemove(ConditionBean cb, DeleteOption<? extends ConditionBean> option) {
        if (option == null) { return queryDelete((LdNextLibraryCB)cb); }
        else { return varyingQueryDelete((LdNextLibraryCB)cb, downcast(option)); }
    }
    ...
    protected <ENTITY extends LdNextLibrary> void delegateSelectCursor(LdNextLibraryCB cb, EntityRowHandler<ENTITY> erh, Class<ENTITY> et)
    { invoke(createSelectCursorCBCommand(cb, erh, et)); }
    protected <ENTITY extends LdNextLibrary> List<ENTITY> delegateSelectList(LdNextLibraryCB cb, Class<ENTITY> et)
    { return invoke(createSelectListCBCommand(cb, et)); }

    // -----------------------------------------------------
    //                                                Update
    //                                                ------
    protected int delegateInsert(LdNextLibrary e, InsertOption<LdNextLibraryCB> op)
    { if (!processBeforeInsert(e, op)) { return 0; }
      return invoke(createInsertEntityCommand(e, op)); }
    protected int delegateUpdate(LdNextLibrary e, UpdateOption<LdNextLibraryCB> op)
    { if (!processBeforeUpdate(e, op)) { return 0; }
      return invoke(createUpdateEntityCommand(e, op)); }
    protected int delegateUpdateNonstrict(LdNextLibrary e, UpdateOption<LdNextLibraryCB> op)
    { if (!processBeforeUpdate(e, op)) { return 0; }
      return invoke(createUpdateNonstrictEntityCommand(e, op)); }
    protected int delegateDelete(LdNextLibrary e, DeleteOption<LdNextLibraryCB> op)
    { if (!processBeforeDelete(e, op)) { return 0; }
      return invoke(createDeleteEntityCommand(e, op)); }
    protected int delegateDeleteNonstrict(LdNextLibrary e, DeleteOption<LdNextLibraryCB> op)
    { if (!processBeforeDelete(e, op)) { return 0; }
    ...
    protected int delegateQueryInsert(LdNextLibrary e, LdNextLibraryCB inCB, ConditionBean resCB, InsertOption<LdNextLibraryCB> op)
    { if (!processBeforeQueryInsert(e, inCB, resCB, op)) { return 0; } return invoke(createQueryInsertCBCommand(e, inCB, resCB, op));  }
    protected int delegateQueryUpdate(LdNextLibrary e, LdNextLibraryCB cb, UpdateOption<LdNextLibraryCB> op)
    ...
    protected void filterEntityOfInsert(Entity targetEntity, InsertOption<? extends ConditionBean> option) {
        ...
        LdNextLibrary entity = downcast(targetEntity);
    ...
    //                                                                     Downcast Helper
    //                                                                     ===============
    protected LdNextLibrary downcast(Entity entity) {
        return helpEntityDowncastInternally(entity, LdNextLibrary.class);
    }
    ...
    protected List<LdNextLibrary> downcast(List<? extends Entity> entityList) {
        return (List<LdNextLibrary>)entityList;
    }

    @SuppressWarnings("unchecked")
    protected InsertOption<LdNextLibraryCB> downcast(InsertOption<? extends ConditionBean> option) {
        return (InsertOption<LdNextLibraryCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected UpdateOption<LdNextLibraryCB> downcast(UpdateOption<? extends ConditionBean> option) {
        return (UpdateOption<LdNextLibraryCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected DeleteOption<LdNextLibraryCB> downcast(DeleteOption<? extends ConditionBean> option) {
        return (DeleteOption<LdNextLibraryCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected QueryInsertSetupper<LdNextLibrary, LdNextLibraryCB> downcast(QueryInsertSetupper<? extends Entity, ? extends ConditionBean> option) {
        return (QueryInsertSetupper<LdNextLibrary, LdNextLibraryCB>)option;
    }
}

...
public class LdBsVendorConstraintNameAutoBarCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;LdVendorConstraintNameAutoBarCB&gt;() {
    ...
    public void union(UnionQuery<LdVendorConstraintNameAutoBarCB> unionQuery) {
        final LdVendorConstraintNameAutoBarCB cb = new LdVendorConstraintNameAutoBarCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;LdVendorConstraintNameAutoBarCB&gt;() {
     *     public void query(LdVendorConstraintNameAutoBarCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;LdVendorConstraintNameAutoBarCB&gt;() {
    ...
    public HpColQyOperand<LdVendorConstraintNameAutoBarCB> columnQuery(final SpecifyQuery<LdVendorConstraintNameAutoBarCB> leftSpecifyQuery) {
        return new HpColQyOperand<LdVendorConstraintNameAutoBarCB>(new HpColQyHandler<LdVendorConstraintNameAutoBarCB>() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;LdVendorConstraintNameAutoBarCB&gt;() {
     ...
     *     public void query(LdVendorConstraintNameAutoBarCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;LdVendorConstraintNameAutoBarCB&gt;() {

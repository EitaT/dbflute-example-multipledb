...
public abstract class LdAbstractBsVendorConstraintNameAutoBarCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LdAbstractBsVendorConstraintNameAutoBarCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public void existsVendorConstraintNameAutoRefList(SubQuery<LdVendorConstraintNameAutoRefCB> subQuery) {
        ...
        String pp = keepConstraintNameAutoBarId_ExistsReferrer_VendorConstraintNameAutoRefList(cb.query());
    ...
    public void notExistsVendorConstraintNameAutoRefList(SubQuery<LdVendorConstraintNameAutoRefCB> subQuery) {
        ...
        LdVendorConstraintNameAutoRefCB cb = new LdVendorConstraintNameAutoRefCB(); cb.xsetupForExistsReferrer(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepConstraintNameAutoBarId_NotExistsReferrer_VendorConstraintNameAutoRefList(cb.query());
    ...
    public void inScopeVendorConstraintNameAutoRefList(SubQuery<LdVendorConstraintNameAutoRefCB> subQuery) {
        ...
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepConstraintNameAutoBarId_InScopeRelation_VendorConstraintNameAutoRefList(cb.query());
    ...
    public void notInScopeVendorConstraintNameAutoRefList(SubQuery<LdVendorConstraintNameAutoRefCB> subQuery) {
        ...
        LdVendorConstraintNameAutoRefCB cb = new LdVendorConstraintNameAutoRefCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
        String pp = keepConstraintNameAutoBarId_NotInScopeRelation_VendorConstraintNameAutoRefList(cb.query());
    ...
    public void xsderiveVendorConstraintNameAutoRefList(String fn, SubQuery<LdVendorConstraintNameAutoRefCB> sq, String al, DerivedReferrerOption op) {
        ...
        String pp = keepConstraintNameAutoBarId_SpecifyDerivedReferrer_VendorConstraintNameAutoRefList(cb.query());
    ...
    public void xqderiveVendorConstraintNameAutoRefList(String fn, SubQuery<LdVendorConstraintNameAutoRefCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        ...
        LdVendorConstraintNameAutoRefCB cb = new LdVendorConstraintNameAutoRefCB(); cb.xsetupForDerivedReferrer(this);
        try { lock(); sq.query(cb); } finally { unlock(); }
        String sqpp = keepConstraintNameAutoBarId_QueryDerivedReferrer_VendorConstraintNameAutoRefList(cb.query()); String prpp = keepConstraintNameAutoBarId_QueryDerivedReferrer_VendorConstraintNameAutoRefListParameter(vl);
     ...
     * <pre>e.g. setConstraintNameAutoBarName_LikeSearch("xxx", new <span style="color: #DD4747">LikeSearchOption</span>().likeContain());</pre>
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_Equal()</span>.max(new SubQuery&lt;LdVendorConstraintNameAutoBarCB&gt;() {
    ...
    public HpSSQFunction<LdVendorConstraintNameAutoBarCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, LdVendorConstraintNameAutoBarCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;LdVendorConstraintNameAutoBarCB&gt;() {
     *     public void query(LdVendorConstraintNameAutoBarCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
    ...
    public HpSSQFunction<LdVendorConstraintNameAutoBarCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, LdVendorConstraintNameAutoBarCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;LdVendorConstraintNameAutoBarCB&gt;() {
     *     public void query(LdVendorConstraintNameAutoBarCB subCB) {
    ...
    public HpSSQFunction<LdVendorConstraintNameAutoBarCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, LdVendorConstraintNameAutoBarCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessThan()</span>.max(new SubQuery&lt;LdVendorConstraintNameAutoBarCB&gt;() {
     *     public void query(LdVendorConstraintNameAutoBarCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<LdVendorConstraintNameAutoBarCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, LdVendorConstraintNameAutoBarCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;LdVendorConstraintNameAutoBarCB&gt;() {
     *     public void query(LdVendorConstraintNameAutoBarCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<LdVendorConstraintNameAutoBarCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, LdVendorConstraintNameAutoBarCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #DD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;LdVendorConstraintNameAutoBarCB&gt;() {
     *     public void query(LdVendorConstraintNameAutoBarCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    public HpSSQFunction<LdVendorConstraintNameAutoBarCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, LdVendorConstraintNameAutoBarCB.class);
    }
    ...
    public void xsmyselfDerive(String fn, SubQuery<LdVendorConstraintNameAutoBarCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        LdVendorConstraintNameAutoBarCB cb = new LdVendorConstraintNameAutoBarCB(); cb.xsetupForDerivedReferrer(this);
        try { lock(); sq.query(cb); } finally { unlock(); }
    ...
    public void myselfExists(SubQuery<LdVendorConstraintNameAutoBarCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        LdVendorConstraintNameAutoBarCB cb = new LdVendorConstraintNameAutoBarCB(); cb.xsetupForMyselfExists(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }
    ...
    public void myselfInScope(SubQuery<LdVendorConstraintNameAutoBarCB> subQuery) {
        assertObjectNotNull("subQuery", subQuery);
        LdVendorConstraintNameAutoBarCB cb = new LdVendorConstraintNameAutoBarCB(); cb.xsetupForMyselfInScope(this);
        try { lock(); subQuery.query(cb); } finally { unlock(); }

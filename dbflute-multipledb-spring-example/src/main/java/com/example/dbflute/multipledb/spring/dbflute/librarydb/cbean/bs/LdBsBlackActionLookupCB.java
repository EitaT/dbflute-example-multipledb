...
public class LdBsBlackActionLookupCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;LdBlackActionLookupCB&gt;() {
    ...
    public void union(UnionQuery<LdBlackActionLookupCB> unionQuery) {
        final LdBlackActionLookupCB cb = new LdBlackActionLookupCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;LdBlackActionLookupCB&gt;() {
     *     public void query(LdBlackActionLookupCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;LdBlackActionLookupCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;LdBlackActionLookupCB&gt;() {
     ...
     *     public void query(LdBlackActionLookupCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;LdBlackActionLookupCB&gt;() {

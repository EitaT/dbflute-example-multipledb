 ...
 */
public class LdBsBlackActionCB extends AbstractConditionBean {
     ...
     * @param blackActionId : PK, ID, NotNull, INTEGER(10). (NotNull)
     */
    public void acceptPrimaryKey(Integer blackActionId) {
        assertObjectNotNull("blackActionId", blackActionId);
        LdBsBlackActionCB cb = this;
        cb.query().setBlackActionId_Equal(blackActionId);
    }
    ...
    public LdBlackActionCQ getConditionQuery() { // public for parameter comment and internal
    ...
    protected LdBlackActionCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected LdBlackActionCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        LdBlackActionCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected LdBlackActionCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public LdBlackListNss setupSelect_BlackList() {
        ...
        doSetupSelect(new SsCall() { public ConditionQuery qf() { return query().queryBlackList(); } });
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<LdBlackActionCQ>() {
                public boolean has() { return true; }
                public LdBlackActionCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<LdBlackActionCQ> {
        protected LdBlackListCB.HpSpecification _blackList;
        protected LdBlackActionLookupCB.HpSpecification _blackActionLookup;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<LdBlackActionCQ> qyCall
         ...
         */
        public HpSpecifiedColumn columnBlackActionId() { return doColumn("BLACK_ACTION_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnBlackLevel() { return doColumn("BLACK_LEVEL"); }
        /**
         * ACTION_DATE: {TIMESTAMP(26, 6)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnActionDate() { return doColumn("ACTION_DATE"); }
        /**
         * EVIDENCE_PHOTOGRAPH: {BLOB(2147483647)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnEvidencePhotograph() { return doColumn("EVIDENCE_PHOTOGRAPH"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryBlackList()
                    || qyCall().qy().xgetReferrerQuery() instanceof LdBlackListCQ) {
                columnBlackListId(); // FK or one-to-one referrer
            }
            if (qyCall().qy().hasConditionQueryBlackActionLookup()
                    || qyCall().qy().xgetReferrerQuery() instanceof LdBlackActionLookupCQ) {
         ...
         */
        public LdBlackListCB.HpSpecification specifyBlackList() {
            assertRelation("blackList");
            if (_blackList == null) {
                _blackList = new LdBlackListCB.HpSpecification(_baseCB, new HpSpQyCall<LdBlackListCQ>() {
                    public boolean has() { return _qyCall.has() && _qyCall.qy().hasConditionQueryBlackList(); }
                    public LdBlackListCQ qy() { return _qyCall.qy().queryBlackList(); } }
                    , _purpose, _dbmetaProvider);
                if (xhasSyncQyCall()) { // inherits it
                    _blackList.xsetSyncQyCall(new HpSpQyCall<LdBlackListCQ>() {
                        public boolean has() { return xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryBlackList(); }
                        public LdBlackListCQ qy() { return xsyncQyCall().qy().queryBlackList(); }
                    });
                }
            }
            return _blackList;
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public LdBlackActionLookupCB.HpSpecification specifyBlackActionLookup() {
            assertRelation("blackActionLookup");
            if (_blackActionLookup == null) {
                _blackActionLookup = new LdBlackActionLookupCB.HpSpecification(_baseCB, new HpSpQyCall<LdBlackActionLookupCQ>() {
                    public boolean has() { return _qyCall.has() && _qyCall.qy().hasConditionQueryBlackActionLookup(); }
                    public LdBlackActionLookupCQ qy() { return _qyCall.qy().queryBlackActionLookup(); } }
                    , _purpose, _dbmetaProvider);
                if (xhasSyncQyCall()) { // inherits it
                    _blackActionLookup.xsetSyncQyCall(new HpSpQyCall<LdBlackActionLookupCQ>() {
                        public boolean has() { return xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryBlackActionLookup(); }
                        public LdBlackActionLookupCQ qy() { return xsyncQyCall().qy().queryBlackActionLookup(); }
                    });
                }
            }
         ...
         */
        public HpSDRFunction<LdBlackActionCB, LdBlackActionCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return new HpSDRFunction<LdBlackActionCB, LdBlackActionCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<LdBlackActionCB, LdBlackActionCQ>() {
                public void setup(String fn, SubQuery<LdBlackActionCB> sq, LdBlackActionCQ cq, String al, DerivedReferrerOption op) {
     ...
     */
    public HpColQyOperand<LdBlackActionCB> columnQuery(final SpecifyQuery<LdBlackActionCB> leftSpecifyQuery) {
        return new HpColQyOperand<LdBlackActionCB>(new HpColQyHandler<LdBlackActionCB>() {
            public HpCalculator handle(SpecifyQuery<LdBlackActionCB> rightSp, String operand) {
     ...
     */
    public LdBlackActionCB dreamCruiseCB() {
        LdBlackActionCB cb = new LdBlackActionCB();
        cb.xsetupForDreamCruise((LdBlackActionCB) this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<LdBlackActionCB> orQuery) {
        xorSQ((LdBlackActionCB)this, orQuery);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<LdBlackActionCB> andQuery) {
        xorSQAP((LdBlackActionCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final LdBlackActionCB cb;
        if (mainCB != null) {
            cb = (LdBlackActionCB)mainCB;
        } else {
            cb = new LdBlackActionCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<LdBlackActionCQ>() {
            public boolean has() { return true; }
            public LdBlackActionCQ qy() { return cb.query(); }
        });
    }

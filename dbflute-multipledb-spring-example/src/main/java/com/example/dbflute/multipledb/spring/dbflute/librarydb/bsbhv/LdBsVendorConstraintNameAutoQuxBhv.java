...
public abstract class LdBsVendorConstraintNameAutoQuxBhv extends AbstractBehaviorWritable<LdVendorConstraintNameAutoQux, LdVendorConstraintNameAutoQuxCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public LdVendorConstraintNameAutoQuxDbm getDBMeta() { return LdVendorConstraintNameAutoQuxDbm.getInstance(); }
    ...
    protected LdVendorConstraintNameAutoQux facadeSelectEntity(LdVendorConstraintNameAutoQuxCB cb) {
    ...
    protected LdVendorConstraintNameAutoQux facadeSelectByPKValue(java.math.BigDecimal constraintNameAutoQuxId) {
    ...
    protected <ENTITY extends LdVendorConstraintNameAutoQux> ENTITY doSelectByPKWithDeletedCheck(java.math.BigDecimal constraintNameAutoQuxId, Class<ENTITY> tp) {
        return doSelectEntityWithDeletedCheck(xprepareCBAsPK(constraintNameAutoQuxId), tp);
    }

    protected LdVendorConstraintNameAutoQuxCB xprepareCBAsPK(java.math.BigDecimal constraintNameAutoQuxId) {
     ...
     * @exception SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<LdVendorConstraintNameAutoQux> selectByUniqueOf(String constraintNameAutoQuxName) {
        return facadeSelectByUniqueOf(constraintNameAutoQuxName);
    }

    protected OptionalEntity<LdVendorConstraintNameAutoQux> facadeSelectByUniqueOf(String constraintNameAutoQuxName) {
    ...
    protected LdVendorConstraintNameAutoQuxCB xprepareCBAsUniqueOf(String constraintNameAutoQuxName) {
     ...
     */
    public void load(List<LdVendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList, ReferrerLoaderHandler<LdLoaderOfVendorConstraintNameAutoQux> handler) {
        xassLRArg(vendorConstraintNameAutoQuxList, handler);
        handler.handle(new LdLoaderOfVendorConstraintNameAutoQux().ready(vendorConstraintNameAutoQuxList, _behaviorSelector));
    }
     ...
     * @param handler The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(LdVendorConstraintNameAutoQux vendorConstraintNameAutoQux, ReferrerLoaderHandler<LdLoaderOfVendorConstraintNameAutoQux> handler) {
        xassLRArg(vendorConstraintNameAutoQux, handler);
        handler.handle(new LdLoaderOfVendorConstraintNameAutoQux().ready(xnewLRAryLs(vendorConstraintNameAutoQux), _behaviorSelector));
    }
     ...
     */
    public NestedReferrerListGateway<LdVendorConstraintNameAutoRef> loadVendorConstraintNameAutoRefList(List<LdVendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList, ConditionBeanSetupper<LdVendorConstraintNameAutoRefCB> setupper) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<LdVendorConstraintNameAutoRef> loadVendorConstraintNameAutoRefList(LdVendorConstraintNameAutoQux vendorConstraintNameAutoQux, ConditionBeanSetupper<LdVendorConstraintNameAutoRefCB> setupper) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<LdVendorConstraintNameAutoRef> loadVendorConstraintNameAutoRefList(LdVendorConstraintNameAutoQux vendorConstraintNameAutoQux, LoadReferrerOption<LdVendorConstraintNameAutoRefCB, LdVendorConstraintNameAutoRef> loadReferrerOption) {
    ...
    public NestedReferrerListGateway<LdVendorConstraintNameAutoRef> loadVendorConstraintNameAutoRefList(List<LdVendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList, LoadReferrerOption<LdVendorConstraintNameAutoRefCB, LdVendorConstraintNameAutoRef> loadReferrerOption) {
        xassLRArg(vendorConstraintNameAutoQuxList, loadReferrerOption);
        if (vendorConstraintNameAutoQuxList.isEmpty()) { return (NestedReferrerListGateway<LdVendorConstraintNameAutoRef>)EMPTY_NREF_LGWAY; }
        return doLoadVendorConstraintNameAutoRefList(vendorConstraintNameAutoQuxList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<LdVendorConstraintNameAutoRef> doLoadVendorConstraintNameAutoRefList(List<LdVendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList, LoadReferrerOption<LdVendorConstraintNameAutoRefCB, LdVendorConstraintNameAutoRef> option) {
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(LdVendorConstraintNameAutoQux vendorConstraintNameAutoQux) {
    ...
    public OutsideSqlBasicExecutor<LdVendorConstraintNameAutoQuxBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<LdVendorConstraintNameAutoQuxBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends LdVendorConstraintNameAutoQux> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends LdVendorConstraintNameAutoQux> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {

...
public abstract class LdBsVendorConstraintNameAutoQuxBhv extends AbstractBehaviorWritable {
     ...
     * LdVendorConstraintNameAutoQuxCB cb = new LdVendorConstraintNameAutoQuxCB();
     * cb.query().setFoo...(value);
     * LdVendorConstraintNameAutoQux vendorConstraintNameAutoQux = vendorConstraintNameAutoQuxBhv.<span style="color: #FD4747">selectEntity</span>(cb);
    ...
    protected <ENTITY extends LdVendorConstraintNameAutoQux> ENTITY doSelectEntity(final LdVendorConstraintNameAutoQuxCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityInternally(cb, entityType, new InternalSelectEntityCallback<ENTITY, LdVendorConstraintNameAutoQuxCB>() {
            public List<ENTITY> callbackSelectList(LdVendorConstraintNameAutoQuxCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); } });
    }
     ...
     * LdVendorConstraintNameAutoQuxCB cb = new LdVendorConstraintNameAutoQuxCB();
     * cb.query().setFoo...(value);
     * LdVendorConstraintNameAutoQux vendorConstraintNameAutoQux = vendorConstraintNameAutoQuxBhv.<span style="color: #FD4747">selectEntityWithDeletedCheck</span>(cb);
    ...
    protected <ENTITY extends LdVendorConstraintNameAutoQux> ENTITY doSelectEntityWithDeletedCheck(final LdVendorConstraintNameAutoQuxCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityWithDeletedCheckInternally(cb, entityType, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, LdVendorConstraintNameAutoQuxCB>() {
            public List<ENTITY> callbackSelectList(LdVendorConstraintNameAutoQuxCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); } });
    }
     ...
     * ListResultBean&lt;LdVendorConstraintNameAutoQux&gt; vendorConstraintNameAutoQuxList = vendorConstraintNameAutoQuxBhv.<span style="color: #FD4747">selectList</span>(cb);
    ...
    protected <ENTITY extends LdVendorConstraintNameAutoQux> ListResultBean<ENTITY> doSelectList(LdVendorConstraintNameAutoQuxCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", entityType);
        assertSpecifyDerivedReferrerEntityProperty(cb, entityType);
        return helpSelectListInternally(cb, entityType, new InternalSelectListCallback<ENTITY, LdVendorConstraintNameAutoQuxCB>() {
            public List<ENTITY> callbackSelectList(LdVendorConstraintNameAutoQuxCB cb, Class<ENTITY> entityType) { return delegateSelectList(cb, entityType); } });
    }
     ...
     * PagingResultBean&lt;LdVendorConstraintNameAutoQux&gt; page = vendorConstraintNameAutoQuxBhv.<span style="color: #FD4747">selectPage</span>(cb);
    ...
    protected <ENTITY extends LdVendorConstraintNameAutoQux> PagingResultBean<ENTITY> doSelectPage(LdVendorConstraintNameAutoQuxCB cb, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityType", entityType);
        return helpSelectPageInternally(cb, entityType, new InternalSelectPageCallback<ENTITY, LdVendorConstraintNameAutoQuxCB>() {
     ...
     * LdVendorConstraintNameAutoQuxCB cb = new LdVendorConstraintNameAutoQuxCB();
     * cb.query().setFoo...(value);
     * vendorConstraintNameAutoQuxBhv.<span style="color: #FD4747">selectCursor</span>(cb, new EntityRowHandler&lt;LdVendorConstraintNameAutoQux&gt;() {
    ...
    protected <ENTITY extends LdVendorConstraintNameAutoQux> void doSelectCursor(LdVendorConstraintNameAutoQuxCB cb, EntityRowHandler<ENTITY> entityRowHandler, Class<ENTITY> entityType) {
        assertCBStateValid(cb); assertObjectNotNull("entityRowHandler<LdVendorConstraintNameAutoQux>", entityRowHandler); assertObjectNotNull("entityType", entityType);
        assertSpecifyDerivedReferrerEntityProperty(cb, entityType);
        helpSelectCursorInternally(cb, entityRowHandler, entityType, new InternalSelectCursorCallback<ENTITY, LdVendorConstraintNameAutoQuxCB>() {
            public void callbackSelectCursor(LdVendorConstraintNameAutoQuxCB cb, EntityRowHandler<ENTITY> entityRowHandler, Class<ENTITY> entityType) { delegateSelectCursor(cb, entityRowHandler, entityType); }
            public List<ENTITY> callbackSelectList(LdVendorConstraintNameAutoQuxCB cb, Class<ENTITY> entityType) { return doSelectList(cb, entityType); }
        });
    }
    ...
    protected <RESULT, CB extends LdVendorConstraintNameAutoQuxCB> SLFunction<CB, RESULT> doScalarSelect(Class<RESULT> resultType, CB cb) {
        assertObjectNotNull("resultType", resultType); assertCBStateValid(cb);
        cb.xsetupForScalarSelect(); cb.getSqlClause().disableSelectIndex(); // for when you use union
        return createSLFunction(cb, resultType);
    }

    protected <RESULT, CB extends LdVendorConstraintNameAutoQuxCB> SLFunction<CB, RESULT> createSLFunction(CB cb, Class<RESULT> resultType) {
     ...
     */
    public void loadVendorConstraintNameAutoRefList(LdVendorConstraintNameAutoQux vendorConstraintNameAutoQux, ConditionBeanSetupper<LdVendorConstraintNameAutoRefCB> conditionBeanSetupper) {
     ...
     * <pre>
     * vendorConstraintNameAutoQuxBhv.<span style="color: #FD4747">loadVendorConstraintNameAutoRefList</span>(vendorConstraintNameAutoQuxList, new ConditionBeanSetupper&lt;LdVendorConstraintNameAutoRefCB&gt;() {
     ...
     * @param conditionBeanSetupper The instance of referrer condition-bean set-upper for registering referrer condition. (NotNull)
     */
    public void loadVendorConstraintNameAutoRefList(List<LdVendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList, ConditionBeanSetupper<LdVendorConstraintNameAutoRefCB> conditionBeanSetupper) {
        xassLRArg(vendorConstraintNameAutoQuxList, conditionBeanSetupper);
        loadVendorConstraintNameAutoRefList(vendorConstraintNameAutoQuxList, new LoadReferrerOption<LdVendorConstraintNameAutoRefCB, LdVendorConstraintNameAutoRef>().xinit(conditionBeanSetupper));
    }
    /**
     * {Refer to overload method that has an argument of the list of entity.}
     * @param vendorConstraintNameAutoQux The entity of vendorConstraintNameAutoQux. (NotNull)
     ...
     */
    public void loadVendorConstraintNameAutoRefList(LdVendorConstraintNameAutoQux vendorConstraintNameAutoQux, LoadReferrerOption<LdVendorConstraintNameAutoRefCB, LdVendorConstraintNameAutoRef> loadReferrerOption) {
     ...
     * @param loadReferrerOption The option of load-referrer. (NotNull)
     */
    public void loadVendorConstraintNameAutoRefList(List<LdVendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList, LoadReferrerOption<LdVendorConstraintNameAutoRefCB, LdVendorConstraintNameAutoRef> loadReferrerOption) {
        ...
        helpLoadReferrerInternally(vendorConstraintNameAutoQuxList, loadReferrerOption, new InternalLoadReferrerCallback<LdVendorConstraintNameAutoQux, java.math.BigDecimal, LdVendorConstraintNameAutoRefCB, LdVendorConstraintNameAutoRef>() {
            public java.math.BigDecimal getPKVal(LdVendorConstraintNameAutoQux e)
            ...
            public java.math.BigDecimal getFKVal(LdVendorConstraintNameAutoRef e) { return e.getConstraintNameAutoQuxId(); }
    ...
    public List<java.math.BigDecimal> extractConstraintNameAutoQuxIdList(List<LdVendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList) {
        return helpExtractListInternally(vendorConstraintNameAutoQuxList, new InternalExtractCallback<LdVendorConstraintNameAutoQux, java.math.BigDecimal>() {
            public java.math.BigDecimal getCV(LdVendorConstraintNameAutoQux e) { return e.getConstraintNameAutoQuxId(); }
        });
    }
    ...
    public List<String> extractConstraintNameAutoQuxNameList(List<LdVendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList) {
        return helpExtractListInternally(vendorConstraintNameAutoQuxList, new InternalExtractCallback<LdVendorConstraintNameAutoQux, String>() {
            public String getCV(LdVendorConstraintNameAutoQux e) { return e.getConstraintNameAutoQuxName(); }
        });
    }
    ...
    protected void doInsert(LdVendorConstraintNameAutoQux vendorConstraintNameAutoQux, InsertOption<LdVendorConstraintNameAutoQuxCB> option) {
    ...
    protected void prepareInsertOption(InsertOption<LdVendorConstraintNameAutoQuxCB> option) {
    ...
    protected void doUpdate(LdVendorConstraintNameAutoQux vendorConstraintNameAutoQux, final UpdateOption<LdVendorConstraintNameAutoQuxCB> option) {
        assertObjectNotNull("vendorConstraintNameAutoQux", vendorConstraintNameAutoQux);
        prepareUpdateOption(option);
        helpUpdateInternally(vendorConstraintNameAutoQux, new InternalUpdateCallback<LdVendorConstraintNameAutoQux>() {
            public int callbackDelegateUpdate(LdVendorConstraintNameAutoQux entity) { return delegateUpdate(entity, option); } });
    }

    protected void prepareUpdateOption(UpdateOption<LdVendorConstraintNameAutoQuxCB> option) {
        if (option == null) { return; }
    ...
    protected void doInesrtOrUpdate(LdVendorConstraintNameAutoQux vendorConstraintNameAutoQux, final InsertOption<LdVendorConstraintNameAutoQuxCB> insertOption, final UpdateOption<LdVendorConstraintNameAutoQuxCB> updateOption) {
        helpInsertOrUpdateInternally(vendorConstraintNameAutoQux, new InternalInsertOrUpdateCallback<LdVendorConstraintNameAutoQux, LdVendorConstraintNameAutoQuxCB>() {
            public void callbackInsert(LdVendorConstraintNameAutoQux entity) { doInsert(entity, insertOption); }
            public void callbackUpdate(LdVendorConstraintNameAutoQux entity) { doUpdate(entity, updateOption); }
    ...
    protected void doCreateOrModify(Entity entity, InsertOption<? extends ConditionBean> insertOption,
        ...
        if (insertOption == null && updateOption == null) { insertOrUpdate(downcast(entity)); }
            ...
            insertOption = insertOption == null ? new InsertOption<LdVendorConstraintNameAutoQuxCB>() : insertOption;
            updateOption = updateOption == null ? new UpdateOption<LdVendorConstraintNameAutoQuxCB>() : updateOption;
    ...
    protected void doDelete(LdVendorConstraintNameAutoQux vendorConstraintNameAutoQux, final DeleteOption<LdVendorConstraintNameAutoQuxCB> option) {
        assertObjectNotNull("vendorConstraintNameAutoQux", vendorConstraintNameAutoQux);
        prepareDeleteOption(option);
        helpDeleteInternally(vendorConstraintNameAutoQux, new InternalDeleteCallback<LdVendorConstraintNameAutoQux>() {
            public int callbackDelegateDelete(LdVendorConstraintNameAutoQux entity) { return delegateDelete(entity, option); } });
    }

    protected void prepareDeleteOption(DeleteOption<LdVendorConstraintNameAutoQuxCB> option) {
        if (option == null) { return; }
    ...
    public int[] batchInsert(List<LdVendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList) {
        InsertOption<LdVendorConstraintNameAutoQuxCB> option = createInsertUpdateOption();
        return doBatchInsert(vendorConstraintNameAutoQuxList, option);
    }

    protected int[] doBatchInsert(List<LdVendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList, InsertOption<LdVendorConstraintNameAutoQuxCB> option) {
    ...
    protected void prepareBatchInsertOption(List<LdVendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList, InsertOption<LdVendorConstraintNameAutoQuxCB> option) {
    ...
    public int[] batchUpdate(List<LdVendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList) {
        UpdateOption<LdVendorConstraintNameAutoQuxCB> option = createPlainUpdateOption();
        return doBatchUpdate(vendorConstraintNameAutoQuxList, option);
    }

    protected int[] doBatchUpdate(List<LdVendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList, UpdateOption<LdVendorConstraintNameAutoQuxCB> option) {
        assertObjectNotNull("vendorConstraintNameAutoQuxList", vendorConstraintNameAutoQuxList);
    ...
    protected void prepareBatchUpdateOption(List<LdVendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList, UpdateOption<LdVendorConstraintNameAutoQuxCB> option) {
     ...
     * vendorConstraintNameAutoQuxBhv.<span style="color: #FD4747">batchUpdate</span>(vendorConstraintNameAutoQuxList, new SpecifyQuery<LdVendorConstraintNameAutoQuxCB>() {
    ...
    protected int[] doBatchDelete(List<LdVendorConstraintNameAutoQux> vendorConstraintNameAutoQuxList, DeleteOption<LdVendorConstraintNameAutoQuxCB> option) {
        assertObjectNotNull("vendorConstraintNameAutoQuxList", vendorConstraintNameAutoQuxList);
        prepareDeleteOption(option);
     ...
     * <pre>
     * vendorConstraintNameAutoQuxBhv.<span style="color: #FD4747">queryInsert</span>(new QueryInsertSetupper&lt;LdVendorConstraintNameAutoQux, LdVendorConstraintNameAutoQuxCB&gt;() {
    ...
    protected int doQueryInsert(QueryInsertSetupper<LdVendorConstraintNameAutoQux, LdVendorConstraintNameAutoQuxCB> setupper, InsertOption<LdVendorConstraintNameAutoQuxCB> option) {
        assertObjectNotNull("setupper", setupper);
        prepareInsertOption(option);
        LdVendorConstraintNameAutoQux entity = new LdVendorConstraintNameAutoQux();
        LdVendorConstraintNameAutoQuxCB intoCB = createCBForQueryInsert();
    ...
    protected int doQueryUpdate(LdVendorConstraintNameAutoQux vendorConstraintNameAutoQux, LdVendorConstraintNameAutoQuxCB cb, UpdateOption<LdVendorConstraintNameAutoQuxCB> option) {
    ...
    protected int doRangeModify(Entity entity, ConditionBean cb, UpdateOption<? extends ConditionBean> option) {
        if (option == null) { return queryUpdate(downcast(entity), (LdVendorConstraintNameAutoQuxCB)cb); }
        else { return varyingQueryUpdate(downcast(entity), (LdVendorConstraintNameAutoQuxCB)cb, downcast(option)); }
    }
    ...
    protected int doQueryDelete(LdVendorConstraintNameAutoQuxCB cb, DeleteOption<LdVendorConstraintNameAutoQuxCB> option) {
        assertCBStateValid(cb);
        prepareDeleteOption(option);
    ...
    protected int doRangeRemove(ConditionBean cb, DeleteOption<? extends ConditionBean> option) {
        if (option == null) { return queryDelete((LdVendorConstraintNameAutoQuxCB)cb); }
        else { return varyingQueryDelete((LdVendorConstraintNameAutoQuxCB)cb, downcast(option)); }
    }
    ...
    protected <ENTITY extends LdVendorConstraintNameAutoQux> void delegateSelectCursor(LdVendorConstraintNameAutoQuxCB cb, EntityRowHandler<ENTITY> erh, Class<ENTITY> et)
    { invoke(createSelectCursorCBCommand(cb, erh, et)); }
    protected <ENTITY extends LdVendorConstraintNameAutoQux> List<ENTITY> delegateSelectList(LdVendorConstraintNameAutoQuxCB cb, Class<ENTITY> et)
    { return invoke(createSelectListCBCommand(cb, et)); }

    // -----------------------------------------------------
    //                                                Update
    //                                                ------
    protected int delegateInsert(LdVendorConstraintNameAutoQux e, InsertOption<LdVendorConstraintNameAutoQuxCB> op)
    { if (!processBeforeInsert(e, op)) { return 0; }
      return invoke(createInsertEntityCommand(e, op)); }
    protected int delegateUpdate(LdVendorConstraintNameAutoQux e, UpdateOption<LdVendorConstraintNameAutoQuxCB> op)
    { if (!processBeforeUpdate(e, op)) { return 0; }
      return delegateUpdateNonstrict(e, op); }
    protected int delegateUpdateNonstrict(LdVendorConstraintNameAutoQux e, UpdateOption<LdVendorConstraintNameAutoQuxCB> op)
    { if (!processBeforeUpdate(e, op)) { return 0; }
      return invoke(createUpdateNonstrictEntityCommand(e, op)); }
    protected int delegateDelete(LdVendorConstraintNameAutoQux e, DeleteOption<LdVendorConstraintNameAutoQuxCB> op)
    { if (!processBeforeDelete(e, op)) { return 0; }
      return delegateDeleteNonstrict(e, op); }
    protected int delegateDeleteNonstrict(LdVendorConstraintNameAutoQux e, DeleteOption<LdVendorConstraintNameAutoQuxCB> op)
    { if (!processBeforeDelete(e, op)) { return 0; }
    ...
    protected int delegateQueryInsert(LdVendorConstraintNameAutoQux e, LdVendorConstraintNameAutoQuxCB inCB, ConditionBean resCB, InsertOption<LdVendorConstraintNameAutoQuxCB> op)
    { if (!processBeforeQueryInsert(e, inCB, resCB, op)) { return 0; } return invoke(createQueryInsertCBCommand(e, inCB, resCB, op));  }
    protected int delegateQueryUpdate(LdVendorConstraintNameAutoQux e, LdVendorConstraintNameAutoQuxCB cb, UpdateOption<LdVendorConstraintNameAutoQuxCB> op)
    ...
    //                                                                     Downcast Helper
    //                                                                     ===============
    protected LdVendorConstraintNameAutoQux downcast(Entity entity) {
        return helpEntityDowncastInternally(entity, LdVendorConstraintNameAutoQux.class);
    }
    ...
    protected List<LdVendorConstraintNameAutoQux> downcast(List<? extends Entity> entityList) {
        return (List<LdVendorConstraintNameAutoQux>)entityList;
    }

    @SuppressWarnings("unchecked")
    protected InsertOption<LdVendorConstraintNameAutoQuxCB> downcast(InsertOption<? extends ConditionBean> option) {
        return (InsertOption<LdVendorConstraintNameAutoQuxCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected UpdateOption<LdVendorConstraintNameAutoQuxCB> downcast(UpdateOption<? extends ConditionBean> option) {
        return (UpdateOption<LdVendorConstraintNameAutoQuxCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected DeleteOption<LdVendorConstraintNameAutoQuxCB> downcast(DeleteOption<? extends ConditionBean> option) {
        return (DeleteOption<LdVendorConstraintNameAutoQuxCB>)option;
    }

    @SuppressWarnings("unchecked")
    protected QueryInsertSetupper<LdVendorConstraintNameAutoQux, LdVendorConstraintNameAutoQuxCB> downcast(QueryInsertSetupper<? extends Entity, ? extends ConditionBean> option) {
        return (QueryInsertSetupper<LdVendorConstraintNameAutoQux, LdVendorConstraintNameAutoQuxCB>)option;
    }
}

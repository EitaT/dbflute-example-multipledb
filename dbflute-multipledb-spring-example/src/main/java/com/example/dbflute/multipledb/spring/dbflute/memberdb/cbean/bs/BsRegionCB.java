...
public class BsRegionCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;RegionCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;RegionCB&gt;() {
     *     public void query(RegionCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;RegionCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;RegionCB&gt;() {
     ...
     *     public void query(RegionCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;RegionCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<RegionCB> andQuery) {
        xorSQAP((RegionCB)this, andQuery);
    }

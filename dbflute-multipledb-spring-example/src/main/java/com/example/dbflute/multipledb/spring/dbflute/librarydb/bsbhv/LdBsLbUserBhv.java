...
public abstract class LdBsLbUserBhv extends AbstractBehaviorWritable<LdLbUser, LdLbUserCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public LdLbUserDbm getDBMeta() { return LdLbUserDbm.getInstance(); }
    ...
    public OutsideSqlBasicExecutor<LdLbUserBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<LdLbUserBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends LdLbUser> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends LdLbUser> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {

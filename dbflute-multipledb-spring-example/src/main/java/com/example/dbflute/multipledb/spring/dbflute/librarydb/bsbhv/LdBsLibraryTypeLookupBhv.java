...
public abstract class LdBsLibraryTypeLookupBhv extends AbstractBehaviorWritable<LdLibraryTypeLookup, LdLibraryTypeLookupCB> {
    ...
    public OutsideSqlBasicExecutor<LdLibraryTypeLookupBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<LdLibraryTypeLookupBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends LdLibraryTypeLookup> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends LdLibraryTypeLookup> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {

...
public abstract class BsRegionBhv extends AbstractBehaviorWritable<Region, RegionCB> {
     ...
     */
    public NestedReferrerListGateway<MemberAddress> loadMemberAddressList(List<Region> regionList, ConditionBeanSetupper<MemberAddressCB> setupper) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MemberAddress> loadMemberAddressList(Region region, ConditionBeanSetupper<MemberAddressCB> setupper) {
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends Region> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends Region> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {

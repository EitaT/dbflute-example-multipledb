...
public abstract class LdAbstractBsVendorConstraintNameAutoRefCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LdAbstractBsVendorConstraintNameAutoRefCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public HpSSQFunction<LdVendorConstraintNameAutoRefCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, LdVendorConstraintNameAutoRefCB.class);
    }
    ...
    public HpSSQFunction<LdVendorConstraintNameAutoRefCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, LdVendorConstraintNameAutoRefCB.class);
    }
    ...
    public HpSSQFunction<LdVendorConstraintNameAutoRefCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, LdVendorConstraintNameAutoRefCB.class);
    }
    ...
    public HpSSQFunction<LdVendorConstraintNameAutoRefCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, LdVendorConstraintNameAutoRefCB.class);
    }
    ...
    public HpSSQFunction<LdVendorConstraintNameAutoRefCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, LdVendorConstraintNameAutoRefCB.class);
    }
    ...
    public HpSSQFunction<LdVendorConstraintNameAutoRefCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, LdVendorConstraintNameAutoRefCB.class);
    }

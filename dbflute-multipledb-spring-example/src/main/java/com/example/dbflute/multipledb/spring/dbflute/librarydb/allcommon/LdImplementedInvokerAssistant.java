 ...
 */
public class LdImplementedInvokerAssistant implements InvokerAssistant {
    ...
    protected LdDBFluteInitializer _introduction;
    ...
    public DataSource assistDataSource() { // DI component
        ...
        DataSourceHandler handler = LdDBFluteConfig.getInstance().getDataSourceHandler();
    ...
    protected TnStatementFactoryImpl newStatementFactoryImpl() {
        final Integer entitySelectFetchSize = LdDBFluteConfig.getInstance().getEntitySelectFetchSize();
    ...
    protected OutsideSqlExecutorFactory createOutsideSqlExecutorFactory() {
        OutsideSqlExecutorFactory factory = LdDBFluteConfig.getInstance().getOutsideSqlExecutorFactory();
        if (factory != null) {
            return factory;
        }
    ...
    public GearedCipherManager assistGearedCipherManager() {
        return LdDBFluteConfig.getInstance().getGearedCipherManager();
    }
    ...
    public void setIntroduction(LdDBFluteInitializer introduction) {

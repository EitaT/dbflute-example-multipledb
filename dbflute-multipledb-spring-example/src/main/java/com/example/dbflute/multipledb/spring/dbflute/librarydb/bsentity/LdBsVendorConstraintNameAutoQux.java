...
public abstract class LdBsVendorConstraintNameAutoQux implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof LdBsVendorConstraintNameAutoQux)) { return false; }
        LdBsVendorConstraintNameAutoQux otherEntity = (LdBsVendorConstraintNameAutoQux)other;
        if (!xSV(getConstraintNameAutoQuxId(), otherEntity.getConstraintNameAutoQuxId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = xCH(result, getConstraintNameAutoQuxId());
        return result;
    }
    ...
    protected String buildColumnString() {
        ...
        sb.append(delimiter).append(getConstraintNameAutoQuxName());

 ...
 */
public class LdLoaderOfVendorConstraintNameAutoQux {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<LdVendorConstraintNameAutoQux> _selectedList;
    protected BehaviorSelector _selector;
    protected LdVendorConstraintNameAutoQuxBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public LdLoaderOfVendorConstraintNameAutoQux ready(List<LdVendorConstraintNameAutoQux> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected LdVendorConstraintNameAutoQuxBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(LdVendorConstraintNameAutoQuxBhv.class); return _myBhv; } }
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<LdVendorConstraintNameAutoQux> getSelectedList() { return _selectedList; }

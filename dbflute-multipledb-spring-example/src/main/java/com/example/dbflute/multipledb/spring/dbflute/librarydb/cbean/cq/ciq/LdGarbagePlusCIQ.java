...
/**
 * The condition-query for in-line of GARBAGE_PLUS.
...
public class LdGarbagePlusCIQ extends LdAbstractBsGarbagePlusCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LdGarbagePlusCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, LdBsGarbagePlusCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue getCValueGarbageMemo() { return _myCQ.getGarbageMemo(); }
    protected ConditionValue getCValueGarbageTime() { return _myCQ.getGarbageTime(); }
    protected ConditionValue getCValueGarbageCount() { return _myCQ.getGarbageCount(); }
    ...
    protected String xinCB() { return LdGarbagePlusCB.class.getName(); }
    protected String xinCQ() { return LdGarbagePlusCQ.class.getName(); }
}

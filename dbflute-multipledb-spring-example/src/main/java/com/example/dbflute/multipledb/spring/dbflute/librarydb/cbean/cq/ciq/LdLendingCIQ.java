...
/**
 * The condition-query for in-line of LENDING.
 * @author DBFlute(AutoGenerator)
 */
public class LdLendingCIQ extends LdAbstractBsLendingCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LdLendingCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, LdBsLendingCQ myCQ) {
    ...
    protected String xinCB() { return LdLendingCB.class.getName(); }
    protected String xinCQ() { return LdLendingCQ.class.getName(); }
}

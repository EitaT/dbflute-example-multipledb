...
public abstract class LdBsCollectionBhv extends AbstractBehaviorWritable<LdCollection, LdCollectionCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public LdCollectionDbm getDBMeta() { return LdCollectionDbm.getInstance(); }
    ...
    public OutsideSqlBasicExecutor<LdCollectionBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<LdCollectionBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends LdCollection> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends LdCollection> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {

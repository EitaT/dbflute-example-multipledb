...
public abstract class LdAbstractBsLibraryUserCQ extends AbstractConditionQuery {
    ...
    public HpSSQFunction<LdLibraryUserCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, LdLibraryUserCB.class);
    }
    ...
    public HpSSQFunction<LdLibraryUserCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, LdLibraryUserCB.class);
    }
    ...
    public HpSSQFunction<LdLibraryUserCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, LdLibraryUserCB.class);
    }
    ...
    public HpSSQFunction<LdLibraryUserCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, LdLibraryUserCB.class);
    }
    ...
    public HpSSQFunction<LdLibraryUserCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, LdLibraryUserCB.class);
    }
    ...
    public HpSSQFunction<LdLibraryUserCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, LdLibraryUserCB.class);
    }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected LdLibraryUserCB newMyCB() {
        return new LdLibraryUserCB();
    }

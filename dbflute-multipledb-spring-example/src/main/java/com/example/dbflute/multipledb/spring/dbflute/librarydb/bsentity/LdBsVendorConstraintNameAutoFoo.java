...
public abstract class LdBsVendorConstraintNameAutoFoo implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof LdBsVendorConstraintNameAutoFoo)) { return false; }
        LdBsVendorConstraintNameAutoFoo otherEntity = (LdBsVendorConstraintNameAutoFoo)other;

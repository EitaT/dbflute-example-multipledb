...
public abstract class LdBsVendorCheckBhv extends AbstractBehaviorReadable<LdVendorCheck, LdVendorCheckCB> {
    ...
    //                                                                              ======
    /** {@inheritDoc} */
    public LdVendorCheckDbm getDBMeta() { return LdVendorCheckDbm.getInstance(); }
    ...
    public OutsideSqlBasicExecutor<LdVendorCheckBhv> outsideSql() {
        OutsideSqlAllFacadeExecutor<LdVendorCheckBhv> facadeExecutor = doOutsideSql();
    ...
    //                                                                         ===========
    @Override
    protected <RESULT extends LdVendorCheck> org.seasar.dbflute.bhv.core.command.SelectCursorCBCommand<RESULT> newSelectCursorCBCommand() {
    ...
    @Override
    protected <RESULT extends LdVendorCheck> org.seasar.dbflute.bhv.core.command.SelectListCBCommand<RESULT> newSelectListCBCommand() {

...
public class LdBsMyselfCheckCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;LdMyselfCheckCB&gt;() {
    ...
    public void union(UnionQuery<LdMyselfCheckCB> unionQuery) {
        final LdMyselfCheckCB cb = new LdMyselfCheckCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;LdMyselfCheckCB&gt;() {
     *     public void query(LdMyselfCheckCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #DD4747">setupSelect_Myself()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;LdMyselfCheckCB&gt;() {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;LdMyselfCheckCB&gt;() {
     ...
     *     public void query(LdMyselfCheckCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;LdMyselfCheckCB&gt;() {

...
public class LdBsBlackActionLookupCQ extends LdAbstractBsBlackActionLookupCQ {
    ...
    public String keepBlackActionCode_ExistsReferrer_BlackActionList(LdBlackActionCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_blackActionCode_ExistsReferrer_BlackActionListMap.size() + 1);
        _blackActionCode_ExistsReferrer_BlackActionListMap.put(key, subQuery); return "blackActionCode_ExistsReferrer_BlackActionList." + key;
    }
    ...
    public String keepBlackActionCode_NotExistsReferrer_BlackActionList(LdBlackActionCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_blackActionCode_NotExistsReferrer_BlackActionListMap.size() + 1);
        _blackActionCode_NotExistsReferrer_BlackActionListMap.put(key, subQuery); return "blackActionCode_NotExistsReferrer_BlackActionList." + key;
    }
    ...
    public String keepBlackActionCode_InScopeRelation_BlackActionList(LdBlackActionCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_blackActionCode_InScopeRelation_BlackActionListMap.size() + 1);
        _blackActionCode_InScopeRelation_BlackActionListMap.put(key, subQuery); return "blackActionCode_InScopeRelation_BlackActionList." + key;
    }
    ...
    public String keepBlackActionCode_NotInScopeRelation_BlackActionList(LdBlackActionCQ subQuery) {
        ...
        String key = "subQueryMapKey" + (_blackActionCode_NotInScopeRelation_BlackActionListMap.size() + 1);
        _blackActionCode_NotInScopeRelation_BlackActionListMap.put(key, subQuery); return "blackActionCode_NotInScopeRelation_BlackActionList." + key;
    }
